...
class Sc_recommend_line extends UA_Controller {
	public $controllerName = '深窗活动超值推荐线路配置';
	public function __construct() {
		parent::__construct ();
		$this->load_model('admin/a/sc_activity_model/Sc_recommend_line_model','recommend_line');
	}
	...
	function index(){
		...
		$this->load_view ( 'admin/a/cfg_activity/sc_recommend_line_view',$data);
	}
