...
class Roll_pic extends UA_Controller
{
	public function __construct()
	{
		parent::__construct ();
		$this->load_model('admin/a/cfgm_index_roll_pic_model','roll_pic_model');
	}

	public function index()
	{
		$this->view ( 'admin/a/cfg_mobile/roll_pic');
	}
	...
	public function getRollPicData()
	{
		...
		$sql = "select * from cfgm_index_roll_pic order by kind desc,id desc";
		$sqls = $sql.$limit;
