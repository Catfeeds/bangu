...
class Integral_figure extends UA_Controller
{
	public function __construct()
	{
		parent::__construct ();
		$this->load_model('admin/a/cfgm_integral_roll_pic_model','integral_roll_pic_model');
	}

	public function index()
	{
		$this->view ( 'admin/a/integral_center/integral_figure');
	}
	...
	public function add()
	{
		...
		$status = $this ->integral_roll_pic_model ->insert($dataArr);
		if (empty($status))
		{
	...
	public function edit()
	{
		...
		$status = $this ->integral_roll_pic_model ->update($dataArr ,array('id' =>intval($postArr['id'])));
	...
	public function getDetailJson ()
	{
		...
		$data=$this ->integral_roll_pic_model ->row(array('id' =>$id));
		$data['activity_name']='';
		$data['action_name']='';
		$data['activity_pic']='';
	...
	{
		$id = intval($this->input->post("id"));
		$status = $this ->integral_roll_pic_model ->delete(array('id'=>$id));
		if (empty($status))
		{
