...
class App_apiservices extends CI_Controller {
	private $resultJSON;
	private $result_code;
	private $result_msg;
	...
	public function index() {
		$data = array(
				...
				"webservice" => array(
						array(
								"serviceName" => "筛选管家",
								"urlName" => "cfgm_find_expert?cityname=深圳&qy_id=2155&e_grade=&sex=0&dest_id=13,11&label=160,170",
						...
						array(
								"serviceName" => "用户评价",
								"urlName" => "cfgm_user_comments?lineid=120&level=1",
...
// 										)
						...
						array(
								...
								"urlName" => "cfgm_in_location?cityname=深圳",
						...
						array(
								"serviceName" => "专家注册(b2)",
								"urlName" => "cfgm_expert_register?mobile=&password=&code=",
								"serviceDesc" => "表单提交,get方式",
								"format" => 'callback({"msg":"success","code":"1","data":{"save_result":"success"}})',
								"para" => array(
		...
		$this->load->view ( 'app_api_view', $data );
	} 
}
