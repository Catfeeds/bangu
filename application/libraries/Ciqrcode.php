...
class Ciqrcode
{
	...
	public function initialize($config = array()) {
		...
		//echo __FILE__;//exit();
		//echo "<br>".dirname(dirname(__FILE__));exit();
		include dirname(dirname(__FILE__))."/third_party/qrcode/qrconst.php";
		include dirname(dirname(__FILE__))."/third_party/qrcode/qrtools.php";
		include dirname(dirname(__FILE__))."/third_party/qrcode/qrspec.php";
		include dirname(dirname(__FILE__))."/third_party/qrcode/qrimage.php";
		include dirname(dirname(__FILE__))."/third_party/qrcode/qrinput.php";
		include dirname(dirname(__FILE__))."/third_party/qrcode/qrbitstream.php";
		include dirname(dirname(__FILE__))."/third_party/qrcode/qrsplit.php";
		include dirname(dirname(__FILE__))."/third_party/qrcode/qrrscode.php";
		include dirname(dirname(__FILE__))."/third_party/qrcode/qrmask.php";
		include dirname(dirname(__FILE__))."/third_party/qrcode/qrencode.php";
	}
