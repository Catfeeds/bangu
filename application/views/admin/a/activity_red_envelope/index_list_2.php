						...
						<div class="widget-body">
							<div role="grid" id="simpledatatable_wrapper"
								...
								<div id="simpledatatable_filter" >
									<label>
										<form class="form-inline" role="form"  method="get" action="<?php echo site_url('admin/a/banguxia_statistics/index')?>">	
...
function del(id) {
	if (confirm("您确定要打款吗?")) {
		$.post("/admin/a/banguxia_statistics/dakuang",{id:id},function(json){
			var data = eval("("+json+")");
			if (data.code == 2000) {
				alert(data.msg);
				location.reload();
