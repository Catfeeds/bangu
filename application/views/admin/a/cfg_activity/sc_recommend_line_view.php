<div class="page-content">
	...
	<div class="tab-content">
		<form action="<?php echo site_url('admin/a/cfg_act/sc_recommend_line/getRecommData')?>" id='search_condition' class="search_condition_form" method="post"></form>
...
$("#dataTable").pageTable({
	columns:columns,
	url:'/admin/a/cfg_act/sc_recommend_line/getRecommData',
...
$("#addFormData").submit(function() {
	...
	if (id.length > 0) {
		var url = "/admin/a/cfg_act/sc_recommend_line/edit";
	} else {
		var url = "/admin/a/cfg_act/sc_recommend_line/add";
	}
...
function edit(id) {
	$.post("/admin/a/cfg_act/sc_recommend_line/getOneData" ,{id:id} ,function(data) {
		var data = eval("("+data+")");
...
function del(id) {
	if (confirm("您确定要删除吗?")) {
		$.post("/admin/a/cfg_act/sc_recommend_line/delete",{id:id},function(json){
			var data = eval("("+json+")");
			if (data.code == 2000) {
				alert(data.msg);
				location.reload();
