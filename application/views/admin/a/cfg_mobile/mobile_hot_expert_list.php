...
<div class="page-content">
	<ul class="breadcrumb">
		...
		<li class="active"><span>/</span>手机端热门管家配置</li>
	</ul>
	<div class="page-body">
...
$("#dataTable").pageTable({
	columns:columns,
	url:'/admin/a/cfg_mobile/mobile_hot_expert/getMHotExpertData',
	pageNumNow:1,
...
$("#add-data").submit(function(){
	...
	var url = id > 0 ? '/admin/a/cfg_mobile/mobile_hot_expert/edit' :'/admin/a/cfg_mobile/mobile_hot_expert/add';
	$.ajax({
		url:url,
		type:'post',
		dataType:'json',
...
function edit(id){
	$.ajax({
		url:'/admin/a/cfg_mobile/mobile_hot_expert/getDetailjson',
		type:'post',
		dataType:'json',
		data:{id:id},
		success:function(data){
