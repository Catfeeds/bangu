    ...
    <div class="RongBox">
        ...
        <div class="RongCon">
            <div class="flex10">
                ...
                <div class="ListSub">
                    <div class="ListInput">
                    	<input type="text" id="parent" name="parent" onfocus="showDestBaseTree(this);">
                    </div>
            ...
            <div class="flex10">
                ...
                <div class="ListSub">
                    <div class="ListInput"><input type="text" name="kindname"></div>
            ...
            <div class="flex10">
                ...
                <div class="ListSub">
                    <label><input type="radio" name="type" value="1">目的地</label>
                    <label><input type="radio" name="type" value="2">景点</label>
                </div>
            </div>
        </div>
        <div class="btnBoix">
...
$('#add-dest').submit(function(){
	...
	$.ajax({
		url:'/admin/a/dest/dest_base/add',
		type:'post',
		dataType:'json',
		data:$(this).serialize(),
