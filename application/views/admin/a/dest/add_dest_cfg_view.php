    ...
    <div class="RongBox">
        ...
        <div class="RongCon">
            <div class="flex10">
                ...
                <div class="ListSub">
                    <div class="ListInput">
                    	<input type="text" id="parent" name="parent" onfocus="showDestCfgTree(this);">
            ...
            <div class="flex10">
                ...
                <div class="ListSub">
                    <div class="ListInput"><input type="text" name="name"></div>
            ...
            <div class="flex10">
                <div class="flex5">
                    ...
                    <div class="ListSub">
                        <div class="ListInput"><input type="text" name="enname"></div>
                        <div class="ListTip"></div>
                    </div>
                </div>
                <div class="flex5 borNone">
                    ...
                    <div class="ListSub">
                        <div class="ListInput"><input type="text" name="simplename"></div>
                        <div class="ListTip"></div>
                    </div>
                </div>
            </div>
            <div class="flex10">
                <div class="flex5">
                    ...
                    <div class="ListSub">
                        <label><input type="radio" name="isopen" value="1" checked="checked">启用</label>
                        <label><input type="radio" name="isopen" value="0">停用</label>
                    </div>
                </div>
                <div class="flex5 borNone">
                    ...
                    <div class="ListSub">
                        ...
                        <img src="http://www.1b1u.com/file/upload/20161108/147860112838885.jpg" class="imagexPot">
                    </div>
                </div>
            </div>
             <div class="flex10">
                ...
                <div class="ListSub">
                    <div class="sizeConsInput"><input type="text" name="displayorder"></div>
             ...
             <div class="flex10">
                ...
                <div class="ListSub">
                    ...
                    <label><input type="radio" name="ishot" value="0" checked="checked">否</label>
                </div>
            </div>
            <div class="flex10">
                ...
                <div class="ListSub">
                    <div class="ListInput">
                    	<input type="text" name="dest-source" id="dest-source" onclick="showDestBaseTree(this);">
