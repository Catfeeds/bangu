						...
						<div class="widget-body">
							<div role="grid" id="simpledatatable_wrapper"
								...
								<div id="simpledatatable_filter" >
									<label>
										<form class="form-inline" role="form"  method="get" action="<?php echo site_url('admin/a/banguxia_statistics/zindex')?>">	
										    ...
										    <div class="form-group dataTables_filter col_ip"style="padding-left:15px;" >
												...
												<input type="text" id="endtime"  class="search-input" style="width:110px;" value="<?php echo $endtime;?>"  name="endtime" placeholder="结束日期" />
                                                                                    ...
                                                                                    <div class="form-group dataTables_filter col_ip" style="padding-left:15px">
                                                                                        手机号:
                                                                                        <input type="text" id="tel" name="tel" class="search-input" style="width:100px" />
                                                                                    </div>
									...
									<?php foreach ($pageData as $item): ?>
       									 <tr>
            								    ...
            								    <td  style="text-align:center"><?php echo $item['mobile']?></td>
                                                                            <td  style="text-align:center"><a href="<?php echo site_url('admin/a/banguxia_statistics/zzindex?zid='. $item['member_id'])?>"><?php echo isset($pep_all[$item['member_id']]) ? $pep_all[$item['member_id']] : 0;?></a></td>
