...
<div class="page-content">
    <ul class="breadcrumb">
        ...
        <li class="active"><span>/</span>积分商城轮播图</li>
    </ul>
    <div class="page-body">
		...
		if(val==14){
			...
			$(".jump_url").hide();
                            ...
                            var columns = [{field: 'name', title: '名称', width: '100', align: 'center'},
                                {field: null, title: '图片', width: '200', align: 'center', formatter: function (item) {
                            ...
                            $("#dataTable").pageTable({
                                columns: columns,
                                url: '/admin/a/integral_center/integral_figure/getRollPicData',
                                pageNumNow: 1,
                            ...
                            $("#add-data").submit(function () {
                                ...
                                var url = id > 0 ? '/admin/a/integral_center/integral_figure/edit' : '/admin/a/integral_center/integral_figure/add';
                                $.ajax({
                                    url: url,
                                    type: 'post',
                                    dataType: 'json',
                            ...
                            function edit(id) {
                                $.ajax({
                                    url: '/admin/a/integral_center/integral_figure/getDetailJson',
                                    type: 'post',
                                    dataType: 'json',
                                    data: {id: id},
                                    success: function (data) {
...
//                                             formObj.find('input[name=link]').val(data.link);
                            ...
                            function del(id) {
                                if (confirm("您确定要删除吗?")) {
                                    $.post("/admin/a/integral_center/integral_figure/delHotLine", {id: id}, function (json) {
                                        var data = eval("(" + json + ")");
                                        if (data.code == 2000) {
                                            $("#dataTable").pageTable({
                                                columns: columns,
