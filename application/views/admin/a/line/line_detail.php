                ...
                <div class="tab_content" style="margin-top:10px;">
                       ...
                       <!--报价-->
                        <div class="ul_div" style="display:none; float: left; width: 100%;">
                          <div class="one_p" style="margin:0px;">
                       ...
                       <!--    <div class="one_p" style="margin:0px;">
                             <p class=""><font>促销价：</font><?php //echo $line['data']['lineprice'];?> 元/人份</p>
                             <p style="margin-left:20px;"><font>已优惠：</font><?php //echo $line['data']['saveprice'];?> 元/人份</p>
                        </div> -->
                   <!--        <div class="one_p" style="margin:0px;  float: left; width: 100%;margin-bottom:15px;" >
                    <p class=""><font>成人佣金：</font><?php //echo $line['data']['agent_rate_int'];?> 元/人份</p>
                    <p style="margin-left:20px;"><font>儿童佣金：</font><?php //echo $line['data']['agent_rate_child'];?> 元/人份</p>
                         ...
                         <!--<p class=""><font>备注：</font></p> -->
                           ...
                           <div class="one_p"><font>特殊人群价说明：</font>
                           ...
                           <div class="one_p" style="margin:0px;  float: left; width: 100%;" >
                                   ...
                                   <div style="padding:30px;margin-left:250px">
...
(function(){
  ...
  function initProductPrice(){
     var url = '<?php echo base_url()?>admin/a/lines/line/getProductPriceJSON';
