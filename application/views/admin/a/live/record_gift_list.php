...
<div class="page-content">
	...
	<!-- Page Body -->
						...
						<div class="widget-header ">
							<span class="widget-caption">打赏记录列表</span>
						...
						<div class="widget-body">
							<div role="grid" id="simpledatatable_wrapper"
								...
								<div id="simpledatatable_filter" >
									<label>
										<form class="form-inline" role="form"  method="post" action="<?php echo site_url('admin/a/live/video/video_comment_list')?>">
								...
								<table
									...
									<thead>
										<tr role="row">
											...
											<th style="text-align:center" >打赏人用户id</th>											
											<th style="text-align:center">打赏内容</th>
									...
									<?php foreach ($pageData as $item): ?>
       									 <tr>
           								     ...
           								     <td class=" " style="text-align:center"><?php echo $item['room_id'];?></td>
            								     <td  style="text-align:center"><?php echo $item['anchor_id']?></td>
            								     <td  style="text-align:center"><?php echo $item['user_id']?></td>									 
            								     <td  style="text-align:center"><?php echo $item['num']?>个/<?php echo $item['worth']?>U币</td>	
            								     <td  style="text-align:center"><?php echo date("Y-m-d H:i:s",$item['recordtime'])?></td>	
									  </tr>
									<?php endforeach;?>
									</tbody>
								</table>
