...
<div class="page-content">
	...
	<!-- Page Body -->
						...
						<div class="widget-header ">
							<span class="widget-caption">封号记录列表</span>
						...
						<div class="widget-body">
							<div role="grid" id="simpledatatable_wrapper"
								...
								<div id="simpledatatable_filter" >
									<label>
										<form class="form-inline" role="form"  method="post" action="<?php echo site_url('admin/a/live/record/lock_list')?>">
								...
								<table
									...
									<thead>
										<tr role="row">
											...
											<th style="text-align:center">封禁理由</th>
											<th style="text-align:center" >封禁账号</th>
											<th style="text-align:center">封禁时长</th>
											<th style="text-align:center">封禁时间</th>
									...
									<?php foreach ($pageData as $item): ?>
       									 <tr>
           								     ...
           								     <td class=" " style="text-align:center"><?php echo $item['content'];?></td>
            								     ...
            								     <td  style="text-align:center"><?php echo $item['locktime']?></td>									 
