...
<div class="page-content">
	...
	<!-- Page Body -->
						...
						<div class="widget-header ">
							<span class="widget-caption">举报详情</span>
						...
						<div class="widget-body">
							<div role="grid" id="simpledatatable_wrapper"
								...
								<div id="simpledatatable_filter" >
									<label>
										<!--<form class="form-inline" role="form"  method="post" action="<?php echo site_url('/admin/a/live/record/report_check_del_video')?>">-->
										    <div class="form-group dataTables_filter col_ip" >
												视频名称：<?php echo $live_video['name'];?><br/>
												视频地址：<?php echo $live_video['video'];?><br/>
												视频编号：<?php echo $live_video['id'];?><br/>
												上传者：<?php echo $live_anchor['name'];?><br/>
												上传时间：<?php echo date("Y-m-d H:i:s",$live_video['addtime']);?><br/>
												举报次数：<?php echo $total;?><br/>
										    </div>										
										    <div class="form-group dataTables_filter col_ip" >
												<textarea name="content" id="content"  placeholder="下架理由" ></textarea>
										    </div>
										<input name="video_id" id="video_id" value="<?php echo $live_video['id'];?>" type="hidden">											
										<input name="report_id" id="report_id" value="<?php echo $pageData[0]['id'];?>" type="hidden">
								...
								<table
									...
									<?php foreach ($pageData as $item): ?>
       									 <tr>
           								     <td class="sorting_1" style="text-align:center"><?php echo $item['content'];?></td>
...
function tijiao() {
	...
	$.post("/admin/a/live/record/report_check_del_video",{content:content,video_id:video_id,report_id:report_id},function(json){
		var data = eval("("+json+")");
		if (data.code == 2000) {
			alert(data.msg);
		} else {
