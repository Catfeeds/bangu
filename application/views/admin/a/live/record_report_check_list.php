...
<div class="page-content">
	...
	<!-- Page Body -->
						...
						<div class="widget-header ">
							<span class="widget-caption">举报审核</span>
						...
						<div class="widget-body">
							<div role="grid" id="simpledatatable_wrapper"
								...
								<div id="simpledatatable_filter" >
									<label>
										<form class="form-inline" role="form"  method="post" action="<?php echo site_url('/admin/a/live/record/report_check_list')?>">											
								...
								<table
									...
									<thead>
										<tr role="row">
											...
											<th style="text-align:center" >举报次数</th>
											<th style="text-align:center">最后举报时间</th>
									...
									<?php foreach ($pageData as $item): ?>
       									 <tr>
           								     <td class="sorting_1" style="text-align:center"><?php echo $item['video_id'];?></td>
           								     <td class=" " style="text-align:center"><?php echo $item['video_name'];?></td>
            								     <td  style="text-align:center"><?php echo $item['nums']?></td>
            								     <td  style="text-align:center"><?php echo $item['lasttime']?></td>
            								     <td  style="text-align:center"><a href="<?php echo site_url('/admin/a/live/record/report_check_do?videoid='.$item['video_id'])?>"  target="main">查看</a></td>												 
									  </tr>
									<?php endforeach;?>
									</tbody>
								</table>
