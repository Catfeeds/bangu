...
<div class="page-content">
	...
	<!-- Page Body -->
						...
						<div class="widget-header ">
							<span class="widget-caption">评论删除记录</span>
						...
						<div class="widget-body">
							<div role="grid" id="simpledatatable_wrapper"
								...
								<div id="simpledatatable_filter" >
									<label>
										<form class="form-inline" role="form"  method="post" action="<?php echo site_url('admin/a/live/record/video_comment_list')?>">
								...
								<table
									...
									<thead>
										<tr role="row">
											...
											<th style="text-align:center">删除内容</th>
									...
									<?php foreach ($pageData as $item): ?>
       									 <tr>
           								     ...
           								     <td class=" " style="text-align:center"><?php echo $item['pcontent'];?></td>
