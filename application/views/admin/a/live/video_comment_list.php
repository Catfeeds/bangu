...
<div class="page-content">
	...
	<!-- Page Body -->
						...
						<div class="widget-header ">
							<span class="widget-caption">视频评论列表</span>
								...
								<table
									...
									<thead>
										<tr role="row">
											...
											<th style="text-align:center" >评论账号</th>
									...
									<?php foreach ($pageData as $item): ?>
									    ...
									    <a href="javascript:void(0);" onclick="del('<?php echo $item['id'];?>');"  class="btn btn-default btn-xs purple">删除</a></td>
