<div class="page-content">
	...
	<div class="tab-content">
		<form action="<?php echo site_url('admin/a/sc_cfg/sc_index_kind/getDataList')?>" id='search_condition' class="search_condition_form" method="post"></form>
...
$("#dataTable").pageTable({
	columns:columns,
	url:'/admin/a/sc_cfg/sc_index_kind/getDataList',
...
$("#addFormData").submit(function() {
	...
	if (id.length > 0) {
		var url = "/admin/a/sc_cfg/sc_index_kind/edit";
	} else {
		var url = "/admin/a/sc_cfg/sc_index_kind/add";
	}
...
function edit(id) {
	$.post("/admin/a/sc_cfg/sc_index_kind/getOneData" ,{id:id} ,function(data) {
		var data = eval("("+data+")");
...
function del(id) {
	if (confirm("您确定要删除吗?")) {
		$.post("/admin/a/sc_cfg/sc_index_kind/delete",{id:id},function(json){
			var data = eval("("+json+")");
			if (data.code == 2000) {
				alert(data.msg);
				location.reload();
