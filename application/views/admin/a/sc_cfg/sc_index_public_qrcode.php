<div class="page-content">
	...
	<div class="tab-content">
		<form action="<?php echo site_url('admin/a/sc_cfg/sc_index_public_qrcode/getDataList')?>" id='search_condition' class="search_condition_form" method="post"></form>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">深窗分类模块配置</h4>
			</div>
			<div class="modal-body">
				<div class="bootbox-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-10 col_ts">
							<textarea name="remark" id="remark" rows="6" style="width:100%;"></textarea>
						</div>
					</div>
...
$("#dataTable").pageTable({
	columns:columns,
	url:'/admin/a/sc_cfg/sc_index_public_qrcode/getDataList',
...
$("#addFormData").submit(function() {
	...
	if (id.length > 0) {
		var url = "/admin/a/sc_cfg/sc_index_public_qrcode/edit";
	} else {
		var url = "/admin/a/sc_cfg/sc_index_public_qrcode/add";
	}
...
function edit(id) {
	$.post("/admin/a/sc_cfg/sc_index_public_qrcode/getOneData" ,{id:id} ,function(data) {
		var data = eval("("+data+")");
...
function del(id) {
	if (confirm("您确定要删除吗?")) {
		$.post("/admin/a/sc_cfg/sc_index_public_qrcode/delete",{id:id},function(json){
			var data = eval("("+json+")");
			if (data.code == 2000) {
				alert(data.msg);
				location.reload();
