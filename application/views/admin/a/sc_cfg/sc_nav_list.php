<div class="page-content">
	...
	<div class="tab-content">
		<form action="<?php echo site_url('admin/a/sc_cfg/sc_nav/getNavList')?>" id='search_condition' class="form-inline clear" method="post">
...
$("#addFormData").submit(function() {
	...
	if (id.length > 0) {
		var url = "/admin/a/sc_cfg/sc_nav/edit";
	} else {
		var url = "/admin/a/sc_cfg/sc_nav/add";
	}
...
function edit(id) {
	$.post("/admin/a/sc_cfg/sc_nav/getOneData" ,{id:id} ,function(data) {
		var data = eval("("+data+")");
...
function del(id) {
	if (confirm("您确定要删除吗?")) {
		$.post("/admin/a/sc_cfg/sc_nav/delete",{id:id},function(json){
			var data = eval("("+json+")");
			if (data.code == 2000) {
				alert(data.msg);
				location.reload();
