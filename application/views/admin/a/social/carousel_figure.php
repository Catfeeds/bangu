...
<div class="page-content">
    <ul class="breadcrumb">
        ...
        <li class="active"><span>/</span>社区轮播图</li>
    </ul>
    <div class="page-body">
    ...
    <div class="fb-content" style="max-height:600px;overflow-y:auto; ">
        ...
        <div class="fb-form">
            <form method="post" action="#" id="add-data" class="form-horizontal" >
            	<div class="form-group">
                    ...
                    <div class="fg-input">
                        <select name="kind" class="selector kind">
                            ...
                            <option value="1">社区首页</option>
                            <option value="2">社区知道首页</option>
                            <option value="3">社区心情首页</option>
                            <option value="4">社区故事首页</option>
                            <option value="5">社区中的直播首页</option>
                            <option value="6">社区瞬间首页</option>
                            <option value="7">社区服务首页</option>
                            <option value="8">社区管家首页</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
					<div class="fg-title">轮播图：<i>*</i></div>
					<img src="#" name="pic"  style="width: 250px; height: 103px;" id="imghead">
	...
	function check_val(obj){
		...
		if(val==14){
			...
			$(".jump_url").hide();
                            ...
                            var columns = [{field: 'name', title: '名称', width: '300', align: 'center'},
...
//                                         return "<a href='" + item.pic + "' target='_blank'>图片预览</a>";
                            ...
                            $("#dataTable").pageTable({
                                columns: columns,
                                url: '/admin/a/social/carousel_figure/getRollPicData',
                                pageNumNow: 1,
                            ...
                            $("#add-data").submit(function () {
                                ...
                                var url = id > 0 ? '/admin/a/social/carousel_figure/edit' : '/admin/a/social/carousel_figure/add';
                                $.ajax({
                                    url: url,
                                    type: 'post',
                                    dataType: 'json',
                            ...
                            function edit(id) {
                                $.ajax({
                                    url: '/admin/a/social/carousel_figure/getDetailJson',
                                    type: 'post',
                                    dataType: 'json',
                                    data: {id: id},
                                    success: function (data) {
                                        if (!$.isEmptyObject(data)) {
                                            ...
                                            }else if(data.link_type==3 || data.link_type==4){
                                            	$(".canshu").hide();
                                            	$(".action").hide();
                                            	$(".jump_url").show();
                                            ...
                                            formObj.find('img[name=pic]').attr('src', window.location.protocol + '//' + document.domain + data.pic);
...
//                                             formObj.find('input[name=link]').val(data.link);
                            ...
                            function del(id) {
                                if (confirm("您确定要删除吗?")) {
                                    $.post("/admin/a/social/carousel_figure/delHotLine", {id: id}, function (json) {
                                        var data = eval("(" + json + ")");
                                        if (data.code == 2000) {
                                            $("#dataTable").pageTable({
                                                columns: columns,
                            ...
                            /*-----------------------------------上传图片-----------------------------*/
                        	var imgProportion = {1:"750x309",2:"347:480",3:"5:5",4:"332:222"};
