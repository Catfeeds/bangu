...
<div class="page-content">
    <ul class="breadcrumb">
        ...
        <li class="active"><span>/</span>故事</li>
    </ul>
    <div class="page-body">
        ...
        <div class="fb-form">
            <form method="post" action="#" id="add-data" class="form-horizontal" >
                ...
                <div class="form-group">
					...
					<input class="add_btn" type="button" onclick="uploadImgFile(this,4);" value="上传">
...
<script type="text/javascript">
                            var columns = [{field: 'id', title: '主题编号', width: '25', align: 'center'},
                                ...
                                {field :false,title : '主题背景图片',align : 'center', width : '100',formatter:function(item){
                        			return '<img src="<?php echo trim(base_url(''),'/');?>'+item.icon+'" width="100" height="100" />';
                        		}},
                                {field: null, title: '主题图片', width: '100', align: 'center', formatter: function (item) {
	                                    ...
	                                    var str = '';
	                                    if (pic1.length > 0){
	                                        str += '<img src="<?php echo trim(base_url(''),'/');?>'+pic1+'" width="100" height="100" style="margin:5px;" />'; + "&nbsp&nbsp";
	                                    }
	                                    if (pic2.length > 0){
...
//                                        }
                                        ...
                                        button += '<br/>';
                                        button += '<a href="<?php echo site_url('admin/a/social/social_story/get_posts_by_theme_id?theme_id=')?>'+item.id+'" class="tab-button but-blue">故事动态</a>';
                                        return button;
                                    }
                                }
                            ];
                            ...
                            $("#add-data").submit(function () {
                                ...
                                var theme_name = $(this).find('input[name=name]').val();
  ...
  //app首页推荐
    ...
    /*-----------------------------------上传图片-----------------------------*/
	var imgProportion = {1:"710x309",2:"750x470",3:"5:5",4:"344x220"};
