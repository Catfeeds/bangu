        ...
        <div class="page_content bg_gray">      
            <div class="table_content">
                <div class="tab_content">
                	<form class="search_form" method="get" id="search-condition" action="/admin/a/statistics/depart_p_count/index">
                                ...
                                <tr>
                                	...
                                	<?php 
                                		foreach($titleArr as $val){
                                			if ($type == 1) {
                                				echo '<td class="depart-num"><a data-val="'.$v['depart_id'].'" data-type="'.$type.'" data-name="'.$v['depart_name'].'" data-time="'.$val['key'].'" href="javascript:void(0);" onclick="chioce(this);">'.$v[$val['key']].'</a></td>';
                                			} else {
