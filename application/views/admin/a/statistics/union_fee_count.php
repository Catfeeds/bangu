    ...
    <div class="page-body" id="bodyMsg">
        ...
        <div class="page_content bg_gray">      
            <div class="table_content">
            	<div class="itab">
                    <ul class="tab-nav"> 
                        <li data-val="1"><a href="/admin/a/statistics/union_fee_count/index?countType=1" class="<?php if ($countType==1) {echo 'active';}?>">按团队统计</a></li> 
                        <li data-val="2"><a href="/admin/a/statistics/union_fee_count/index?countType=2" class="<?php if ($countType==2) {echo 'active';}?>">按营业部统计</a></li> 
                    </ul>
                </div>
                <div class="tab_content">
                	<form class="search_form" method="get" id="search-condition" action="/admin/a/statistics/union_fee_count/index">
