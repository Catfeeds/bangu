	...
	<!-- Page Body -->
				...
				<div class="well with-header with-footer">
					 <ul id="myTab5" class="nav nav-tabs">
                            				<li class="tab-red"><a href="<?php echo base_url(); ?>admin/a/expert/topic_list" >新申请</a></li>
                            				<li class="tab-blue"><a href="<?php echo base_url(); ?>admin/a/expert/passed" >已审核</a></li>
                            				<li class="active"><a href="<?php echo base_url(); ?>admin/a/expert/refused" >已拒绝</a></li>
                       			 </ul>

                       			 <div class="tab-content">
					<label>
						<form class="form-inline" role="form"
					action="<?php echo base_url(); ?>admin/a/expert/refused" method="get">
					...
					<table class="table table-striped table-hover table-bordered dataTable no-footer"
						...
						<tbody>
						 <?php foreach ($refusde_list as $item): ?>
							<tr>
