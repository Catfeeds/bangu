...
<div class="page-content">
    ...
    <!-- Page Body -->
                     ...
                     <ul id="myTab5" class="nav nav-tabs">
                                            <li class="active"><a href="<?php echo base_url(); ?>admin/a/finance/supplier_month_account" >未结算</a></li>
                                            <li class="tab-red"><a href="<?php echo base_url(); ?>admin/a/finance/supplier_month_account_Settled" >已结算</a></li>
                                 </ul>

            <div class="tab-content">
                   <label>
                        <form class="form-inline clear" role="form" action="<?php echo base_url();?>admin/a/finance/supplier_month_account" method="post">
                           <div style="float:left;">
                                 <a class="btn btn-info btn-xs" target="_blank" class="btn btn-info btn-xs edit"
                                     href="<?php echo base_url();?>admin/a/finance/show_supplier_add_order" style=" padding:6px 7px; margin-right:55px; font-size:12px;">新增结算单
                                     </a>
                           </div>
                  ...
                  <!--   <div>
                    ...
                    <a class="btn btn-info btn-xs" target="_blank" class="btn btn-info btn-xs edit"
                                     href="<?php echo base_url();?>admin/a/finance/show_supplier_add_order" style=" padding:3px 7px; margin-top">新增结算单
                                     </a>
                    </div> -->
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting_disabled" tabindex="0" rowspan="1"
                                    ...
                                    <th class="sorting_disabled" tabindex="0" rowspan="1"
                                    colspan="1" style="width: 120px;text-align:center">品牌</th>
                                    <th class="sorting_disabled" tabindex="0" rowspan="1"
                                    colspan="1" style="width: 120px;text-align:center">修改时间</th>
