...
<script
	src="<?php echo base_url(); ?>assets/js/tagsinput/bootstrap-tagsinput.js"></script>

<!--Bootstrap Date Picker-->
<script
	src="<?php echo base_url(); ?>assets/js/datetime/bootstrap-datepicker.js"></script>

<!--Bootstrap Time Picker-->
<script
	src="<?php echo base_url(); ?>assets/js/datetime/bootstrap-timepicker.js"></script>
...
<!--Jquery Autosize-->
<script
	src="<?php echo base_url(); ?>assets/js/textarea/jquery.autosize.js"></script>

<!--Fuelux Spinner-->
<script
	src="<?php echo base_url(); ?>assets/js/fuelux/spinner/fuelux.spinner.min.js"></script>

<!--jQUery MiniColors-->
<script
	src="<?php echo base_url(); ?>assets/js/colorpicker/jquery.minicolors.js"></script>
...
<!--noUiSlider-->
<script
	src="<?php echo base_url(); ?>assets/js/slider/jquery.nouislider.js"></script>

<!--jQRangeSlider-->
<script
	src="<?php echo base_url(); ?>assets/js/jquery-ui-1.10.4.custom.js"></script>
<script
	src="<?php echo base_url(); ?>assets/js/slider/jQRangeSlider/jQAllRangeSliders-withRuler-min.js"></script>
<script>
        //--Jquery Select2--
        $("#e1").select2();
        $("#e2").select2({
