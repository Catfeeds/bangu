        ...
        <div class="page_content bg_gray">
            <div class="table_content">
                <div class="tab_content">
                	<form class="search_form" method="get" id="search-condition" action="/admin/b1/count/line_type_count/index">
                    	<div class="search_form_box clear">
                        	<div class="search_group">
                            	<label>统计方式</label>
                                <select class="search-select" name="type" style="height:24px;line-height: 24px;padding:0px;" >
