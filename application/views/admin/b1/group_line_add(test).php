		...
		<div class="widget-main ">
			<div class="tabbable">
				<ul id="myTab11" class="nav nav-tabs tabs-flat">
					<li class="" id="basc"><a href="#home11" data-toggle="tab"> 基础信息 </a></li>	
					<li class="active" id="scheduling"><a class="routting"   href="#profile12" data-toggle="tab" id="routting" name="rout"> 行程安排 </a></li>
                            	...
                            	<table class="line_base_info table_form_content table_td_border" border="1" width="100%">
                                    ...
                                    <tr height="34" class="form_group">
                                     ...
                                     <tr height="34" class="form_group">
                                        ...
                                        <td>
                                                     <input type="text" placeholder="" id="linebefore" class="form_input" name="linebefore" style="width: 50px;" value="<?php echo $data['linebefore'];?>"/>
                                                    <span>天</span>
                                                    <input type="text" placeholder="" id="linedatehour" class="form_input" name="linedatehour" style="width: 50px;" 
                                                    value="<?php  if(!empty($line_aff['hour'])){ echo $line_aff['hour']; }?>"/>
                                                   <span> 小时</span>
                                                   <input type="text" placeholder="" id="linedateminute" class="form_input" name="linedateminute" style="width: 50px;" 
                                                   value=" <?php  if(!empty($line_aff['minute'])){ echo $line_aff['minute']; }?> "/>
                                                   <span> 分 截止报名</span>
                                        </td>
                                    </tr>  
         <!--                            <tr height="34" class="form_group">
                    <td class="form_title"><i class="important_title">*</i>押金：</td>
                    <td><input type="text" id="deposit" name="deposit" style="width: 50px;height: 34px;" value="<?php //if(!empty($line_aff)){ echo $line_aff['deposit'];}else{ echo 0;} ?>"/>
                        <span>元</span>
                    </td>
                </tr>  
                <tr height="34" class="form_group">
                    <td class="form_title"><i class="important_title">*</i>提前：</td>
                    <td><input type="text" id="before_day"  name="before_day" style="width: 50px;height: 34px;" value="<?php //if(!empty($line_aff)){ echo $line_aff['before_day'];}else{ echo 0;} ?>"/>
                        <span>天交团款</span>
                    </td>
                </tr>   -->       
                                    ...
                                    <tr height="34" class="form_group">
                                        ...
                                        <td><div id="select_dest">
                                        	<?php if(!empty($query['expert_id'])){ echo $query['realname'];}else{ ?>
									    	<input type="text" id="expert" class="form-control" style="width:8%;" placeholder="管家-模糊搜索" name="expert" autocomplete="off" value="<?php  if(!empty($expert['nickname'])){ echo  $expert['nickname']; } ?>"  >
                                            <?php } ?>
                                        	</div>			
                                        	<div id="ds-list"></div>
                                        </td>
					...
					<!-- 行程安排 -->
					<div class="tab-pane active" id="profile12">
							...
							<div class="form-group">
								...
								<div class="form-inline col_ts">
									<div class="form-group col_ts" style="margin: 0px;">
												...
												<input type="text"  style="width:612px;-moz-box-flex: 1; -webkit-box-flex: 1; box-flex: 1;" 
							...
							<div class="form-group">
								<label class="col-sm-2 control-label no-padding-right label-width col_lb" for="inputEmail3">住宿</label>
									<div class="form-inline col_ts">
										<div class="form-group col_ts" style="margin: 0px;">
										     	<div class="col-sm-10 col_ts">
												<input type="text"  style="width:612px;-moz-box-flex: 1; -webkit-box-flex: 1; box-flex: 1;" id="hotel<?php echo $i;?>"
							...
							<div class="form-group" style="padding:15px 0px 20px 0px;">
								<label class="col-sm-2 control-label no-padding-right label-width col_lb" for="inputEmail3">温馨提示</label>
									<div class="form-inline col_ts">
										<div class="form-group col_ts" style="margin: 0px;">
										     	<div class="col-sm-10 col_ts">
												<input type="text"  style="width:612px;-moz-box-flex: 1; -webkit-box-flex: 1; box-flex: 1;" id="line_beizhu"
								...
								<div id="day_price">
									<div style="margin-top: 10px;"> 	
									    <form action="<?php echo base_url()?>admin/b1/product/updateLinePrice" accept-charset="utf-8" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" 
									  	...
									  	<div style="margin-top:20px;"><span><span style="color: red;">*</span>管家佣金:</span>
					...
					<div class="tab-pane" id="profile15">
						...
						id="lineLabelForm" novalidate="novalidate" onsubmit="return updateLabel();" >
							<div class="widget-body">
								<div class="form-group" style="padding:0px 0px 10px 0px; margin-left: -15pxdisplay: -moz-inline;display: -webkit-inline;display: inline;">	
									<div class="col-sm-2 control-label no-padding-right label-width col_xl" style="float: none;width:100%;max-width: 810px;" for="inputEmail3" >请点击以下标签进行选择：（客人根据兴趣寻找心仪的旅游线路时，会使用关键字标签进行搜索，若您不设标签将脱离于客人视线之外）
													 	...
													 	<div class="tab" id="line_attr_tab">
													 		 ...
													 		 <?php 
															 		...
															 		foreach($v['two'] as $key=>$val){
																			...
																			echo '<a href="##"  class="attr-item '.$selected.'" dataid="'.$val['id'].'">'.$val['attrname'].'</a>';
															 		}
															 		echo '</div>';
															 	}
															 } ?>
			    	...
			    	<div class="tab-pane" id="profile17">
						...
						<div style="margin-left:6px;width:870px;color:red;"> 
						 <span>旅游管家在申请售卖权时，需认真阅读您的“管家培训”内容后才可得到资质。因此请您认真填写在售卖此条线路时，游客最经常问到的至少十个问题（多不限），并提供相对固定的参考答案。</span></div>
							<div class="form-group problem_content" style="margin-left:0.5%;margin-top:20px; margin-left: -15px; display: -moz-inline; display: inline;">
								<?php if(!empty($train)){ 
								  if(count($train)<10){ 
					...
					<?php if(!empty($imgurl)){ 
						...
						?>
						 <li style="float: left;margin:0 10px 10px 0px; width:96px;height:59px;">
						   <div class="img_main0" ><div class="float_img" id="del_img"  onclick="del_line_imgdata(this,<?php echo $v['pid']?>)">×</div>
							<div style="height:60px;"><img  style="height:100%;<?php if($data['mainpic']==$v['filepath']){ echo "border:2px solid #ff9900";} ?> " src="<?php echo $v['filepath']; ?>"></div>
							</div>
			   	 ...
			   	 if(obj.imgurl_str!=''){
				    	...
				    	$.each(pic, function(key, val) {
					    	if(val!=''){
							    ...
							    html+='<div><img  style="width: 78px;height:59px;" src="'+val['filepath']+'"></div>'; 
							    html+='</div>';
...
function ChecklineTrain(){	
	jQuery.ajax({ type : "POST",async:false,data : jQuery('#lineTrainForm').serialize(),async:false,url : "<?php echo base_url()?>admin/b1/product/updateTrain", 
		success : function(response) {
		 	 if(response!='' && response!='0'){	 	 
				alert( '保存成功！' );
				//下一步						
...
$('#upfile').on('click', function() {  
	$.ajaxFileUpload({  
	        url:'<?php echo base_url()?>admin/b1/product/up_file',  
	        secureuri:false,  
	        fileElementId:'line_file',//file标签的id  
	        dataType: 'json',//返回数据的类型  
	        data:{filename:'line_file'},
	        success: function (data, status) {  
	          	if (data.status == 1) {
			$('input[name="file_url"]').val(data.url);
			alert(data.msg);
	            } else {
			alert(data.msg);
		}
