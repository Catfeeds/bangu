...
<script type="text/javascript">
	...
	object = {
            init:function(){ //初始化方法
                          ...
                          //接口数据
                          var post_url="<?php echo base_url('admin/b1/line_single/api_server_range')?>";
...
$(".add_depart").click(function(){
	...
	$("body").on("click",".a_delete",function(){
    	           ...
    	           var url="<?php echo base_url('admin/b1/line_single/api_del_server');?>";
                        var data={id:id};
	...
	$("body").on("click",".btn_add_server",function(){
		...
		var remark=$("#depart_div #remark").val();
                          ...
                          if(showorder=="") {tan('请填写排序');return false;}
                            ...
                            var url="<?php echo base_url('admin/b1/line_single/api_add_server');?>";
