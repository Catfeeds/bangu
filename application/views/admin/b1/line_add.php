...
<style type="text/css">
	...
	.widget-body,.tab-content { background:#fff;}
	#name_list { margin-left:5px;}
	.choice_img,.choice_picture { margin-top:3px;}
	#theme_arr { display:inline-block;margin-left:0;width:100%;}
				...
				<div class="tab-content tabs-flat">
					...
					<div class="tab-pane " id="home11">
						...
						<div style="margin-bottom: 100px;" class="div_bt_i">
							...
							<button class="btn btn-palegreen" type="button" style="margin-left:150px;"  id="next_line" onclick="return CheckLine();" ><b  style="font-size:14px">保存&nbsp;&nbsp;并</b><span style="font-size:12px;padding-left:4px">下一步</span></button><i> </i>
						</div>
						</form>
					</div>
					<!-- 行程安排 -->
					<div class="tab-pane active" id="profile12">
						...
						<div class="lineDayDiv">
							<div class="form-group">
								...
								<input name="daynum" value="<?php echo $num; ?>" id="daynum" type="hidden" />
									<div name="title" class="title_div text-width" style="width: 612px" contenteditable="true" ><?php if(!empty($rout[$i])){ echo $rout[$i]['title']; }?> </div>
							...
							<div class="form-group">
								...
								<div class="form-inline col_ts">
									   <div class="form-group col_ts" style="margin: 0px; width: 100%; max-width: 800px;">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label no-padding-right label-width col_lb" for="inputEmail3">住宿</label>
									<div class="form-inline col_ts">
										<div class="form-group col_ts" style="margin: 0px;">
										     	<div class="col-sm-10 col_ts">
												<input type="text"  style="width:613px;-moz-box-flex: 1; -webkit-box-flex: 1; box-flex: 1;" id="hotel<?php echo $i;?>"
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col_ts" style="">
							...
							<div class="form-group" style=" display: -moz-inherit;;display: -webkit-inherit;;display: inherit;;">
								<label class="col-sm-2 control-label no-padding-right label-width col_lb"
									for="inputEmail3" style=" position: relative; top:10px">行程图片</label>
									<div class="col-sm-10 col_ts" style="width: 640px; padding-left: 15px;">
											       ...
											       foreach ($img_str as $k=>$vl){ 
													if(!empty($vl)){	?> 
											      	    <li class="url_li" style="float:left;list-style:none;margin:0 20px 0px 0px">
															<div class="img_main">
																<div id="del_img" class="float_div" onclick="del_imgdata(this,-1);">×</div>
						...
						<div class="div_bt_i">
							...
							<button class="btn btn-palegreen" type="button" id="sb_rout" onclick="CheckRouting(1)"><b  style="font-size:14px">保存</b></button>
							<button class="btn btn-palegreen" type="button"  id="next_rout"    onclick="CheckRouting(2)" style="margin-left:150px;font-size:14px" ><b >保存&nbsp;&nbsp;并</b><span style="font-size:12px;padding-left:4px">下一步</span></button><i> </i>
						</div>
						</form>
					</div>
					<!-- 设置价格 -->
									...
									<div style="margin-top: 10px;"> 	
									    <form action="<?php echo base_url()?>admin/b1/product/updateLinePrice" accept-charset="utf-8" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" 
									  	...
									  	<div style="margin-top:20px;"><span><span style="color: red;">*</span>成人佣金:</span>
									  		<input style="padding-left: 5px;width:60px;display:inline-block;" type="text" placeholder="15字内 " value="<?php echo $data['agent_rate_int'];?>" id="agent_rate" class="price_input text-width" name="agent_rate"  />
									  		<span>元/人份</span>
									  	<span style="padding-left: 15px;" >小童佣金:</span>
									  		<input style="padding-left: 5px;width:60px;display:inline-block;" type="text" value="<?php echo $data['agent_rate_child'];?>" id="agent_rate_child" class="price_input text-width" name="agent_rate_child"  />
									  		<span>元/人份</span>
									  	</div>
									    ...
									    <input style="padding-left: 5px;display:inline-block;height:28px;" type="text" placeholder="15字内 " value="<?php if(!empty($data['child_description'])){ echo $data['child_description']; }?>" id="child_description" class="price_input col_wd form-control text-width" name="child_description"  /></div>
									    
									    <div style="margin-top:10px;"> <span class=" col_price">儿童不占床说明 :</span>
									    <input style="padding-left: 5px;display:inline-block;height:28px;" type="text" placeholder="15字内 " value="<?php if(!empty($data['child_nobed_description'])){ echo $data['child_nobed_description']; }?>" id="child_nobed_description"  class="price_input col_wd form-control text-width" name="child_nobed_description"  />
									    <span style="padding-left:10px;">提示：填写则在产品页面显示，不填则无显示</span>
									    </div>
									       
									    <div style="margin:10px 0px 10px 0px;"> <span class=" col_price">老人价说明 :</span>
									    <input style="padding-left: 5px;display:inline-block;height:28px;" type="text" placeholder="15字内 " value="<?php if(!empty($data['old_description'])){ echo $data['old_description'];} ?>" id="old_description"  class="price_input col_wd form-control text-width" name="old_description"  /></div>
									    
									    <div style="margin-bottom:30px;"> <span class=" col_price">特殊人群说明:</span>
									    <input type="text" placeholder="15字内 " value="<?php if(!empty($data['special_description'])){ echo $data['special_description'];} ?>" id="special_description" style="padding-left: 5px;display:inline-block;height:28px;" class="price_input col_wd form-control text-width" name="special_description"  /></div>
										</form>
						...
						id="lineLabelForm" novalidate="novalidate" onsubmit="return updateLabel();" >
							<div class="widget-body">
								<div class="form-group" style="padding:0px 0px 10px 0px;">					
										<div class="col-sm-2 control-label no-padding-right label-width col_xl" style="width:100%;max-width: 810px; height:auto;" for="inputEmail3" >
										<p>
										<span style="color: red;">*</span>请点击以下标签进行选择：（客人根据兴趣寻找心仪的旅游线路时，会使用关键字标签进行搜索，若您不设标签将脱离于客人视线之外)</p>
		       ...
		       <div class="modal-header">
			    ...
			    <div class="modal-body"><div class="bootbox-body">
			       <form  class="form-horizontal" id="giftFrom" method="post" action="">	
			         ...
			         <div class="form-group">
			              <label class="col-sm-2 control-label no-padding-right fl" for="inputPassword3"><span style="color: red;">*</span>礼品数量:</label>
			            <div class="col-sm-4 fl">
			               <input type="text" name="account" style="float:left;height:30px;" />&nbsp;<span class="jg_my ">张</span>
			            </div>
			        </div>
	         		<div class="form-group">
			              <label class="col-sm-2 control-label no-padding-right fl" for="inputPassword3"><span style="color: red;">*</span>添加的数量:</label>
			            <div class="col-sm-4 fl">
			               <input type="text" name="add_account" style="float:left;height:30px;" />&nbsp;<span class="jg_my ">张</span>
			            </div>
			        </div>
			          <div class="form-group">
			              <label class="col-sm-2 control-label no-padding-right fl"  for="inputPassword3"><span style="color: red;">*</span>价值:</label>
			            <div class="col-sm-4 fl ">
			               <input type="text" name="worth" style="float:left;height:30px;" />&nbsp;<span class="jg_my">元</span>
			            </div>
			        </div>
			          <div class="form-group">
			...
			<div id="registration-form" class="messages_show" style="height:90%;overflow-y:auto;overflow-x:hidden;margin-top:35px; ">
				<form
					...
					<div class="form-group has-feedback">
						...
						<div class="col-lg-4 fl" style="width:220px" id="linelist_div">
...
function get_dest(type,startcity){
	...
	$.post("/common/area/getRoundTripData",{'startcity':startcity},function(json) {
		...
		if(line_classify==3){  //周边游		
			...
			var line_type=<?php  if(!empty($data['line_type'])){ echo $data['line_type'];}else{ echo 0;} ?>;
			if(line_type==1){
                                                myArray.abroad=chioceDestJson.abroad;
			}else{
				myArray.domestic= chioceDestJson.domestic;
