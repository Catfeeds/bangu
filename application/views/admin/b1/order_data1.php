...
.navbar .navbar-inner{background:#2dc3e8;}
</style>
</head>
<body>
    ...
    <div class="page-body" id="bodyMsg">
        ...
        <div class="page_content bg_gray">      
            ...
            <div class="table_content">
                <div class="itab">
                    <ul> 
                        <li static="1"><a href="#tab1" class="active">用户管理</a></li> 
                    </ul>
                </div>
                        ...
                        <form class="search_form" id="search-condition"method="post" action="">
                            <div class="search_form_box clear">
                                ...
                                <div class="search_group">
                                    <label>姓名:</label>
                                    <input type="text" name="search_name" class="search_input" placeholder="名称"/>
                                </div>
                                <div class="search_group">
                                    <label>手机号:</label>
                                    <input type="text" name="search_moblie" class="search_input" placeholder="名称"/>
                                </div>

                                <div class="search_group">
                                    <input type="button" name="button" class="search_button" value="搜索"/>
                                </div>
                                 <span class="alert_msg1 btn btn_green" style="float: right;">添加</span>
                            </div>
                        </form>
        ...
        <form method="post" action="#" id="employee_from" class="form-horizontal ">
           <div class="form-group">
                ...
                <div class="fg-input">
                      ...
                      ?>
                         <li><label><input type="radio" class="fg-radio" name="roleid" value="<?php echo  $value['roleid'];?>"><?php echo  $value['rolename'];?></label></li>
                      <?php } } ?> 
                    </ul>
                </div>
           </div>
          <div class="form-group">
                ...
                <div class="fg-input"><input type="text" class="loginname" name="loginname" value=""></div>
            </div>
            <div class="form-group">
                <div class="fg-title">密码：<i>*</i></div>
                <div class="fg-input">
                       <input type="password" name="password" id="password" placeholder="不填写则为原密码" >
                </div>
            </div>
            <div class="form-group">
                <div class="fg-title">确认密码：<i>*</i></div>
                <div class="fg-input"><input type="password" class="repass" name="repass" value=""></div>
            </div>
             <div class="form-group">
