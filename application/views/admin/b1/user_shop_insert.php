...
#theme_arr { display:inline-block;margin-left:0;width:100%;font-size:12px;}
...
#theme-list { position: relative; padding-right: 20px;}
#theme-list a { position: absolute; right: 4px;}
		...
		<div class="widget-main ">
			<div class="tabbable">
				<ul id="myTab11" class="nav tabs-flat">
					<li class="home"><a href="#home11" data-toggle="tab" onclick="change_tab()" > 基础信息 </a></li>
					<li><a href="##"  data-toggle="tab" style="color: #aaa" onclick="change_tab()" > 行程安排 </a></li>
					<li><a href="##" data-toggle="tab" style="color: #aaa" onclick="change_tab()" > 设置价格 </a></li>	
					<li><a href="##"  data-toggle="tab" style="color: #aaa" onclick="change_tab()" > 费用说明 </a></li>
					<li><a href="##"  data-toggle="tab" style="color: #aaa"  onclick="change_tab()" > 参团须知</a></li>		
					<li><a href="##"  data-toggle="tab" style="color: #aaa"  onclick="change_tab()" > 产品标签 </a></li>
					<li><a href="##"  data-toggle="tab" style="color: #aaa"  onclick="change_tab()" > 管家培训 </a><li>
					<!-- <li onclick="change_tab()"><a href="##"  data-toggle="tab" style="color: #aaa"> 抽奖礼品</a><li> -->
				</ul>
					<?php
						$class_form = array(
						...
						echo form_open ( 'admin/b1/product_insert/insert', $class_form );
					?>
							...
							<input  type="hidden" name="line_classify" value="<?php if(!empty($line_type)){ echo $line_type ;}else{ echo 0;} ?>" />
                            	<table class="line_base_info table_form_content table_td_border" border="1" width="100%">
                                    <tr height="34" class="form_group">
                                        ...
                                        <td>&nbsp;&nbsp;
                                       		<input type="hidden" id="mold" name="mold" value="<?php if(!empty($mold)){ echo $mold;} ?>">
                                    ...
                                    <tr height="34" class="form_group">
                                        ...
                                        <td>
                                         <?php if(!empty($line_type)){?>
                                                 <?php  if($line_type=="1"){ ?>
                                                      <input type="text" placeholder="目的地-模糊搜索" autocomplete="new-password" class="form_input w_160 fl" id="overcityID" onfocus="showCJDestTree(this);"> 
                                                 <?php  }else if($line_type=="2"){ ?>
                                                      <input type="text" placeholder="目的地-模糊搜索" autocomplete="new-password" class="form_input w_160 fl" id="overcityID" onfocus="showGNDestTree(this);" > 
                                                 <?php }else if($line_type=="3"){  ?>
                                                      <input type="text" placeholder="目的地-模糊搜索" autocomplete="new-password" class="form_input w_160 fl" id="overcityID" onfocus="showZBDestTree(this,$('#lineCityId').val());"  > 
                                                 	  <!--<input type="text" placeholder="目的地-模糊搜索" class="form_input w_160 fl" id="overcityID" onfocus="show_GL_Menu(this.id);" onkeyup="show_GL_Menu(this.id,this.value);" > -->
                                                 <?php  }else{?>
                                    ...
                                    <tr height="34" class="form_group">
                                        ...
                                        <td>
                                        	<input type="text" placeholder="" id="linebefore" value="0"  class="form_input" name="linebefore" style="width: 50px;"/>
											<span>天</span>
											<input type="text" placeholder="" id="linedatehour" value="0"  class="form_input" name="linedatehour" style="width: 50px;"/>
											<span>时</span>
											<input type="text" placeholder="" id="linedateminute"  value="0"  class="form_input" name="linedateminute" style="width: 50px;"/>
											<span>分 截止报名</span>
                                        </td>
                                    </tr>
                                    <tr height="34" class="form_group">
...
<div class="choice_photo_box" style="display: none;">
	<div class="box_content">
        ...
        <div class="box_body">
            ...
            <div class="queren"><span onclick="queren_choice(this);" class="btn" style="background: #2DB7F5;">确认</span></div>
        </div>
    </div>
</div>
...
if(!flag)
{
	...
	jQuery.ajax({ type : "POST",data : jQuery('#registrationForm').serialize(),async:false,url : "<?php echo base_url()?>admin/b1/product_insert/insert", 
		beforeSend:function() {//ajax请求开始时的操作
			...
			success : function(response) {
				...
				if(obj.status==1){
					...
					var mold="<?php if(!empty($mold)){ echo $mold;}else{ echo '0';} ?>";
					if(union_id==1){
						if(mold=="c"){
							window.location.href="/admin/b1/product/toLineEdit?id="+obj.line_id+'&type=-1';
						}else{
							window.location.href="/admin/b1/products/toLineEdit?id="+obj.line_id+'&type=-1';	
						}
