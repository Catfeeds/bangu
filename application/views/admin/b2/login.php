                ...
                <form class="form-horizontal form-bordered" id="b2_login_from" method="post" action="<?php echo site_url('admin/login/do_login')?>">
                    <div class="reg-form" id="js-form-mobile">
                        <div class="reg-font">
                            ...
                            <input type="text" name="username"  placeholder="手机号/邮箱" class="loginname" autocomplete="new-password" disableautocomplete >
                        </div>
                        <div class="reg-font">
                            <div class="fotLeft">
                                <div class="passIco"></div>
                            </div>
                            <input type="password" name="password" class="loginpassword" autocomplete="new-password" placeholder="登录密码">
                        </div>
...
$('#login_submit').click(function(){
	...
	$.post(
		"<?php echo site_url('admin/b2/login/do_login')?>",
