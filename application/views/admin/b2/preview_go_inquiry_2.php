...
<div class="c_reply">
  ...
  <div class="col_div fl">
   ...
   <div class="need_kj clear">
  <div class="col_div fl">
     <label class="td_1" height="40">联系方式：</label>
    <span class="td_2" height="40"><?php echo $grab_custom_data['linkphone']?></span>
    </div>
    <div class="fl">
 ...
 <div class="need_kj clear">
  <div class="col_div fl">
    ...
    <span class="td_2" colspan="">￥<b><?php echo $grab_custom_data['childprice']?></b>/人</span>
     ...
     <div class="need_kj clear">
  <div class="col_div fl">
    <label class="td_1" height="40">微信号：</label>
    <span class="td_2" colspan="1"><?php echo $grab_custom_data['linkweixin']?></span>
    </div>
    <div class="fl">
