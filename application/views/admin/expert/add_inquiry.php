...
<style type="text/css">
#bodyMsg { width:1030px;margin:0 auto !important;}
...
.project_number_info { text-align:center;border:1px solid #d2d2d2;border-left:none;width:85px;padding:7px 10px;display:inline-block;height:20px;line-height:20px;color:#2dc3e8;}

.supplier_reply_check .text { margin-top:0;}
.search_group { margin: 1px 0 0 0;}

.w_80 { width:80px !important;}
.form_input { height: 24px;line-height: 24px;padding: 5px 8px;margin:2px 0;display:inline-block;width:250px;}
.form_textarea { height:100px;padding:5px 8px;margin:5px;width:683px;}
.order_info_table tr td { padding-left:5px;}
select.form_select { height: 26px;line-height: 26px;padding: 5px 8px;margin:2px 0;width:270px;}
div.form_select { margin:2px 0;}

/*目的地选择*/
.to_play_input{ float: left; position: relative;box-sizing:border-box;margin:2px 0;z-index:199;}
...
.mudidi_one{ width: 200px !important; margin-right: 14px; margin: 5px;}
.mudidi_two{ width: 233px !important; margin-right: 14px; margin: 5px;}
.mudidi_three{ width: 240px !important; margin: 5px;}
...
.form_select .search_select .select_list{ left: 5px; top: 38px;}
...
.w_75 { width:75px !important; margin-right: 5px !important;}
.bodyBody{ background:#fafafa}
...
.delPlugin{ line-height: 20px; }
.table_td_border > tbody > tr > td{ border: none !important; }
.order_info_table{ border:none; }
.order_info_title{ border:1px solid #099 !important; }
.small_title_txt{ height: 30px; line-height: 30px; background: #f8f8f8;margin: 10px 0;border-bottom: none; }
.float_div{ position: absolute; top: 10px; right: 10px; background: #099; opacity: 1; color: #fff; border-radius: 50%; width: 21px; height: 21px; line-height: 22px;font-family: "宋体"; font-size: 14px; }
.float_div span{position: relative;left: -2px; }

.page-body{ margin: 0 auto !important;}
.current_page{ height: 40px; line-height: 40px; width:1020px; margin: 0 auto; position: relative; z-index: 1; }
.small_title_txt{ background:none; padding-bottom: 0;}
.form_input,select.form_select{ margin: 0; height: 22px; line-height: 22px; margin: 5px;}
.order_info_table tr td{ padding-left: 0;}
textarea, input[type="text"], input[type="password"], input[type="datetime"], input[type="datetime-local"], input[type="date"], input[type="month"], input[type="time"], input[type="week"], input[type="number"], input[type="email"], input[type="url"], input[type="search"], input[type="tel"], input[type="color"]{ border: 1px solid #ddd ;}
input, textarea, select,.to_play_input input{ border: 1px solid #ddd;}
...
.table_td_border>tbody>tr>td{ border: 1px solid #f2f2f2 !important;}
</style>
</head>
...
<div class="bodyBody">
	<div class="current_page shadow">
        ...
        <span class="right_jiantou">&gt;</span>添加询价单
    </div>
    <!--=================右侧内容区================= -->
    <div class="page-body" id="bodyMsg">
        <!-- ===============转询价单  start============ -->
        <div class="order_detail">
            <h2 class="lineName headline_txt">添加询价单</h2>

            <form id="add_inquiry_form" method="post" action="#">
            <!-- ===============管家需求============ -->
            <div class="content_part">
                <div class="small_title_txt clear">
                    <span class="txt_info fl">管家需求</span>
                </div>
                <div class="project_number"><span class="project_number_title">编号:</span><span class="project_number_info">新增后自动生成</span></div>
                 <table class="order_info_table table_td_border" border="1" width="100%" cellspacing="0">
                    <tr height="40">
                        <td class="order_info_title">出发城市:</td>
                        <td width="320">
                        <input type="text" id="startcity" name="startcity" class="form_input" value="" placeholder="请选择出发城市"/>
                        <input type="hidden" id="startcityId" name="startcityId" value=""/>
                        </td>
            ...
            <input type="text" id="destOne" name="destOne" value=""  readonly="" class="mudidi_one" placeholder="出境/周边/国内" autocomplete="off">
            <u class="pos_right"></u>
            </div>
                        ...
                        <div class="mudidi_input">
                                 <input type="text" id="destTwo" name="destTwo" value="" readonly="" class="mudidi_two" placeholder="选择省份(二级目录)" autocomplete="off">
                                 <input type="hidden" id="destTwoId" name="destTwoId" value="" autocomplete="off">
                                 <u class="pos_right"></u>
                        </div>
                ...
                <div class="mudidi_input">
                       ...
                       <input type="hidden" id="expert_dest_id" name="expert_dest_id" value="" autocomplete="off">
                </div>
                    </div>
                        <!-- 显示选择的目的地标签  -->
                        <div id="destButton"></div>
                        </td>
                    </tr>
                    <tr height="40">
                    ...
                    <td colspan="3" id="travel_type">
                            <div class="form_select">
                                <div class="search_select">
                                    <div class="show_select" status="1" style="width:672px;"></div>
                                ...
                                <input type="hidden" name="trip_way" value="" class="select_value"/>
                            </div>
                        </td>
                    ...
                    <tr height="40">
                        ...
                        <td colspan="3">
                            ...
                            <input type="text" data-val="1" id="datetimepicker" name="startdate" class="form_input" placeholder="YYYY-MM-DD" style="width:682px;" value=""/>
                              <input type="text" data-val="2" name="estimatedate" class="form_input" placeholder="只能手写输入" style="display:none;width:682px;" value=""/>
                        </td>
                    </tr>
                    <tr height="40">
                        <td class="order_info_title">人均预算:</td>
                        <td><input type="text" name="budget" class="form_input" placeholder="请输入您的预算(数字)" value=""/>元/人</td>
                        <td class="order_info_title">出游时长:</td>
                        <td><input type="text" name="days" class="form_input" placeholder="" value="" />天</td>
                    </tr>
                    <tr height="40">
                    ...
                    <tr height="40">
                        ...
                        <td colspan="3"><textarea  name="service_range" class="form_textarea noresize"  placeholder="请安排多预留购物时间，行程安排不要太紧迫了..."></textarea>
        </td>
                    </tr>
                    <tr height="40">
                        <td class="order_info_title">总人数:</td>
                        <td><input type="text" name="total_people" class="form_input" value="" style="width:107px;"/>人</td>
                        <td class="order_info_title">用房数:</td>
                        <td><input type="text" name="roomnum" class="form_input" value=""/>间</td>
                    </tr>
                    <tr height="40">
                        <td class="order_info_title">成员构成:</td>
                        <td colspan="3">
                            成人&nbsp;<input type="text" name="people" class="form_input w_75"value="" />人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            儿童占床&nbsp;<input type="text" name="childnum" class="form_input w_75" value=""/>人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            儿童不占床&nbsp;<input type="text" name="childnobednum" class="form_input w_75" value=""/>人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            老人&nbsp;<input type="text" name="oldman" class="form_input w_75" value=""/>人
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="content_part">
                ...
                <div class="expert_offer_price clear">
                    <div><span>成人价：</span><input type="text" name="price" class="" value=""/>元/人</div>
                    <div><span style="width:80px;">儿童占床价：</span><input type="text" name="childprice" class="" value=""/>元/人</div>
                    <div><span style="width:90px;">儿童不占床价：</span><input type="text" name="childnobedprice" class="" value=""/>元/人</div>
                    <div style="margin-right:0;"><span style="width:55px;">老人价：</span><input type="text" name="oldprice" class="" value=""/>元/人</div>
                </div>
                <div class="price_explain clear">
                    <div class="price_explain_title">方案推荐：</div>
                    <textarea name="price_description" placeholder="字数不限"></textarea>
                </div>
            </div>
            ...
            <div class="content_part">
                ...
                <div class="price_explain clear">
                    ...
                    <textarea name="plan_design" placeholder="字数不限"></textarea>
                </div>

                <div class="project_name clear">
                    <div class="price_explain_title">方案名称：</div>
                    <input type="text" placeholder="方案名称" class="travel_describe w_705" name="ca_title" value="" />
                </div>
...
function click_this_type(obj){
    ...
    $(obj).parent().siblings("input").hide();
    $(obj).parent().parent().find("input[data-val="+status+"]").show();
}
