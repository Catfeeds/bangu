...
.price_explain_title { float:left;color: #09c;width:90px;padding-right:5px;text-align:right; font-size: 12px;}
...
.project_name{ margin-bottom:0;}
.project_number { height:50px;line-height:40px;font-family:"微软雅黑";}
.project_number_title { border-radius:5px 0 0 5px;background: #09c;color:#fff;height:20px;line-height:20px;padding:10px 15px;}
.project_number_info { text-align:center;border:1px solid #09c;border-left:none;width:80px;padding:7px 10px;display:inline-block;height:20px;line-height:20px;color:#09c; border-radius:0 5px 5px 0;}
...
.small_title_txt{border-bottom: 1px solid #ddd;}
.form_btn { margin: 0; height: 50px; line-height: 60px; background: #f9f9f9; padding-top: 20px; margin-top:20px ;}
.form_btn input{margin-left: 250px;}
.dayNum i{ color:  #09c;}
.travel_arrange .travelDay{padding: 20px 0;}
.nav-tabs>li.active>a, .nav-tabs>li.active>a:hover, .nav-tabs>li.active>a:focus{ border-left: 1px solid #ddd !important; border-right: 1px solid #ddd; position: relative; top: 1px;}
        ...
        <?php endif;?>
            ...
            <div class="content_part">
                ...
                <div class="table_content">
                    ...
                    <div class="tab_content" style="box-shadow: none; border: 1px solid #ddd ;">
                        <div class="table_list">
                        	<div class="project_nameclear" style="position: relative; z-index: 1;">
                                <div class="important_title" style="font-size:12px">*请填写方案名称,这样您的方案才会展示在用户定制方案列表中。</div>
                                <div class="" style=" margin: 20px 0; height: 40px ;line-height: 40px; padding: 10px;">
	                                <div class="price_explain_title " style=" height: 32px; line-height: 32px; font-size: 14px;"><i class="important_title">*</i>方案名称：</div>
	                                <input type="text" placeholder="方案名称" class="travel_describe w_705" name="plan_name" style=" height: 20px; line-height: 20px;" value="<?php echo $expert_baojia['ca_title']?>"/>
                        	 	</div>
                        	 </div>
                                      ...
                                      <div class="form_group clear">
                                        ...
                                        <div class="input_field">
                                             <div class="traffic_type">
                                                <div class="traffic_content" type="text" contenteditable="true"><?php echo $item['cj_title']?></div>
