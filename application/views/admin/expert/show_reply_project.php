...
<style type="text/css">
	...
	.form_btn span  { margin-left:450px;}
   ...
   <!--=================右侧内容区================= -->
    <div class="page-body" id="bodyMsg">
        ...
        <div class="order_detail">
            <h2 class="lineName headline_txt">查看回复方案</h2>
            ...
            <div class="content_part">
                ...
                <div class="price_explain clear">
                    <div class="price_explain_title"><i class="important_title">*</i>方案推荐：</div>
                ...
                <!-- Start 详细行程开始-->
                    ...
                    <div class="travel_arrange">
                        ...
                        <div class="travelDay">
                          ...
                          <div class="form_group clear">
                            <div class="travel_content_title">行程安排:</div>
