...
<style type="text/css">
    ...
    .price_explain_title { float:left;color:#056DAB;width:90px;padding-right:5px;text-align:right;}
    ...
    .current_page{ width: 1020px; margin: 0 auto; position: relative; z-index: 1;}
    .order_detail{ margin-top: 0;}
    .small_title_txt{ height: 40px; line-height: 40px;}
    .project_number_title{ background: #056DAB;}
    .project_number_info{ border: 1px solid #056DAB; border-radius: 0 5px 5px 0; color: #056DAB;}
    .close_page { background: #056DAB !important;}
	...
	.page-body { width:1030px;margin:0 auto;}
</style>
</head>
         ...
         <div class="price_explain clear">
            ...
            <div class="content_part">
                ...
                <div class="price_explain clear">
                    ...
                    <div class="price_explain_info"><?php echo $grab_custom_data['plan_description'];?></div>
                </div>
