		               ...
		               <form method="post" action="#" id="add-data" class="form-horizontal">
		                 <table class="order_info_table table_td_border" border="1" width="100%" cellspacing="0">
		                    ...
		                    <tr height="40">
		                        ...
		                        <td class="order_info_title">上传流水单<i style='color:red;'>*</i>:</td>
		                        <td>
...
$("body").on("click",".btn_submit",function(){
	...
	if(!flag)
	{
	   ...
	   /*  if(type=="") { tan('请选择发票类型');return false; }
	    ...
	    var url="<?php echo base_url('admin/t33/sys/approve/api_hand_add');?>";
	    var data={expert_id:expert_id,depart_id:depart_id,addtime:addtime,money:money,way:way,code:code,bankname:bankname,bankcard:bankcard,remark:remark,code_pic:code_pic};
