                ...
                <div class="printf_div" id="printf_div">
                    ...
                    <div class="table_list">
                        ...
                        <table class="table table-bordered table_hover printTable">
                            ...
                            <tbody class="data_rows">
                               ...
                               <tr><td class="td_right">申请人：</td><td class="td_left"><?php echo $row['expert_name'];?></td><td class="td_right">经办人：</td><td class="td_left"><?php echo $row['employee_name'].'（'.$row['u_time'].'）';?></td></tr>
                  ...
                  <?php  } ?>
                   ...
                   <p class="p_line">付款申请明细</p>
					...
					<div style="float: left;width:80%;margin-bottom:0px;" class="pagehead">
                    <p>抬头：<?php echo $row['bankcompany'];?></p>
                    <p>账号：<?php echo $row['bankcard'];?></p>
                    <p>开户行：<?php echo $row['bankname'];?></p>
                    </div>
                <!--endprint1-->  
                 <div class="fb-form noprint" style="width:96%;overflow:hidden;">
