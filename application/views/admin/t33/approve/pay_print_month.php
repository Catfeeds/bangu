...
<script type="text/javascript">
	...
	object = {
        ...
        init:function(){ //   打印的数据
            ...
            if(action=="1")
	        	$(".tr_rows").html('<th>订单号</th><th>团号</th><th>付款单号</th><th>营业部</th><th>线路名称</th><th>人数</th><th>总团款</th><th>应付款</th><th>本次结算金额</th><th>操作费</th><th>已付款</th><th>未付款</th>');
        	else if(action=="2")
        		$(".tr_rows").html('<th>团号</th><th>付款单号</th><th>营业部</th><th>线路名称</th><th>人数</th><th>总团款</th><th>本次结算金额</th><th>应付款</th><th>操作费</th><th>已付款</th><th>未付款</th>');
        	...
        	if(return_data.code=="2000")
        	{
            	...
            	for(var i in data)
         	    {
         	       ...
         	       str +=     "<td>"+input_str+"</td>"; //checkbox
         	        ...
         	        str +=     "<td style='width:56px;'>"+data[i].ordersn+"</td>";
         	        
         	        str +=     "<td style='width:80px;'>"+data[i].item_code+"</td>";
         	        str +=     "<td style='width:40px;'>"+data[i].payable_id+"</td>";
         	        
         	        //str +=     "<td>"+data[i].apply_percent+"</td>";
         	        str +=     "<td style='width:60px;'>"+data[i].depart_name+"</td>";
         	        str +=     "<td style='width:60px;'>"+data[i].productname+"</td>";
         	        str +=     "<td style='width:30px;'>"+data[i].total_people+"</td>";
         	        str +=     "<td style='width:80px;text-align:right;'>"+data[i].supplier_cost+"</td>";
                   //str +=     "<td>"+data[i].supplier_cost+"</td>";
                    str +=     "<td style='width:80px;text-align:right;'>"+data[i].jiesuan_money+"</td>";
                    str +=     "<td style='width:80px;text-align:right;'>"+data[i].amount_apply+"</td>";
                    str +=     "<td style='width:80px;text-align:right;'>"+data[i].all_platform_fee+"</td>";
         	        
         	        str +=     "<td style='width:80px;text-align:right;'>"+data[i].balance_money+"</td>";
         	        
         	        if(data[i].status=="1" || data[i].status=="2")
         	        	str +=     "<td style='width:80px;text-align:right;'>"+data[i].nopay_money2+"</td>";
         	        else
         	        	str +=     "<td style='width:80px;text-align:right;'>"+data[i].nopay_money+"</td>";
            	...
            	str +=     "<tr><td colspan='3' align=\"right\">总计：</td><td colspan='2'></td><td>"+all_people+"</td><td style='text-align:right;'>"+supplier_cost_total+"</td><td style='text-align:right;'>"+jiesuan_money_total+"</td><td style='text-align:right;'>"+amount_apply_total+"</td><td style='text-align:right;'>"+platform_fee_total+"</td><td style='text-align:right;'>"+balance_money_total+"</td><td style='text-align:right;'>"+nopay_money_total+"</td></tr>";
