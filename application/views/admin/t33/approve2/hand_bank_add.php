		            ...
		            <div class="content_part">
		               <form method="post" action="#" id="add-data" class="form-horizontal">
		                 <table class="order_info_table table_td_border" border="1" width="100%" cellspacing="0">
		                    ...
		                    <tr height="40">
		                    	<td class="order_info_title">认款方式<i style='color:red;'>*</i>:</td>
		                        <td colspan="3">
		                          <div class="search_group" style="margin:5px 0px;">
                                  
                                    <div class="form_select">
                                        <div class="search_select div_way">
                                            <div class="show_select ul_way" data-value="转账" style="padding-left: 4px;height:31px;line-height:31px;">转账</div>
		                    ...
		                    <tr height="40">
		                        ...
		                        <td class="order_info_title" style="width:90px;">上传流水单<i style='color:red;'>*</i>:</td>
		                        <td colspan="3">
...
$("body").on("click",".btn_submit",function(){
	...
	if(!flag)
	{
	    ...
	    //if(code=="") { tan('请填写凭证');return false; }
	    if(code_pic=="") { tan('请上传流水单');return false; }
	    /*if(invoice_code=="") { tan('收据号不能为空');return false; }
	    if(voucher=="") { tan('收款单号不能为空');return false; } */
	    //if(remark=="") { tan('备注不能为空');return false; }

	    var url="<?php echo base_url('admin/t33/sys/approve2/api_hand_bank_add');?>";
	    var data={expert_id:expert_id,depart_id:depart_id,addtime:addtime,money:money,way:way,bankname:bankname,bankcard:bankcard,remark:remark,code_pic:code_pic};
