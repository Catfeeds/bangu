        ...
        <div class="page_content_detail bg_gray" style="width: 100%;">      
            ...
            <div class="p_content" style="">
                <div id="printf_div" class="printf_div">
                    ...
                    <p class="p_line" style="font-family: Microsoft YaHei;font-size: 14px;text-align: center;">认款确认单</p>
                    <!-- 收款确认单-->
                    <div class="table_list" style="margin: 0 auto;text-align: center;">
                        <table class="table_list printTable" style="border: 1px solid #000;" border="1" width="100%">
                            <tbody class="data_rows">
                               ...
                               <tr><td>经理：</td><td class="td_left"><?php echo $row['commit_name'];?></td><td>提交时间：</td><td class="td_left"><?php echo $row['addtime'];?></td><td>备注：</td><td class="td_left"><?php echo $row['remark'];?></td></tr>
                               <tr><td colspan="6" class="td_left">审核信息</td></tr>
                               <tr><td>审核人：</td><td class="td_left"><?php echo $row['employee_name'];?></td><td>审核时间：</td><td class="td_left"><?php echo $row['modtime'];?></td><td>审核备注：</td><td class="td_left"><?php echo $row['reply'];?></td></tr>
                            </tbody>
                        </table>
                    </div>  
                     <!-- 收款记录明细 -->
                    <p class="p_line" style="font-size: 14px;font-family: Microsoft YaHei;">认款记录明细</p>
                    <div class="table_list" style="margin: 0 auto;text-align: center;">
                        <table class="table_list printTable" style="border: 1px solid #000;"  border="1" width="100%" >
                            <thead class="">
                                <tr>
