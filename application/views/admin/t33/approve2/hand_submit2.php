                               ...
                               <?php $total_tongguo_money=0;if(!empty($list)):?>
                                 <?php foreach ($list as $k=>$v):?>
                                  ...
                                  <?php if($action=="2"): //审核的时候显示checkbox ?>
                                   ...
                                   ?>
                                   <input style='margin:0 5px;' type="checkbox" class="input_check <?php echo $class_str;?>" checked <?php echo $disabled_str;?> data-id="<?php echo $v['id'];?>" data-value="<?php echo $v['money'];?>" />
                                   </td>
                                <?php endif;?>
                                  
                                   <td><a style='margin:0;' href='javascript:void(0)' class='a_detail' data-id='<?php echo $v['id'];?>'><?php echo $v['id'];?></a></td>
                                   <td style="color:#FF6537;"><?php echo sprintf("%.2f",$v['money']);?></td>
                                   <td><?php echo $v['expert_name'];?></td>
                                   <td><?php echo $v['depart_name'];?></td>
                                   <td><?php echo $v['remark'];?></td>
                                   <td><a style='margin:0;' href='javascript:void(0)' class='a_order' data-id='<?php echo $v['order_id'];?>'><?php echo $v['order_sn'];?></a></td>
                                   <td><a style='margin:0;' href='javascript:void(0)' class='a_teamcode' data-id='<?php echo $v['item_code'];?>'><?php echo $v['item_code'];?></a></td>
                                   <td><?php echo $v['way'];?></td>
                                   <td><a style='margin:0;' href='javascript:void(0)' class='a_supplier' data-id='<?php echo $v['supplier_id'];?>'><?php echo $v['brand'];?></a></td>
    ...
    $("body").on("click",".btn_approve",function(){
    	...
    	if(!flag)
    	{
	        ...
	        if(return_data.code=="2000")
	        {
	        	...
	        	setTimeout(function(){t33_close_iframe_noreload();},500);
	        	 $(".input_check").each(function(index,data){
    	    	     if($(this).is(':checked'))
    				 {
...
function cal()
{
     ...
     if($(this).is(':checked'))
	 {
		 ...
		 money=object.accAdd(money,value);
	   }	  
      })
