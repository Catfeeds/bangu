...
<html>
    ...
    .buts {text-align: center;padding: 0px 0px 50px;}
                        ...
                        <div id="sortable">
                            <div class="itomgs">
                                <div class="sortableContent preHetong">
                                    ...
                                    <div class="pre_title">出境旅游合同</div>
                                    <div class="pre_BanTop">合同编号：<span class="pre_bottom pre_RedColor"><?php echo $detailArr['contract_code'];?></span></div>
                                    <div class="pre_Text">旅游者：<input type="text" name="travelman" readonly="readonly" value="<?php echo $detailArr['travelman'];?>" class=" inputNone pre_bottom pre_T250">等 <input type="text"  name="travelnum" readonly="readonly" value="<?php echo $detailArr['travelnum'];?>" class=" inputNone pre_bottom pre_T50">人（名单可附页）;</div>
                                    <div class="pre_Text">旅行社：<input type="text" name="travel_agency" readonly="readonly" value="<?php echo $detailArr['travel_agency'];?>" class=" inputNone pre_bottom pre_T250"> ;</div>
                                    <div class="pre_Text">旅行社业务经营许可证编号<input type="text" name="business_code" readonly="readonly" value="<?php echo $detailArr['business_code'];?>" class=" inputNone pre_bottom pre_T150"> .</div>
                                    ...
                                    <div class="pre_Text pre_indent "> 
                                    	出发时间<input type="text" name="start_year" readonly="readonly" value="<?php echo $detailArr['start_year'];?>" class="inputNone pre_bottom pre_T40">年<input type="text" name="start_month" readonly="readonly" value="<?php echo $detailArr['start_month'];?>" class=" inputNone pre_bottom pre_T40">月<input type="text" name="start_day" readonly="readonly" value="<?php echo $detailArr['start_day'];?>" class=" inputNone pre_bottom pre_T40">日<input type="text" name="start_time" readonly="readonly" value="<?php echo $detailArr['start_time'];?>" class=" inputNone pre_bottom pre_T40">时，
                                    	结束时间<input type="text" name="end_year" readonly="readonly" value="<?php echo $detailArr['end_year'];?>" class=" inputNone pre_bottom pre_T40">年<input type="text" name="end_month" readonly="readonly" value="<?php echo $detailArr['end_month'];?>" class=" inputNone pre_bottom pre_T40">月<input type="text" name="end_day" readonly="readonly"  value="<?php echo $detailArr['end_day'];?>" class=" inputNone pre_bottom pre_T40">日<input type="text" name="end_time" readonly="readonly" value="<?php echo $detailArr['end_time'];?>" class=" inputNone pre_bottom pre_T40">时；
                                    	共<input type="text" name="days" readonly="readonly" value="<?php echo $detailArr['days'];?>" class=" inputNone pre_bottom pre_T40">天，饭店住宿<input type="text" name="nights" readonly="readonly" value="<?php echo $detailArr['nights'];?>" class=" inputNone pre_bottom pre_T40">夜。</div>

                                    <div class="pre_H20"></div>

                                    <div class="pre_Text pre_indent pre_winf">第十三条<span class="pre_T20"></span>旅游费用及支付（以人民币为计算单位）</div>
                                    <div class="pre_Text pre_indent ">成人<input type="text" name="adultprice" readonly="readonly" value="<?php echo $detailArr['adultprice'];?>" class=" inputNone pre_bottom pre_T40">元/人，儿童（不满12岁）<input type="text" name="childprice" readonly="readonly" value="<?php echo $detailArr['childprice'];?>" class=" inputNone pre_bottom pre_T40">元/人；其中，导游服务费 <input type="text" name="serverprice" readonly="readonly" value="<?php echo $detailArr['serverprice'];?>" class=" inputNone pre_bottom pre_T40">元/人；</div>
                                    <div class="pre_Text pre_indent ">旅游费用合计：<input type="text" name="total_travel" readonly="readonly" value="<?php echo $detailArr['total_travel'];?>" class=" inputNone pre_bottom pre_T50">元。</div>
                                    <div class="pre_Text pre_indent ">旅游费用支付方式：<input type="text" name="pay_way" readonly="readonly" value="<?php echo $detailArr['pay_way'];?>" class=" inputNone pre_bottom pre_T50">。</div>
                                    <div class="pre_Text pre_indent ">旅游费用支付时间：<input type="text" name="pay_time" readonly="readonly" value="<?php echo $detailArr['pay_time'];?>" class=" inputNone pre_bottom pre_T100">。</div>
                                    ...
                                    <div class="pre_Text pre_indent "><input type="radio" name="is_buy" <?php if ($detailArr['is_buy'] ==1) {echo 'checked="checked"';}?> value="1" disabled="disabled" class="checkReact">委托旅行社购买：保险产品名称<input type="text" name="insurance_name" readonly="readonly" value="<?php echo $detailArr['insurance_name'];?>" class=" inputNone pre_bottom pre_T100">（投保的相关信息以实际保单为准）；</div>
                                    <div class="pre_Text pre_indent "><input type="radio" name="is_buy" <?php if ($detailArr['is_buy'] ==2) {echo 'checked="checked"';}?> value="2" disabled="disabled" class="checkReact">自行购买</div>
                                    <div class="pre_Text pre_indent "><input type="radio" name="is_buy" <?php if ($detailArr['is_buy'] ==3) {echo 'checked="checked"';}?> value="3" disabled="disabled" class="checkReact">放弃购买。</div>

                                    <div class="pre_H20"></div>

                                    <div class="pre_Text pre_indent pre_winf">第十五条<span class="pre_T20"></span>成团人数与不成团的约定</div>
                                    <div class="pre_Text pre_indent ">成团的最低人数：<input type="text" name="min_num" readonly="readonly" value="<?php echo $detailArr['min_num'];?>" class=" inputNone pre_bottom pre_T50">人。</div>
                                    <div class="pre_Text pre_indent ">如不能成团，旅游者是否同意按下列方式解决：</div>
                                    <div class="pre_Text pre_indent ">1.<input type="text" name="is_agree_contract" readonly="readonly" value="<?php echo $detailArr['is_agree_contract'];?>" class=" inputNone pre_bottom pre_T50">（同意或者不同意，打勾无效）旅行社委托          旅行社履行合同；  </div>
                                    <div class="pre_Text pre_indent ">2.<input type="text" name="is_agree_delay" readonly="readonly" value="<?php echo $detailArr['is_agree_delay'];?>" class=" inputNone pre_bottom pre_T50">（同意或者不同意，打勾无效）延期出团；</div>
                                    <div class="pre_Text pre_indent ">3.<input type="text" name="is_agree_change" readonly="readonly" value="<?php echo $detailArr['is_agree_change'];?>" class=" inputNone pre_bottom pre_T50">（同意或者不同意，打勾无效）改签其他线路出团；</div>
                                    <div class="pre_Text pre_indent ">4.<input type="text" name="is_agree_relieve" readonly="readonly" value="<?php echo $detailArr['is_agree_relieve'];?>" class=" inputNone pre_bottom pre_T50">（同意或者不同意，打勾无效）解除合同。</div>

                                    <div class="pre_H20"></div>

                                    <div class="pre_Text pre_indent pre_winf">第十六条<span class="pre_T20"></span>拼团约定</div>
                                    <div class="pre_Text pre_indent ">旅游者<input type="text" name="is_agree_group" readonly="readonly" value="<?php echo $detailArr['is_agree_group'];?>" class=" inputNone pre_bottom pre_T50">（同意或者不同意，打勾无效）采用拼团方式拼至<input type="text" name="group_travel" readonly="readonly" value="<?php echo $detailArr['group_travel'];?>" class=" inputNone pre_bottom pre_T100">旅行社成团。</div>
...
<!--                                         <input type="text" name="other_matter" readonly="readonly" value="" class=" inputNone pre_block_border "> -->
                                    ...
                                    <div class="pre_Text pre_indent ">本合同一式<input type="text" name="copie" readonly="readonly" value="<?php echo $detailArr['copie'];?>" class=" inputNone pre_bottom pre_T30">份，双方各持<input type="text" name="mutual_copie" readonly="readonly" value="<?php echo $detailArr['mutual_copie'];?>" class=" inputNone pre_bottom pre_T30">份，具有同等法律效力，自双方当事人签字盖章或电子确认之日起生效。</div>
                                    <div class="pre_H40"></div>
                                    ...
                                    <ul class="sign-region">
                                    	...
                                    	<li>
                                    		...
                                    		<div class="sign-con" style="text-indent: 46px;"><?php if (!empty($fileData['gs_time'])){echo date('Y-m-d' ,strtotime($fileData['gs_time'])); }?></div>
                                    	</li>
                                    	<?php if (!empty($fileData['guest_sign'])):?>
                                    	<li class="sign-pic" style="left:30%;">
                                    		<img src="<?php echo $fileData['guest_sign']?>" />
                                    	</li>
                                    	<?php endif;?>
                                    </ul>
                                    <ul class="sign-region">
                                    	<li>
                                    		...
                                    		<div class="sign-con" style="text-indent: 84px;"><?php echo $detailArr['travel_agency']?></div>
                                    	</li>
                                    	<li>
                                    	...
                                    	<li class="sign-pic" style="left:50%;width:41%;">
                                    		<img src="<?php echo $fileData['bangu_sign']?>" />
                                    	</li>
                                    	<?php endif;?>
                                    	<?php if (!empty($fileData['union_sign'])):?>
                                    	<li class="sign-pic" style="left: 20%;width:40%;">
                                    		<img src="<?php echo $fileData['union_sign']?>" />
                                    	</li>
                                    	<?php endif;?>
