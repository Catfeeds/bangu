        ...
        <div class="page_content bg_gray">      
            <div class="table_content">
                <div class="tab_content">
                	<form class="search_form" method="get" id="search-condition" action="/admin/t33/sys/count/depart_p_count/index">
                    	<div class="search_form_box clear">
                        	<div class="search_group">
                            	<label>统计方式：</label>
                                <select class="search-select" style="padding:0px;" name="type" >
                            ...
                            <div class="actoeln search-quarter"  <?php if ($type == 2) { echo 'style="display:block;"'; } ?>>
                            	...
                            	?>
                            	<select class="search-select" style="width:100px;padding:0px;" name="start_quarter" >
                            		<?php echo $options;?>
                            	</select>
                            	<select class="search-select" style="width:100px;padding:0px;" name="end_quarter">
                            		<?php echo $options;?>
                            	</select>
                            </div>
                            ...
                            <div class="actoeln search-year" <?php if ($type == 3) { echo 'style="display:block;"'; } ?>>
                            	...
                            	?>
                            	<select class="search-select" style="width:100px;padding:0px;" name="start_year">
                            		<?php echo $options;?>
                            	</select>
                            	<select class="search-select" style="width:100px;padding:0px;" name="end_year">
                            		<?php echo $options;?>
                            	</select>
                            </div>
                                ...
                                <tr>
                                	...
                                	<?php 
                                		foreach($titleArr as $val){
                                			foreach($val['key'] as $i)
                                			{
                                				$last = substr($i ,-1);
                                				if ($type == 1) {
                                					echo '<td class="depart-num">';
                                					echo '<a data-val="'.$v['depart_id'].'" data-type="'.$last.'" data-name="'.$v['depart_name'].'" data-time="'.$val['title'].'" href="javascript:void(0);" onclick="chioce(this);">'.$v[$i].'</a>';
                                					echo '</td>';
                                				} else {
                                					echo '<td class="depart-num">'.$v[$i].'</td>';
                                				}
                                			}
                                		}
                                	?>
...
$('#export-excel').click(function(){
	$.ajax({
		url:'/admin/t33/sys/count/depart_p_count/exportExcel',
...
function chioce(obj) {
	...
	if (type == 1) {
		var title = name+timeArr[1]+'月份出境游人数统计';
	} else if (type == 2) {
		var title = name+timeArr[1]+'月份国内游人数统计';
	} else {
		var title = name+timeArr[1]+'月份周边游人数统计';
	}
	...
	window.top.openWin({
		  ...
		  fix: true, //不固定
		  maxmin: true,
		  content: "<?php echo base_url('/admin/t33/sys/count/depart_p_count/wholeExcel');?>"+"?id="+departId+'&type='+type+'&time='+time+'&name='+name
	});
