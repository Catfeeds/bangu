        ...
        <div class="page_content bg_gray">      
            <div class="table_content">
                <div class="tab_content">
                	<form class="search_form" method="get" id="search-condition" action="/admin/t33/sys/count/line_income/index">
                    	<div class="search_form_box clear">
                            ...
                            <div class="search_group" style="margin-left:15px;">
                            	<label>线路名称：</label>
                                <input type="text" name="linename" value="<?php echo $linename?>" style="height:24px;line-height:22px;">
                            </div>
                            <div class="search_group" style="margin-left:15px;">
                            	<label>线路编号：</label>
                                <input type="text" name="linecode" value="<?php echo $linecode?>" style="height:24px;line-height:22px;">
                            </div>
                            <div class="search_group">
...
$('#export-excel').click(function(){
	$.ajax({
		url:'/admin/t33/sys/count/line_income/exportExcel',
