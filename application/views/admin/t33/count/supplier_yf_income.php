        ...
        <div class="page_content bg_gray">      
            <div class="table_content">
                <div class="tab_content">
                	<form class="search_form" method="get" id="search-condition" action="/admin/t33/sys/count/supplier_yf_income/index">
                    	<div class="search_form_box clear">
                            ...
                            <div class="search_group" style="margin-left:15px;">
                            	<label style="width:73px;">供应商名称：</label>
                                <input type="text" name="name" value="<?php echo $name?>" style="height:24px;line-height:22px;">
                            </div>
                            <div class="search_group" style="margin-left:15px;">
                            	<label style="width:73px;">供应商品牌：</label>
                                <input type="text" name="brand" value="<?php echo $brand?>" style="height:24px;line-height:22px;">
                            </div>
                            <div class="search_group">
...
$('#export-excel').click(function(){
	$.ajax({
		url:'/admin/t33/sys/count/supplier_yf_income/exportExcel',
