    ...
    <div class="page-body" id="bodyMsg">
        ...
        <div class="page_content bg_gray">      
            <div class="table_content">
            	<div class="itab">
                    <ul class="tab-nav"> 
                        <li data-val="1"><a href="/admin/t33/sys/count/union_fee_count/index?countType=1" class="<?php if ($countType==1) {echo 'active';}?>">按团队统计</a></li> 
                        <li data-val="2"><a href="/admin/t33/sys/count/union_fee_count/index?countType=2" class="<?php if ($countType==2) {echo 'active';}?>">按营业部统计</a></li> 
                    </ul>
                </div>
                <div class="tab_content">
                	<form class="search_form" method="get" id="search-condition" action="/admin/t33/sys/count/union_fee_count/index">
                    	<div class="search_form_box clear">
                            ...
                            <div class="actoeln search-quarter"  <?php if ($type == 2) { echo 'style="display:block;"'; } ?>>
                            	...
                            	?>
                            	<select class="search-select" style="width:120px;height:24px;line-height:24px;padding:0;" name="start_quarter" >
                            		<?php echo $options;?>
                            	</select>
                            	<select class="search-select" style="width:120px;height:24px;line-height:24px;padding:0;" name="end_quarter">
                            		<?php echo $options;?>
                            	</select>
                            </div>
                            ...
                            <div class="actoeln search-year" <?php if ($type == 3) { echo 'style="display:block;"'; } ?>>
                            	...
                            	?>
                            	<select class="search-select" style="width:120px;height:24px;line-height:24px;padding:0;" name="start_year">
                            		<?php echo $options;?>
                            	</select>
                            	<select class="search-select" style="width:120px;height:24px;line-height:24px;padding:0;" name="end_year">
                            		<?php echo $options;?>
                            	</select>
                            </div>
                            ...
                            <div class="search_group" style="margin-left:15px;">
                            	<label>团号：</label>
                                <input type="text" name="code" class="search_input" value="<?php echo $code?>" style="width:120px;height:22px;line-height:22px;">
                            </div>
                            <?php else:?>
                            
                            <div class="search_group" style="margin-left:15px;">
                            	<label>营业部：</label>
                                <input type="text" name="name" class="search_input" value="<?php echo $name?>" style="width:120px;height:22px;line-height:22px;">
                            </div>
                            <?php endif;?>
                            <div class="search_group">
                            	...
                            	<input type="hidden" name="countType" value="<?php echo $countType?>">
                            ...
                            <thead class="">
                                <tr>
                                    ...
                                    <th class="posTh" data-val="total">
                                    	...
                                    	<i class="price_icon_bottom <?php if ($by_type=="desc"){echo 'active';}?>"></i>佣金总计
                                    </th>
                                </tr>
                            </thead>
...
$('#export-excel').click(function(){
	$.ajax({
		url:'/admin/t33/sys/count/union_fee_count/exportExcel',
...
function chioce(obj) {
	...
	window.top.openWin({
		  ...
		  fix: true, //不固定
		  maxmin: true,
		  content: "<?php echo base_url('/admin/a/statistics/depart_p_count/wholeExcel');?>"+"?id="+departId+'&type='+type+'&time='+time+'&name='+name
	});
	...
	layer.confirm(
		...
		function(){
			window.top.openWin({
				  ...
				  fix: true, //不固定
				  maxmin: true,
				  content: "<?php echo base_url('/admin/a/statistics/depart_p_count/wholeExcel');?>"+"?id="+departId+'&type='+type+'&time='+time
			});
		}
	);
}
