    ...
    <div class="fb-form">
        <form method="post" action="#" id="add-data" class="form-horizontal" style="z-index:1;">
            ...
            <div class="form-group div5">
                ...
                <div class="small-input"><input type="text" id="nickname" class="showorder" placeholder="昵称" value="<?php echo $expert['nickname'];?>"></div>
            </div>
...
object = {
    ...
    submitData:function(){  //提交表单
    	...
    	var post_url="<?php echo base_url('admin/t33/expert/to_edit')?>";
