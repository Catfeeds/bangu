    ...
    <div class="fb-form">
        <form method="post" action="#" id="add-data" class="form-horizontal" style="z-index:1;">
            ...
            <div class="form-group div5">
                ...
                <div class="small-input"><input type="text" id="realname" class="showorder" placeholder="真实姓名" value="<?php echo $expert['realname'];?>"></div>
            </div>
            ...
            <div class="form-group div7">
                ...
                <div class="fg-input">
                    <ul>
                    	<li><label><input type="radio" class="fg-radio radio_sex" name="sex" value="1" <?php if($expert['sex']=="1") echo "checked";?>>男</label></li>
                        <li><label><input type="radio" class="fg-radio radio_sex" name="sex" value="0" <?php if($expert['sex']!="1") echo "checked";?>>女</label></li>
            ...
            <div class="form-group div7">
                ...
                <div class="small-input"><input type="text" id="depart_id" class="showorder" value="<?php echo $expert['depart_name'];?>" data-id="<?php echo $expert['depart_id'];?>" onfocus="showMenu(this.id,this.value);" onkeyup="showMenu(this.id,this.value);"></div>
            ...
            <div class="form-group div7">
                ...
                <div class="fg-input">
                    <ul>
                    	<li><label><input type="radio" class="fg-radio is_dm" name="is_dm" value="0" <?php if($expert['is_dm']=="0") echo "checked";?> >销售</label></li>
                        <li><label><input type="radio" class="fg-radio is_dm" name="is_dm" value="1" <?php if($expert['is_dm']=="1") echo "checked";?>>经理</label></li>

                    </ul>
                </div>
            </div>
            <?php if($expert['type']=="2"):?>
             <div class="form-group div24">
                <div class="fg-title">证件类型：<i>*</i></div>
                <div class="form_select">
                  
                 
                  	<select name="country" class="select_one" id="idcardtype" data-value="" style="width:137px">
                  		 <option value="<?php echo $expert['idcardtype']?>"><?php echo $expert['idcardtype_name'];?></option>
            ...
            <div class="form-group div8">
                ...
                <div class="small-input"><input type="text" id="idcard" class="showorder" placeholder="" value="<?php echo $expert['idcard'];?>"></div>
            </div>
          
          <!--  
            <div class="form-group div10">
                <div class="fg-title">微信：</div>
                <div class="small-input"><input type="text" id="weixin" class="showorder" placeholder="" value="<?php echo $expert['weixin'];?>"></div>
            </div>
            -->
            <!--  
             <div class="form-group div11">
                <div class="fg-title">擅长线路：<i>*</i></div>
                 <div class="form-group">
                  ...
                  <div class="fg-input">
                  	<input type="text" id="expert_dest" data-id="<?php echo $expert['expert_dest'];?>" value="<?php echo $expert['expert_dest_ch'];?>" autoComplete="off" class="showorder" placeholder="最多选择5个线路" name="showorder">
                  	<div class="dest-list">
                  	  <?php if(!empty($top)):?>
                       ...
                       <div class="one <?php if($a==(count($top)-1)) echo 'last';?>">
                          ...
                          <?php foreach ($dest as $c=>$d):?>
                             <?php if($d['pid']==$b['id']):?>
                             <div class="input"><input class="dest" type="checkbox" <?php if(in_array($d['id'], $expert['expert_dest_arr'])) echo "checked";?> data-id="<?php echo $d['id'];?>" value="<?php echo $d['kindname'];?>" style="width:16px;margin:0;padding:0;" /><?php echo $d['kindname'];?></div>
                             <?php endif;?>
                          <?php endforeach;?>
                          </div>
                       </div>
            ...
            <div class="form-group div11">
                <div class="fg-title">所在地：<i>*</i></div>
                 <div class="form_select">
                  	<select name="province" data-value="<?php echo $expert['province'];?>" class="select_two" id="province" style="width: 137px; display: none;">
                  	  <option value="1">ss</option>
                  	</select>
                  	
                  	<select name="city" data-value="<?php echo $expert['city'];?>" class="select_three" id="city" style="width: 137px; ">
             ...
             <div class="form-group div12">
                ...
                <div class="fg-title">上门服务：<i>*</i></div>
                 <div class="form-group">
                  ...
                  <div class="fg-input">
                  	<input type="text" id="visit_service" data-id="<?php echo $expert['visit_service'];?>" value="<?php echo $expert['visit_service_ch'];?>" class="showorder" autoComplete="off" placeholder="最多选择5个地区" name="showorder">
            ...
            <div class="form-group div14">
                ...
                <div class="fg-input">
                    ...
                    <input name="pic" id="big_photo" type="hidden" value="<?php echo $expert['small_photo'];?>" />
                    
                    
                 </div>
                 <div style="text-align: left;width:100%;" class="olddiv">
                   <img src="<?php echo BANGU_URL.$expert['small_photo'];?>" height="80" style="margin-left:24%;" />
                 </div> 
            </div>-->
            <div class="form-group div15">
                ...
                <div class="fg-input">
                    ...
                    <input name="pic" id="idcardpic" type="hidden" value="<?php echo $expert['idcardpic'];?>" />
                    <!-- <span>不上传则默认管家头像</span> -->
                 </input>
                </div>
                 <div style="text-align: left;width:100%;" class="olddiv">
                   <img src="<?php echo BANGU_URL.$expert['idcardpic'];?>" height="80" style="margin-left:24%;" />
                 </div> 
            </div>
            ...
            <div class="form-group div16">
                ...
                <div class="fg-input">
                    ...
                    <input name="pic" id="idcardconpic" type="hidden" value="<?php echo $expert['idcardconpic'];?>">
                    
                    <!-- <span>不上传则默认管家头像</span> -->
                </div>
                 <div style="text-align: left;width:100%;" class="olddiv">
                   <img src="<?php echo BANGU_URL.$expert['idcardconpic'];?>" height="80" style="margin-left:24%;" />
                 </div> 
            </div>
                ...
                <div class="fg-input">
                   <div class="certificate_list">
                     <?php if(!empty($expert_cert)):?>
	                      <?php foreach ($expert_cert as $n=>$m):?>
		                      <div class="certificate_row" style="margin-bottom: 10px;">
		                        <input type="hidden" class="certificate_id" value="<?php echo $m['id'];?>"  />
			                	<input type="text" class="showorder certificate" placeholder="证书名称" value="<?php echo $m['certificate'];?>" style="width:40%;">
			                  	<input name="uploadFile<?php echo $n+5;?>" class="uploadFile" onchange="uploadImgFile(this);" type="file" style="width:30%;margin:0;">
			                    <input name="pic" class="certificatepic" type="hidden" value="<?php echo $m['certificatepic'];?>">
			                    <img src="<?php echo BANGU_URL.$m['certificatepic'];?>" width="80" />
          ...
          <div style="border-top:1px solid #D5D5D5;margin:15px 20px;"></div>
            <div class="form-group div19">
                ...
                <div class="small-input"><input type="text" id="school" class="showorder" placeholder="" value="<?php echo $expert['school'];?>"></div>
            </div>
            <div class="form-group div20">
                <div class="fg-title">从业：<i>*</i></div>
                <div class="small-input"><input type="text" id="profession" class="showorder" placeholder="" value="<?php echo $expert['profession'];?>"></div>
            </div>
            <div class="form-group div21">
                <div class="fg-title">工作年限：<i>*</i></div>
                <div class="small-input"><input type="text" id="working" class="showorder" placeholder="" value="<?php echo $expert['working'];?>"></div>
            </div>
                ...
                <div class="fg-input">
                   <div class="work_list">
                        <?php if(!empty($expert_resume)):?>
	                      <?php foreach ($expert_resume as $a=>$b):?>
		                    <div class="work_row" style="margin-bottom: 10px;/*border-bottom:1px solid #D5D5D5;*/padding:2px;">
			                	<input type="hidden" class="resume_id" value="<?php echo $b['id'];?>">
			                	<input type="text" class="starttime date" data-date-format="yyyy-mm-dd" placeholder="起始时间" value="<?php echo $b['starttime'];?>" style="width:40%;">&nbsp;-&nbsp;<input type="text" class="endtime date" data-date-format="yyyy-mm-dd" value="<?php echo $b['endtime'];?>" placeholder="截止时间" style="width:40%;">
		                        <input type="text" class="company_name" placeholder="所在企业" value="<?php echo $b['company_name'];?>" style="margin-top:2px;">
		                        <input type="text" class="job" placeholder="职务" value="<?php echo $b['job'];?>" style="margin-top:2px;">
		                       
		                        <textarea class="description" maxlength="30" placeholder="工作描述" style="margin-top:2px;width:80%;"><?php echo $b['description'];?></textarea>
            ...
            <div class="form-group" style="margin-bottom:20px;margin-bottom:20px;">
                ...
                <input type="button" class="fg-but" onclick="object.submitData()" value="保存修改">
            </div>
            <div class="clear"></div>
        </form>
    </div>
...
var expert_id="<?php echo $expert['id'];?>"; //管家id
var type="<?php echo $expert['type'];?>";  //管家类型
//js对象
var object = object || {};
var ajax_data={};
object = {
    ...
    submitData:function(){  //提交表单
		...
		$(".certificate_row").each(function(index){ 
			var id=$(this).find(".certificate_id").val();
		...
		$(".work_row").each(function(index){ 
			...
			var id=$(this).find(".resume_id").val();
    	...
    	var post_url="<?php echo base_url('admin/t33/expert/to_edit2')?>";
    ...
    getArea_two:function(pid){  //获取二级地区
     	...
     	var province="<?php echo $expert['province'];?>";
     	var province_name="<?php echo $expert['province_name'];?>";
        
     	if(return_data.code=="2000")
     	{
     		var json=return_data.data;
     		var str="";
     		str += "<option value='"+province+"'>"+province_name+"</option>";
     		str += "<option value='0'>请选择</option>";
        	for(var i in json)
        	{
            ...
            //
        	var city="<?php echo $expert['city'];?>";
         	var city_name="<?php echo $expert['city_name'];?>";
         	var city_str = "<option value='"+city+"'>"+city_name+"</option>";
         	 $(".select_three").html(city_str);
         	//上门服务
			...
			if(return_data.code!="-3")
			{
				...
				var arr=<?php echo json_encode($expert['visit_service_arr']);?>; //json数组
				
				for(var o in json)
				{
					var status="";
					if(jQuery.inArray(json[o].id,arr)>=0)
					{
		
						status="checked";
					}
					str += "<div class='input'><input class='service' type='checkbox' data-id='"+json[o].id+"' "+status+" value='"+json[o].name+"' style='width:16px;margin:0;padding:0;' />"+json[o].name+"</div>"
				}
...
$(document).ready(function(){
	...
	$(".add_cert").click(function(){
	    ...
	    html += "   <input type='hidden' class='certificate_id' value=''  />";
	...
	$(".add_work").click(function(){
		...
		html += "   <input type='hidden' class='resume_id' value=''  />";
