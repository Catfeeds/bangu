    ...
    <div class="fb-form">
        <form method="post" action="#" id="add-data" class="form-horizontal" style="z-index:1;">
            ...
            <div class="form-group div7">
                 ...
                 <div class="small-input"><input type="text" id="depart_id" onfocus="showMenu(this.id);" class="showorder" placeholder="点击选择" data-id=""></div>
            </div>
            <div class="form-group div7">
            ...
            <div class="form-group div11">
                <div class="fg-title">所在地：<i>*</i></div>
                 <div class="form_select">
                  	<select name="province" data-value="" class="select_two" id="province" style="width: 137px; display: none;">
                  	
                  	</select>
                  	
                  	<select name="city" data-value="" class="select_three" id="city" style="width: 137px; display: none;">
             ...
             <div class="form-group div12" style="display:none;">
...
object = {
    ...
    submitData:function(){  //提交表单
    	...
    	var post_url="<?php echo base_url('admin/t33/expert/to_add')?>";
