...
#add_invoice_form input{height:24px !important;}
#receive_invoice_form input{height:24px;}
#cancel_invoice_form input{height:24px;}
</style>
</head>
<body>
    ...
    <div class="page-body m_w" id="bodyMsg">
        ...
        <div class="page_content bg_gray">
            ...
            <div class="table_content">
                <div class="itab">
                    <ul data-value="0">
                        <li static="0"><a href="#tab1" class="active">未领用</a></li>
                ...
                <div class="tab_content">
                    <div class="table_list">
                        ...
                        <form class="search_form" id="search_form" method="post" action="">
                            <div class="search_form_box clear">
                                    ...
                                    <div class="search_group"   id="receive_depart" style="display: none">
                                     ...
                                     <div class="search_group" id="invoce_sn" style="display: none">
                                        <label>发票号：</label>
                                        <input type="text" name="invoce_sn" class="search_input" style="width:120px;" />
                                    </div>
                                ...
                                <div class="search_group">
                                    <span class="btn btn_green" style="margin-top:3px;" onclick="add_invoice(this)" id="add_invoice">+新增发票</span>
                                </div>
                            </div>
                        </form>
                        ...
                        <span class="btn btn_green" style="display:none;margin-top:10px;" onclick="write_off(this)" id="write_off">核销</span>
                        <!-- 暂无数据 -->
...
<!-- ****************************************************增加发票弹框**********************************************************************-->
    <div class="fb-content" id="add_invoice_modal" style="display:none;">
        <div class="box-title">
            <h4>新增发票</h4>
        ...
        <div class="jkxx fb-form" style="padding:10px;">
            <form id="add_invoice_form" action="#" method="post">
                    <div class="content_part">
                    <a style="cursor: pointer;" onclick="append_td()">+新增发票</a>
                         <table class="order_info_table table_td_border" border="1" id="add_invoice_table" width="100%" cellspacing="0">
                           
                            <tr height="30">
                                    <th class="order_info_title" width="10%">发票类型</th>
                                    <th class="order_info_title" width="10%">前缀</th>
                                    <th class="order_info_title" width="10%">发票起始编号</th>
                                    <th class="order_info_title" width="10%">发票结束编号</th>
                            ...
                            <tr>
                                    <td>
                                        <select name="invoice_name[]">
                                            <option value="百元发票">百元发票</option>
                                            <option value="千元发票">千元发票</option>
                                            <option value="万元发票">万元发票</option>
                                            <option value="十万发票">十万发票</option>
                                        </select>
                                    </td>
                                    <td>
                                        <input style="width:100%;height: 100%"  type="text" name="prefix[]" value="" />
                                    </td>
                                    <td>
                                        <input style="width:100%;height: 100%" onkeyup="cal_num(this)"  type="text" name="start_invoice_num[]" value="0"/>
                                    </td>
                                    <td>
                                        <input style="width:100%;height: 100%" onkeyup="cal_num(this)"  type="text" name="end_invoice_num[]" value="0"/>
                                    </td>
                                    <td>
                                        <input style="width:100%;height: 100%" readonly="readonly"  type="text" name="total_num[]" value="0"/>
                                    </td>
                                    <td>
                                        <input style="width:100%;height: 100%"  type="text" name="remark[]" value=""/>
                                    </td>
                ...
                <div class="form_btn" style="padding-bottom:30px;">
                    <input type="submit" name="submit" value="确认" class="btn btn_blue" style="margin-left:300px;height:auto !important;" />
                    <input type="reset" name="reset" value="取消" class="btn btn_gray layui-layer-close" style="margin-left:30px;height:auto !important;" />
                </div>
            </form>
        </div>
    </div>
<!-- ****************************************************End新增发票弹框**********************************************************************-->
<!-- ****************************************************查看发票列表弹框**********************************************************************-->
    <div class="fb-content" id="invoice_list_modal" style="display:none;">
        <div class="box-title">
            <h4>发票列表</h4>
            <span class="layui-layer-setwin">
                <a class="layui-layer-ico layui-layer-close layui-layer-close1" href="javascript:;">×</a>
        ...
        <div class="jkxx fb-form" style="padding:10px;">
            <table class="order_info_table table_td_border" border="1" id="add_invoice_table" width="100%" cellspacing="0">
                         <thead class="" >
                            <tr height="30">
                                    <th class="order_info_title" width="8%">发票编号</th>
                                    <th class="order_info_title" width="5%">批次号</th>
                                    <th class="order_info_title" width="5%">订单号</th>
                                    <th class="order_info_title" width="5%">发票类型</th>
                                    <th class="order_info_title" width="5%">前缀</th>
                                    <th class="order_info_title" width="5%">发票编号</th>
...
<!-- ****************************************************查看发票详情弹框**********************************************************************-->
<div class="fb-content" id="invoice_detail_modal" style="display:none;">
        <div class="box-title">
            <h4>领用记录</h4>
            <span class="layui-layer-setwin">
                <a class="layui-layer-ico layui-layer-close layui-layer-close1" href="javascript:;">×</a>
            ...
            <table class="order_info_table table_td_border" border="1" id="add_invoice_table" width="100%" cellspacing="0">
                         <thead class="" >
                            <tr height="30">
                                    ...
                                    <th class="order_info_title" width="5%">发票前缀</th>
                                    ...
                                    <th class="order_info_title" width="3%">状态</th>
                            </tr>
                            </thead>
                            <tbody id="use_invoice_list"></tbody>
            </table>
          </div>
</div>
...
<div class="fb-content" id="cancel_invoice_modal" style="display:none;">
        ...
        <div class="jkxx fb-form" style="padding:10px;">
        <form id="cancel_invoice_form" action="#" method="post">
        <div class="content_part">
            <table class="order_info_table table_td_border" border="1" id="add_invoice_table" width="100%" cellspacing="0">
                    <tr>
                        <td>操作人</td>
...
<!-- ****************************************************查看已作废发票详情弹框**********************************************************************-->
<div class="fb-content" id="show_cancel_invoice_modal" style="display:none;">
        <div class="box-title">
            <h4>已作废</h4>
            <span class="layui-layer-setwin">
                <a class="layui-layer-ico layui-layer-close layui-layer-close1" href="javascript:;">×</a>
            ...
            <table class="order_info_table table_td_border" border="1" id="add_invoice_table" width="100%" cellspacing="0">
                         <thead class="" >
                            <tr height="30">
                                    ...
                                    <th class="order_info_title" width="3%">发票类型</th>
                                    <th class="order_info_title" width="5%">前缀</th>
                                    <th class="order_info_title" width="5%">发票编号</th>
                                    <th class="order_info_title" width="5%">领用部门</th>
                                    <th class="order_info_title" width="5%">使用人</th>
                            ...
                            <tbody id="one_cancel_invoice"></tbody>
            </table>
          </div>
</div>
...
<!-- ****************************************************领用发票弹框**********************************************************************-->
<div class="fb-content" id="receive_invoice_modal" style="display:none;">
        <div class="box-title">
            <h4>领用发票</h4>
            <span class="layui-layer-setwin">
                <a class="layui-layer-ico layui-layer-close layui-layer-close1" href="javascript:;">×</a>
           ...
           <div class="jkxx fb-form" style="padding:10px;">
            <form id="receive_invoice_form" action="#" method="post">
               <table class="order_info_table table_td_border" border="1" id="add_invoice_table" width="100%" cellspacing="0">
                         <tr height="30">
                             <td width="89" style="text-align: right;">发票编号</td>
                             <td width="241" style="text-align: left;" id="total_invoice_num"></td>
                             <td width="96" style="text-align: right;">可领用</td>
                         ...
                         <tr height="30">
                             ...
                             <td style="text-align: left;" id="start_invoice_code"></td>
                             
                             <td style="text-align: right;">最大可领编号</td>
                             <td style="text-align: left;" id="max_invoice_code"></td>
                         ...
                         <tr height="30">
                             ...
                             <td style="text-align: left;">
                                ...
                                <span id="input_total_num">共0份</span>
                                 <span id="error_tips" style="color:red"></span>
                             </td>
                         </tr>
                         <tr height="30">
                             <td style="text-align: right;">领用人</td>
                             <td style="text-align: left;" colspan="3"><input type="text" id="choose_receive_people" name="choose_receive_people" value=""></td>
                         </tr>
                         <tr height="30">
                            
                             <td style="text-align: right;">领用部门</td>
                             <td style="text-align: left;" id="choose_receive_depart" colspan="3">选择领用人之后才显示</td>
                         </tr>
                         <tr height="30">
        ...
        <div class="jkxx fb-form" style="padding:10px;">
            ...
            <table class="order_info_table table_td_border" border="1" id="add_invoice_table" width="100%" cellspacing="0">
                         <thead class="" >
                            ...
                            <tbody id="received_invoice_list"></tbody>
            </table>
          </div>
</div>
...
function calculate_num(obj){
    ...
    $.post("<?php echo base_url();?>admin/t33/sys/invoice/get_can_use",
            {'start_num':start_num,'end_num':end_num,'prefix':prefix,'invoice_id':invoice_id},
            function(data){
               data = eval('('+data+')');
...
function append_td(){
    var tr_str="<tr>";
    tr_str += "<td><select name='invoice_name[]'><option value='百元发票'>百元发票</option><option value='千元发票'>千元发票</option><option value='万元发票'>万元发票</option><option value='十万发票'>十万发票</option></select></td>";
    tr_str += "<td><input style='width:100%;height: 100%'  type='text' name='prefix[]' value=''/></td>";
    tr_str += "<td><input style='width:100%;height: 100%' onkeyup='cal_num(this)'  type='text' name='start_invoice_num[]' value='0'/></td>";
    tr_str += "<td><input style='width:100%;height: 100%' onkeyup='cal_num(this)'  type='text' name='end_invoice_num[]' value='0'/></td>";
    tr_str += "<td><input style='width:100%;height: 100%'  type='text' name='total_num[]' value=''/></td>";
    tr_str += "<td><input style='width:100%;height: 100%'  type='text' name='remark[]' value=''/></td>";
    ...
    tr_str += "</tr>";
    $("#add_invoice_table").append(tr_str);
}
...
function cal_num(obj){
    var end_num = Number($(obj).parent().parent().find("input[name='end_invoice_num[]']").val());
    var start_num = Number($(obj).parent().parent().find("input[name='start_invoice_num[]']").val());
...
//查看发票列表
function show_invoice_list(obj){
    //#invoice_list_modal; #invoice_list
    var invoice_list_str = "";
    var invoice_id = $(obj).attr('data-id');
    var use_id = $(obj).attr('data-useid');
     $.post("<?php echo base_url();?>admin/t33/sys/invoice/get_invoice_list",
                 {'invoice_id':invoice_id,use_id:use_id},
                 function(data){
                    data = eval('('+data+')');
                    $.each(data, function(name, value) {
                          invoice_list_str += "<tr>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['invoice_code']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['batch']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['ordersn']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['invoice_name']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['prefix']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['invoice_code']+"</td>";

                          invoice_list_str += "<td style='height:35px;text-align:center'>"+(value['use_time']==null ? '' : value['use_time'])+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['expert_name']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['depart_name']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+(value['assign_people']==null ? '' : value['assign_people'])+"</td>";
                          ...
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+confirm_status+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['cancel_remark']+"</td>";
                          if(/*value['confirm_status']!=2 && value['use_id']>0 &&*/ value['confirm_status']==1 && value['cancel_status']==0){
                            invoice_list_str += "<td style='height:35px;text-align:center'><a style='cursor:pointer' onclick='cancel_invoice(this)' data-useid='"+value['use_id']+"'  data-id='"+value['id']+"'>作废</a></td>";
                        }else{
                            invoice_list_str += "<td style='height:35px;text-align:center'></td>";
                        }

                          invoice_list_str += "</tr>";
                    });
                   $("#invoice_list").html(invoice_list_str);
                   layer.open({
                        type: 1,
                        title: false,
                        closeBtn: 0,
...
function show_detail(obj){
    ...
    var one_invoice = "";
    var invoice_id = $(obj).attr('data-id');
     $.post("<?php echo base_url();?>admin/t33/sys/invoice/get_invoice_detail",
                 {'invoice_id':invoice_id},
                 function(data){
                    data = eval('('+data+')');
                    one_invoice += "<tr>";
                    one_invoice += "<td style='height:35px;text-align:center'>"+data['invoice']['invoice_name']+"</td>";
                    one_invoice += "<td style='height:35px;text-align:center'>"+data['invoice']['prefix']+"</td>";
                    one_invoice += "<td style='height:35px;text-align:center'>"+data['invoice']['start_code']+"</td>";
                    one_invoice += "<td style='height:35px;text-align:center'>"+data['invoice']['end_code']+"</td>";
                    one_invoice += "<td style='height:35px;text-align:center'>"+data['invoice']['num']+"</td>";
                    one_invoice += "<td style='height:35px;text-align:center'>"+data['invoice']['remark']+"</td>";
                    one_invoice += "</tr>";
                    $("#one_invoice").html(one_invoice);
                    $.each(data, function(name, value) {
                        if(name=="invoice" || name=="no_use_invoice"){
                            return ;
                        }else{
                          invoice_list_str += "<tr>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['addtime']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['prefix']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['start_code']+' ~ '+value['end_code']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['num']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['depart_name']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['expert_name']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['employee_name']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['use_num']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['cancel_num']+"</td>";
                          var is_recover_str="";
                          if(value['is_recover']=='1')
                              is_recover_str="<span style='color:red'>已收回</span>";
                          else
                              is_recover_str="<span color='red'>已领用</span>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+is_recover_str+"</td>";
                          invoice_list_str += "</tr>";
                        }
                    });
                   $("#use_invoice_list").html(invoice_list_str);
                   layer.open({
                        type: 1,
                        title: false,
                        closeBtn: 0,
...
function received(obj){
    ...
    var prefix = "";
     $.post("<?php echo base_url();?>admin/t33/sys/invoice/get_invoice_detail",
                 ...
                 function(data){
                    data = eval('('+data+')');
                    if(data['no_use_invoice']=='' || data['no_use_invoice']==0 || data['no_use_invoice']==undefined){
                        //tan_alert_noreload('已经没有可以领用的合同了');
                        //return false;
                    }
                    ...
                    $.each(data, function(name, value) {
                        if(name=="invoice" || name=="no_use_invoice"){
                          ...
                          invoice_list_str += "<tr>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['id']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+prefix+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['start_code']+' ~ '+value['end_code']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['num']+"</td>";
                          //invoice_list_str += "<td style='height:35px;text-align:center'>"+value['end_code']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['depart_name']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['expert_name']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['use_num']+"</td>";
                          invoice_list_str += "<td style='height:35px;text-align:center'>"+value['cancel_num']+"</td>";
                   ...
                   $("#received_invoice_list").html(invoice_list_str);
                   $("#total_invoice_num").html(data['invoice']['start_code']+' ~ '+data['invoice']['end_code']+'&nbsp;&nbsp;&nbsp;       共'+data['invoice']['num']+'份');
                   var can_use_num = Number(data['invoice']['num'])-Number(data['invoice']['use_num']);
                   $("#can_use").html(can_use_num+'份');
                   var now_date = new Date().Format("yyyy-MM-dd");
                   $("#assign_date").html(now_date);
                   $("#hidden_start_code").val(data['no_use_invoice']!='' ? data['no_use_invoice']['code'] : '无');
                    $("#start_invoice_code").html(data['no_use_invoice']!='' ? data['no_use_invoice']['code'] : '无');
                    $("#hidden_assign_date").val(now_date);
                    $("#hidden_prefix").val(prefix);
                    $("#hidden_invoice_id").val(data['invoice']['id']);
                    $("#max_invoice_code").html(data['invoice']['end_code']);
                    //理论能用多少
...
function recycle(obj){
    ...
    if(use_num>0)  //
    {
	    layer.confirm('已有部分编号被使用，已使用的编号不会被收回，确定要收回？', { btn: ['是','否'] }, function(){
	        //"是"操作
	   $.post(
	            "<?php echo base_url();?>admin/t33/sys/invoice/recycle_invoice",
	                     {'use_id':use_id,'invoice_id':invoice_id},
	                     function(data){
	                        data = eval('('+data+')');
	                        if (data.status == 200){
	                            tan_alert(data.msg);
...
function write_off(obj){
    if($("#invoice_ids").val()==''){
         layer.alert('没有选中需要核销的收据', {icon: 2,title:'错误提示'});
         return false;
    }
...
//核销的时候选择当前数据
function choose_invoice(obj){
    if($(obj).is(':checked')){
        $("#invoice_ids").val($("#invoice_ids").val()+$(obj).val()+",");
    }else{
        $("#invoice_ids").val($("#invoice_ids").val().replace($(obj).val()+',',''));
    }
}
...
function show_cancel(obj){
    ...
    var td_str = "";
    $.post(
            "<?php echo base_url();?>admin/t33/sys/invoice/show_cancel_invoice",
            {'list_id':list_id},
            function(data){
                  data = eval('('+data+')');
                  ...
                  td_str += "<td style='height:35px;text-align:center'>"+data['invoice_name']+"</td>";
                  td_str += "<td style='height:35px;text-align:center'>"+data['prefix']+"</td>";
                  td_str += "<td style='height:35px;text-align:center'>"+data['invoice_code']+"</td>";
                  ...
                  td_str += "</tr>";
                  $("#one_cancel_invoice").html(td_str);
                  layer.open({
                        type: 1,
                        title: false,
                        closeBtn: 0,
                        area: '840px',
                        shadeClose: false,
                        content: $('#show_cancel_invoice_modal')
                });
            }
    );
}
    ...
    object = {
        init:function(){ //初始化方法
            ...
            var invoce_sn=$("input[name='invoce_sn']").val();
            ...
            if(type==0){
                var post_url="<?php echo base_url('admin/t33/sys/invoice/api_invoice_list')?>";
                var th_str = "<th>序号</th><th>录入日期</th><th>发票类型</th><th>前缀</th><th>起始 ~ 结束编号</th><th>总数量</th><th>已领用</th><th>已使用</th><th>未使用</th><th>录入人</th><th>备注</th><th>操作</th>";
                $("#add_invoice").show();
                $("#input_people").show();
                $("#input_date").show();
                 $("#prefix").show();
                ...
                var post_url="<?php echo base_url('admin/t33/sys/invoice/api_invoice_list')?>";
                var th_str = "<th>序号</th><th>领用日期</th><th>发票类型</th><th>前缀</th><th>起始编号 ~ 结束编号</th><th>总数量</th><th>起始结束 - 结束编号(已领)</th><th>领用数</th><th>领用人</th><th>领用部门</th><th>分配人</th><th>使用数量</th><th>作废数量</th><th>备注</th><th>操作</th>";
                $("#add_invoice").hide();
                $("#input_people").hide();
                $("#input_date").hide();
                $("#order_sn").hide();
                ...
                var post_url="<?php echo base_url('admin/t33/sys/invoice/api_invoice_list')?>";
                var th_str = "<th></th><th>序号</th><th>批次号</th><th>订单号</th><th>发票类型</th><th>前缀</th><th>发票编号</th><th>使用时间</th><th>使用人</th><th>使用部门</th><th>分配人</th><th>操作</th>";
                $("#add_invoice").hide();
                $("#input_people").hide();
                $("#input_date").hide();
                $("#num").hide();
                ...
                var post_url="<?php echo base_url('admin/t33/sys/invoice/api_invoice_list')?>";
                var th_str = "<th>序号</th><th>批次号</th><th>订单号</th><th>发票类型</th><th>前缀</th><th>发票编号</th><th>使用时间</th><th>使用人</th><th>使用部门</th><th>核销人</th><th>核销时间</th>";
                $("#add_invoice").hide();
                $("#input_people").hide();
                $("#input_date").hide();
                $("#num").hide();
                ...
                var post_url="<?php echo base_url('admin/t33/sys/invoice/api_invoice_list')?>";
                var th_str = "<th></th><th>序号</th><th>批次号</th><th>领用日期</th><th>发票类型</th><th>前缀</th><th>发票编号</th><th>作废时间</th><th>作废人</th><th>使用部门</th><th>分配人</th><th>操作</th>";
                $("#add_invoice").hide();
                $("#input_people").hide();
                $("#input_date").hide();
                $("#num").hide();
        ...
        pageData:function(curr,page_size,data){  //未领用生成表格数据
         var str = '', last = curr*page_size - 1;
                ...
                for(var i = 0; i <= last; i++){
                    ...
                    str +=     "<td >"+data[i].invoice_name+"</td>";
                    //str +=     "<td><a href='javascript:void(0)' onclick='show_invoice_list(this)' data-id='"+data[i].id+"'>"+data[i].prefix+"</a></td>";
                    ...
                    str +=     "<td>"+data[i].iu_use_num+"</td>";
                    str +=     "<td>"+(data[i].use_num-data[i].iu_use_num)+"</td>";
                   ...
                   str +=     "<td><a href='javascript:void(0)' class='a_order' onclick='show_invoice_list(this)' data-id='"+data[i].id+"'>查看</a>"+use_str+"</td>";
                   str += "</tr>";
                }
                return str;
        },
         ...
         var str = '', last = curr*page_size - 1;
                ...
                for(var i = 0; i <= last; i++){
                    ...
                    str +=     "<td>"+data[i].remark+"</td>";
                    //操作
                   str +=     "<td><a href='javascript:void(0)' class='a_order' onclick='show_invoice_list(this)' data-useid='"+data[i].use_id+"'>查看</a><a href='javascript:void(0)' class='a_order' onclick='recycle(this)' data-usenum='"+data[i].use_num+"' data-useid='"+data[i].use_id+"' data-id='"+data[i].id+"'>收回</a></td>";
                   str += "</tr>";
                }
                return str;
        },
                ...
                for(var i = 0; i <= last; i++){
                    str += "<tr class='order_type2'>";
                     if(data[i].confirm_status==1 && data[i].cancel_status==0){
                        str +=     "<td><input type='checkbox' value='"+data[i].id+"' name='choose_invoce' onclick='choose_invoice(this)'/></td>";
                    }else{
                        str +=     "<td></td>";
                    }
                    //str +=     "<td><input type='checkbox' value='"+data[i].id+"' name='choose_invoce' onclick='choose_invoice(this)'/></td>";
                    ...
                    //操作
                     if(/*data[i].confirm_status!=2 && data[i].use_id>0 &&*/ data[i].confirm_status==1 && data[i].cancel_status==0){
                        str += "<td><a href='javascript:void(0)' style='cursor:pointer' class='a_order' onclick='cancel_invoice(this)' data-useid='"+data[i].use_id+"' data-id='"+data[i].id+"'>作废</a></td>";
                    }else{
                        str += "<td></td>";
                    }
                    str +=     "</tr>";
...
$(function(){
    ...
    $('.endtime').datetimepicker({
            ...
            $("#add_invoice_form").submit(function(){
                $.post(
                    "<?php echo base_url();?>admin/t33/sys/invoice/add_invoice",
                     $('#add_invoice_form').serialize(),
                     function(data){
                        data = eval('('+data+')');
                        if (data.status == 200){
                        	tan_alert(data.msg);
            ...
            $("#cancel_invoice_form").submit(function(){
                $.post(
                    "<?php echo base_url();?>admin/t33/sys/invoice/cancel_invoice",
                     $('#cancel_invoice_form').serialize(),
                     function(data){
                        data = eval('('+data+')');
                        if (data.status == 200){
            ...
            $("#write_off_form").submit(function(){
                  $.post(
                         "<?php echo base_url();?>admin/t33/sys/invoice/write_off_invoice",
            ...
            // End 发票核销提交#
               ...
               //领用发票提交
            $("#receive_invoice_form").submit(function(){
             
                  $.post(
                         "<?php echo base_url();?>admin/t33/sys/invoice/receive_invoice",
                        $('#receive_invoice_form').serialize(),
                        function(data){
                                data = eval('('+data+')');
                                if (data.status == 200){
                                     tan_alert(data.msg);
...
//旅行社下的营业部的管家
$.post('/admin/t33/sys/invoice/get_union_expert_data', {}, function(data) {
  var data = eval('(' + data + ')');
  var array = new Array();
