...
<?php $this->load->view("admin/t33/common/dest_tree"); //加载树形目的地   ?>
		               ...
		               <form method="post" action="#" id="add-data" class="form-horizontal">
		                 ...
		                 <table class="order_info_table table_td_border" border="1" width="100%" cellspacing="0" style="margin-top:5px;">
		                    ...
		                    <tr height="40">
		                        ...
		                        <td><input type="text" id="startplace" onfocus="showMenu_startplace(this.id);" class="showorder" data-id="235" value="深圳市"></td>
		                         <td class="order_info_title">销售对象<i>*</i>:</td>
		                        <td>
		                         <div class="search_group" style="margin:5px 0px;">
                                  
                                    <div class="form_select">
                                        <input type="text" name="" value="" class="showorder expert_id sell_object" placeholder="输入关键字搜索" data-value="" style="margin:0;width:120px;" />
		                        ...
		                        <!--
		                         <div class="search_group" style="margin:5px 0px;">
                                    ...
                                    <div class="form_select">
                                        <div class="search_select sell_object" data-value="-1" data-name="">
                                            <div class="show_select" style="padding-left: 4px;height:23px;line-height:23px;">全公司</div>
		                    ...
		                    <tr height="40"> 
		                        ...
		                        <td>
		                      	 <input type="text" id="linecode" class="showorder" name="showorder" style="width:200px;" readonly>
		                        </td>
		                        <td class="order_info_title">上车地点:</td>
		                        <td class="td_car">
		                          <div>
		                      	    <input type="text" class="showorder input_car" name="showorder" style="width:120px;"><a href="javascript:void(0)" class="add_car">添加</a>
		                      	 </div>
		                    ...
		                    <tr height="40"> 
		                        ...
		                        <td colspan="3">
		                      	 <input type="text" id="linename" class="showorder" name="showorder" style="width:675px;">
		                        </td>
		                          ...
		                          <div class="search_group" style="margin:5px 0px;">
                                    ...
                                    <div class="form_select">
                                        <div class="search_select div_type">
                                            <div class="show_select ul_type" data-value="收据" style="padding-left: 4px;height:31px;line-height:31px;">名单模板</div>
                                            <ul class="select_list">
                                          			<li value="1">张三</li>
                                                    <li value="2">李四</li>
		                     ...
		                     <tr height="40"> 
		                       <td class="order_info_title">服务类型<i>*</i>:</td>
		                        ...
		                        <div class="search_group" style="margin:5px 0px;">
                                    ...
                                    <div class="form_select">
                                        <input type="text" name="" value="" class="showorder server_range" placeholder="输入关键字搜索" data-value="" style="margin:0;width:150px;" />
		                          ...
		                          <div class="search_group" style="margin:5px 0px;">
                                    ...
                                    <div class="form_select" style="float:left;">
                                        <div class="search_select server_range" data-value="-1">
                                            <div class="show_select"  style="padding-left: 4px;height:23px;line-height:23px;">请选择</div>
                                            <ul class="select_list">
                                        ...
                                        <a href="jsvascript:void(0)" class="a_server" style="margin:3px 8px;float:left;">管理</a>
                                   </div>
                                  -->
		                        </td>
		                        ...
		                        <div class="search_group" style="margin:5px 0px;">
                                    ...
                                    <div class="form_select">
                                        <input type="text" name="" value="" class="showorder supplier_id" placeholder="输入关键字搜索" data-value="" style="margin:0;width:220px;" />
                                        <a href="javascript:void(0)" onclick="javascript:$('.supplier_id').val('');">清空</a>
		                        ...
		                        <div class="search_group" style="margin:5px 0px;">
                                    ...
                                    <div class="form_select">
                                        <div class="search_select supplier_id" data-value="-1">
                                            <div class="show_select" style="padding-left: 4px;height:23px;line-height:23px;width:220px;overflow:hidden;">请选择</div>
		                    ...
		                    <tr height="40">
		                        ...
		                        <td colspan="3">
		                        <textarea name="" class="textarea" id="remark" placeholder="销售须知" style="height:160px;"></textarea>
		                        </td>
		                    </tr>
		                    <tr height="40"> 
		                 ...
		                 <table class="order_info_table table_td_border" border="1" width="100%" cellspacing="0" style="margin-top:5px;">
		                    ...
		                    <tr height="40">
		                    	<!--  <td class="order_info_title" style="width:12%;">佣金收取对象<i>*</i>:</td>
		                        <td colspan="3">
		                          <div class="search_group" style="margin:5px 0px;">
                                  
                                    <div class="form_select">
                                        <div class="search_select agent_object" data-value="1">
                                            <div class="show_select" style="padding-left: 4px;height:31px;line-height:31px;">营业部</div>
                                            <ul class="select_list">
		                        ...
		                        <td colspan="3">
		                          <div class="search_group" style="margin:5px 0px;">
                                    ...
                                    <div class="form_select">
                                          <label><input type="radio" name="agent_object" checked value="1" class="agent_object"/>营业部</label>
                                          <!-- <label style="margin-left:20px;"><input type="radio" name="agent_object" value="2" class="agent_object"/>供应商</label>
                                          -->
		                       ...
		                       <td class="order_info_title">佣金计算类别<i>*</i>:</td>
		                        <td colspan="3">
		                          <div class="search_group" style="margin:5px 0px;">
                                    ...
                                    <div class="form_select">
                                          <label><input type="radio" name="item" checked value="1" class="radio"/>团费比例</label>
                                          <label style="margin-left:20px;"><input type="radio" name="item" value="2" class="radio"/>按人头</label>
		                    ...
		                    -->
		                     <tr height="40"> 
		                        ...
		                        <input type="text" id="agent_rate" class="showorder" name="showorder" style="width: 120px">（如：80% 则输入0.8）
		                        <input type="button" value="计算" class="btn_use" />
		                        </div>
		                        -->
		                         <div class="part2" style="width:640px;">
		                         <label>成人：<input type="text" id="adult_agent" class="showorder" name="showorder" value="0">元</label>
		                         <label>小孩占床：<input type="text" id="child_agent" class="showorder" name="showorder" value="0">元</label>
		                         <label>小孩不占床：<input type="text" id="childnobed_agent" class="showorder" name="showorder" value="0">元</label>
		                         <!-- <label>老人：<input type="text" id="old_agent" class="showorder" name="showorder" value="0">元</label> -->
		                         <!-- <input type="button" value="计算" class="btn_use" /> -->
		                        </div>
  ...
  <div class="fb-form" style="width:100%;overflow:hidden;">
        <form method="post" action="#" id="add-data" class="form-horizontal">
            ...
            <div class="form-group" style="margin-top:0 !important;text-align:right;float:left;width:98%;">
               <div style="width:100%;float:left;margin-top:0px;">
                 <input type="button" class=" btn_two btn_close" value="关闭">
                 <input type="button" class=" btn_one btn_submit" value="提交">
                </div>
            </div>
...
$("body").on("click",".ul_supplier li",function(){
	...
	var send_data={supplier_id:id};
	var return_data=send_ajax_noload(send_url,send_data); 
	liushui_code=return_data.data.liushui_code;
	supplier_code=return_data.data.code;
	var initcode=linecode+m_date+return_data.data.code+return_data.data.liushui_code;
...
$("body").on("click",".btn_submit",function(){
	...
	if(childnobedprice!=""&&childnobedjs!="")
	{
...
$("body").on("click",".btn_add_single",function(){
	...
	if(!flag)
	{
	    ...
	    var url="<?php echo base_url('admin/t33/sys/line/api_add_single');?>";
	    var data={
	    	    dest_id:dest_id,
