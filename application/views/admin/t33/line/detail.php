            ...
            <div class="table_content" style="padding-bottom:0px;position:relative;padding-top:36px;">
                ...
                <div class="tab_content" style="margin-top:0px;">
                       <div class="ul_div clear">
                           <p class="one_p clear" style="font-weight: bold;"><font>供应商：</font><?php echo $line['data']['brand']."(".$line['data']['linkman']."&nbsp;&nbsp;".$line['data']['link_mobile']."&nbsp;&nbsp;".$line['data']['linkemail'].")";?></p>
                           ...
                           <?php  if($line['data']['producttype']==1 && $line['data']['line_kind']==1){?>
                           <p class="one_p clear"><font>指定管家：</font>             

                                <?php  if(!empty($line['package'])){ 
                                           foreach ($line['package'] as $key => $value) {        
                                 ?>
                                 ...
                                 <?php } }?> 
                                  ...
                                  <?php  if(!empty($line['expert']['realname'])){  //echo  $expert['nickname']; ?>
                                        <span class="selectedContent">
                                              <?php echo  $line['expert']['realname']; ?>  
                                        </span>                 
                                 <?php    } ?>
                           </p>
                           <?php  } ?>
                       ...
                       <!--    <div class="one_p"  >
                        ...
                        <div class="ul_div clear" style="display:none;">
                           <div class="four_p"><span class="fl" style="line-height:28px;">产品标签：</span>
...
(function(){
  ...
  function initProductPrice(){
     var url = '<?php echo base_url()?>admin/t33/sys/line/getProductPriceJSON';
