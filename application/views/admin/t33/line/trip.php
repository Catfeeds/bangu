             ...
             <table class="trip_table">
                ...
                <?php if(!empty($list)):?>
                  <?php foreach ($list as $trip=>$trip_value):?>
                    ...
                    <td><?php echo str_replace('undefined','',$trip_value['title']);?></td>
             ...
             <p class="trip_p"><font>【行程介绍】</font></p>
              <?php if(!empty($list)):?>
                <?php foreach ($list as $k=>$v):?>
                  <p class="trip_p2"><font>第<?php echo $v['day'];?>天 <?php echo isset($v['title'])==true?str_replace('undefined','',$v['title']):""; ?></font></p>
