    ...
    <div class="page-body" id="bodyMsg">
        ...
        <div class="page_content bg_gray">      
            ...
            <div class="table_content">
                <div class="itab">
                    <ul> 
                     <li static="1"><a href="#tab1" data-id="0" class="active li_type">退款退团审批</a></li> 
                    ...
                    <div class="table_list">
                        <form class="search_form" method="post" action="">
                            <div class="search_form_box clear" style="padding-right:0;">
								...
								<div class="search_group">
                                    ...
                                    <div class="form_select">
                                        <div class="search_select div_status">
                                            <div class="show_select ul_status" data-value="2" style='width:70px;'>待审核</div>
                                            <ul class="select_list">
                                                    <li data-value="-1">全部</li>
                                                    <li data-value="2">待审核</li>
                               ...
                               <!-- 搜索按钮 -->
                                <div class="search_group">
                                    <input type="button" id="btn_submit" name="submit" class="search_button" value="搜索" style="margin-left:0px;"/>
                                </div>
...
<script type="text/javascript">
	type_value="2";  //类型：默认-1全部，0待审核，2已通过、4已拒绝
	var flag=true;
	//js对象
	var object = object || {};
	var ajax_data={};
	object = {
        init:function(){ //初始化方法
            ...
            //接口数据
            var post_url="<?php echo base_url('admin/t33/sys/order/api_reback')?>";
        	ajax_data={page:"1",type:type_value,ordersn:ordersn,starttime:starttime,endtime:endtime,expert_name:expert_name};
        	...
        	laypage({
        	    ...
        	    jump: function(ret){
		        	...
		        	//else if(type_value=="2")
		        		$(".tr_rows").html("<th>编号</th><th>订单编号</th><th>调整应收金额</th><th>调整结算金额</th><th>订单金额</th><th>已收款</th><th>未收款</th><th>申请时间</th><th>申请人</th><th>申请部门</th><th>审批状态</th><th>操作</th>");
   ...
   $("#btn_submit").click(function(){
	...
	$("body").on("click",".a_detail",function(){
		...
		window.top.openWin({
		  ...
		  fix: true, //不固定
		  maxmin: true,
		  content: "<?php echo base_url('admin/t33/sys/order/reback_detail');?>"+"/"+id+"/"+action
		});
	});
