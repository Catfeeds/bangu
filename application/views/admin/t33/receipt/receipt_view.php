...
#add_receipt_form input{height:24px;}
#receive_receipt_form input,#cancel_receipt_form input{height:24px;}
</style>
</head>
<body>
                    ...
                    <div class="table_list">
                        ...
                        <form class="search_form" id="search_form" method="post" action="">
                            <div class="search_form_box clear">
                                ...
                                <div class="search_group">
                                    <span class="btn btn_green" style="margin-top:3px;" onclick="add_receipt(this)" id="add_receipt">+新增收据</span>
                                </div>
                            </div>
                        </form>
...
<!-- ****************************************************增加收据弹框**********************************************************************-->
    <div class="fb-content" id="add_receipt_modal" style="display:none;">
        <div class="box-title">
            <h4>新增收据</h4>
        ...
        <div class="jkxx fb-form" style="padding:10px;">
            <form id="add_receipt_form" action="#" method="post">
                    <div class="content_part">
                    <a style="width: 100%;height: 100%;cursor: pointer;" onclick="append_td(this)">+新增收据</a>
                         <table class="order_info_table table_td_border" border="1" id="add_receipt_table" width="100%" cellspacing="0">
                           
                            <tr height="30">
                                    <!-- <th class="order_info_title" width="10%">收据名称</th> -->
                                    <th class="order_info_title" width="10%">前缀</th>
                                    <th class="order_info_title" width="10%">收据起始编号</th>
                                    <th class="order_info_title" width="10%">收据结束编号</th>
                            ...
                            <tr>
                                    <!-- <td>
                                        <select name="receipt_name[]">
                                            <option value="百元收据">百元收据</option>
                                            <option value="千元收据">千元收据</option>
                                            <option value="万元收据">万元收据</option>
                                            <option value="十万收据">十万收据</option>
                                        </select>
                                    </td> -->
                                    <td>
                                    ...
                                    <td>
                                        <input style="width:100%;" onkeyup="cal_num(this)"  type="text" name="start_receipt_num[]" value="0"/>
                                    </td>
                                    <td>
                                        <input style="width:100%;" onkeyup="cal_num(this)"  type="text" name="end_receipt_num[]" value="0"/>
                                    </td>
                                    <td>
...
<!-- ****************************************************End新增收据弹框**********************************************************************-->
<!-- ****************************************************查看收据列表弹框**********************************************************************-->
    <div class="fb-content" id="receipt_list_modal" style="display:none;">
        <div class="box-title">
            <h4>收据列表</h4>
            <span class="layui-layer-setwin">
                <a class="layui-layer-ico layui-layer-close layui-layer-close1" href="javascript:;">×</a>
        ...
        <div class="jkxx fb-form" style="padding:10px;">
            <table class="order_info_table table_td_border" border="1" id="add_receipt_table" width="100%" cellspacing="0">
                         <thead class="" >
                            <tr height="30">
                                    <th class="order_info_title" width="8%">收据编号</th>
                                    <th class="order_info_title" width="5%">批次号</th>
                                    <th class="order_info_title" width="5%">订单号</th>
                                    <!-- <th class="order_info_title" width="5%">收据类型</th> -->
                                    <th class="order_info_title" width="5%">前缀</th>
                                    <th class="order_info_title" width="5%">收据编号</th>
...
<!-- ****************************************************查看收据详情弹框**********************************************************************-->
<div class="fb-content" id="receipt_detail_modal" style="display:none;">
        <div class="box-title">
            <h4>领用记录</h4>
            <span class="layui-layer-setwin">
                <a class="layui-layer-ico layui-layer-close layui-layer-close1" href="javascript:;">×</a>
            ...
            <table class="order_info_table table_td_border" border="1" id="add_receipt_table" width="100%" cellspacing="0">
                         <thead class="" >
                            <tr height="30">
                                    ...
                                    <th class="order_info_title" width="5%">收据前缀</th>
                            ...
                            <tbody id="use_receipt_list"></tbody>
            </table>
          </div>
</div>
...
<!-- ****************************************************作废收据弹框**********************************************************************-->
<div class="fb-content" id="cancel_receipt_modal" style="display:none;">
        <div class="box-title">
            <h4>作废收据</h4>
            <span class="layui-layer-setwin">
                <a class="layui-layer-ico layui-layer-close layui-layer-close1" href="javascript:;">×</a>
        ...
        <div class="jkxx fb-form" style="padding:10px;">
        <form id="cancel_receipt_form" action="#" method="post">
        <div class="content_part">
            <table class="order_info_table table_td_border" border="1" id="add_receipt_table" width="100%" cellspacing="0">
                    <tr>
                        <td>操作人</td>
...
<!-- ****************************************************查看已作废收据详情弹框**********************************************************************-->
<div class="fb-content" id="show_cancel_receipt_modal" style="display:none;">
        <div class="box-title">
            <h4>已作废</h4>
            <span class="layui-layer-setwin">
                <a class="layui-layer-ico layui-layer-close layui-layer-close1" href="javascript:;">×</a>
            ...
            <table class="order_info_table table_td_border" border="1" id="add_receipt_table" width="100%" cellspacing="0">
                         <thead class="" >
                            <tr height="30">
                                    ...
                                    <th class="order_info_title" width="3%">收据名称</th>
                                    <th class="order_info_title" width="5%">前缀</th>
                                    <th class="order_info_title" width="5%">收据编号</th>
                                    <th class="order_info_title" width="5%">领用部门</th>
                                    <th class="order_info_title" width="5%">使用人</th>
                            ...
                            <tbody id="one_cancel_receipt"></tbody>
            </table>
          </div>
</div>
    ...
    <form  class="form-horizontal" action="#" id='write_off_form' name='write_off_form' method="post">
        <table class="order_info_table table_td_border" border="1" width="100%" cellspacing="0">
                ...
                <div style="text-align:center;">
                  <input type="hidden" name="receipt_ids" id="receipt_ids" value=""/>
...
<!-- ****************************************************领用收据弹框**********************************************************************-->
<div class="fb-content" id="receive_receipt_modal" style="display:none;">
        <div class="box-title">
            <h4>领用收据</h4>
            <span class="layui-layer-setwin">
                <a class="layui-layer-ico layui-layer-close layui-layer-close1" href="javascript:;">×</a>
           ...
           <div class="jkxx fb-form" style="padding:10px;">
            <form id="receive_receipt_form" action="#" method="post">
               <table class="order_info_table table_td_border" border="1" id="add_receipt_table" width="100%" cellspacing="0">
                         <tr height="30">
                             <td width="89" style="text-align: right;">总数量</td>
                             <td width="241" style="text-align: left;" id="total_receipt_num"></td>
            ...
            <div style="text-align:center;">
                  ...
                  <input type="hidden" name="hidden_receipt_id" id="hidden_receipt_id" value="">
        ...
        <div class="jkxx fb-form" style="padding:10px;">
            ...
            <table class="order_info_table table_td_border" border="1" id="add_receipt_table" width="100%" cellspacing="0">
                         <thead class="" >
                            ...
                            <tbody id="received_receipt_list"></tbody>
            </table>
          </div>
</div>
...
function calculate_num(obj){
    ...
    var receipt_id = $("#hidden_receipt_id").val();
    ...
    $.post("<?php echo base_url();?>admin/t33/sys/receipt/get_can_use",
                 {'start_num':start_num,'end_num':end_num,'prefix':prefix,'receipt_id':receipt_id},
                 function(data){
                    data = eval('('+data+')');
...
function append_td(obj){
    var tr_str="<tr>";
   /* tr_str += "<td><select name='receipt_name[]'><option value='百元收据'>百元收据</option><option value='千元收据'>千元收据</option><option value='万元收据'>万元收据</option><option value='十万收据'>十万收据</option></select></td>";*/
    tr_str += "<td><input style='width:100%;'  type='text' name='prefix[]' value=''/></td>";
    tr_str += "<td><input style='width:100%;' onkeyup='cal_num(this)'  type='text' name='start_receipt_num[]' value='0'/></td>";
    tr_str += "<td><input style='width:100%;' onkeyup='cal_num(this)'  type='text' name='end_receipt_num[]' value='0'/></td>";
    ...
    tr_str += "</tr>";
    $("#add_receipt_table").append(tr_str);
}
...
function cal_num(obj){
    var end_num = Number($(obj).parent().parent().find("input[name='end_receipt_num[]']").val());
    var start_num = Number($(obj).parent().parent().find("input[name='start_receipt_num[]']").val());
...
//查看收据列表
function show_receipt_list(obj){
    //#receipt_list_modal; #receipt_list
    var receipt_list_str = "";
    var receipt_id = $(obj).attr('data-id');
    var use_id = $(obj).attr('data-useid');
     $.post("<?php echo base_url();?>admin/t33/sys/receipt/get_receipt_list",
                 {'receipt_id':receipt_id,use_id:use_id},
                 function(data){
                    data = eval('('+data+')');
                    $.each(data, function(name, value) {
                          receipt_list_str += "<tr>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['receipt_code']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['batch']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['ordersn']+"</td>";
                          /*receipt_list_str += "<td style='height:35px;text-align:center'>"+value['receipt_type']+"</td>";*/
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['prefix']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['receipt_code']+"</td>";

                          receipt_list_str += "<td style='height:35px;text-align:center'>"+(value['use_time']==null ? '' : value['use_time'])+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['expert_name']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['depart_name']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+(value['assign_people']==null ? '' : value['assign_people'])+"</td>";
                          ...
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+confirm_status+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['cancel_remark']+"</td>";
                          if(/*value['confirm_status']!=2 && value['use_id']>0 &&*/ value['confirm_status']==1 && value['cancel_status']==0){
                            receipt_list_str += "<td style='height:35px;text-align:center'><a style='cursor:pointer' onclick='cancel_receipt(this)' data-useid='"+value['use_id']+"'  data-id='"+value['id']+"'>作废</a></td>";
                        }else{
                            receipt_list_str += "<td style='height:35px;text-align:center'></td>";
                        }

                          receipt_list_str += "</tr>";
                    });
                   $("#receipt_list").html(receipt_list_str);
                   layer.open({
                        type: 1,
                        title: false,
                        closeBtn: 0,
...
function show_detail(obj){
    ...
    var one_receipt = "";
    var receipt_id = $(obj).attr('data-id');
     $.post("<?php echo base_url();?>admin/t33/sys/receipt/get_receipt_detail",
                 {'receipt_id':receipt_id},
                 function(data){
                    data = eval('('+data+')');
                    one_receipt += "<tr>";
                   /* one_receipt += "<td style='height:35px;text-align:center'>"+data['receipt']['receipt_name']+"</td>";*/
                    one_receipt += "<td style='height:35px;text-align:center'>"+data['receipt']['prefix']+"</td>";
                    one_receipt += "<td style='height:35px;text-align:center'>"+data['receipt']['start_code']+"</td>";
                    one_receipt += "<td style='height:35px;text-align:center'>"+data['receipt']['end_code']+"</td>";
                    one_receipt += "<td style='height:35px;text-align:center'>"+data['receipt']['num']+"</td>";
                    one_receipt += "<td style='height:35px;text-align:center'>"+data['receipt']['remark']+"</td>";
                    one_receipt += "</tr>";
                    $("#one_receipt").html(one_receipt);
                    $.each(data, function(name, value) {
                        if(name=="receipt" || name=="no_use_receipt"){
                            return ;
                        }else{
                          receipt_list_str += "<tr>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['addtime']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['prefix']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['start_code']+' ~ '+value['end_code']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['num']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['depart_name']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['expert_name']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['employee_name']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['use_num']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['cancel_num']+"</td>";
                          var is_recover_str="";
                          if(value['is_recover']=='1')
                              is_recover_str="<span style='color:red'>已收回</span>";
                          else
                              is_recover_str="<span color='red'>已领用</span>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+is_recover_str+"</td>";
                          receipt_list_str += "</tr>";
                        }
                    });
                   $("#use_receipt_list").html(receipt_list_str);
                   layer.open({
                        type: 1,
                        title: false,
                        closeBtn: 0,
...
function received(obj){
    ...
    var prefix = "";
     $.post("<?php echo base_url();?>admin/t33/sys/receipt/get_receipt_detail",
                 ...
                 function(data){
                    data = eval('('+data+')');
                    if(data['no_use_receipt']=='' || data['no_use_receipt']==0 || data['no_use_receipt']==undefined){
                        //tan_alert_noreload('已经没有可以领用的收据了');
                        //return false;
                    }
                    prefix = data['receipt']['prefix'];
                    $.each(data, function(name, value) {
                        if(name=="receipt" || name=="no_use_receipt"){
                            return ;
                        }else{
                          receipt_list_str += "<tr>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['id']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+prefix+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['start_code']+' ~ '+value['end_code']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['num']+"</td>";
                           //receipt_list_str += "<td style='height:35px;text-align:center'>"+value['end_code']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['depart_name']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['expert_name']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['use_num']+"</td>";
                          receipt_list_str += "<td style='height:35px;text-align:center'>"+value['cancel_num']+"</td>";
                   ...
                   $("#received_receipt_list").html(receipt_list_str);
                   $("#total_receipt_num").html(data['receipt']['start_code']+'-'+data['receipt']['end_code']+'     共'+data['receipt']['num']+'份');
                   var can_use_num = Number(data['receipt']['num'])-Number(data['receipt']['use_num']);
                   $("#can_use").html(can_use_num+'份');
                   var now_date = new Date().Format("yyyy-MM-dd");
                   $("#assign_date").html(now_date);
                   $("#hidden_start_code").val(data['no_use_receipt']!='' ? data['no_use_receipt']['code'] : '无');
                    $("#start_receipt_code").html(data['no_use_receipt']!='' ? data['no_use_receipt']['code'] : '无');
                    $("#hidden_assign_date").val(now_date);
                    $("#hidden_prefix").val(prefix);
                    $("#hidden_receipt_id").val(data['receipt']['id']);
                    //理论能用多少
...
function recycle(obj){
    ...
    if(use_num>0)  //
    {
	    layer.confirm('已有部分编号被使用，已使用的编号不会被收回，确定要收回？', { btn: ['是','否'] }, function(){
	        //"是"操作
	   $.post(
            "<?php echo base_url();?>admin/t33/sys/receipt/recycle_receipt",
                     {'use_id':use_id,'receipt_id':receipt_id},
                     function(data){
                        data = eval('('+data+')');
                        if (data.status == 200){
                            tan_alert(data.msg);
...
function choose_receipt(obj){
    if($(obj).is(':checked')){
        $("#receipt_ids").val($("#receipt_ids").val()+$(obj).val()+",");
    }else{
        $("#receipt_ids").val($("#receipt_ids").val().replace($(obj).val()+',',''));
    }
}
...
function show_cancel(obj){
    ...
    var td_str = "";
    $.post(
            "<?php echo base_url();?>admin/t33/sys/receipt/show_cancel_receipt",
            {'list_id':list_id},
            function(data){
                  data = eval('('+data+')');
                  ...
                  td_str += "<td style='height:35px;text-align:center'>"+data['receipt_name']+"</td>";
                  td_str += "<td style='height:35px;text-align:center'>"+data['prefix']+"</td>";
                  td_str += "<td style='height:35px;text-align:center'>"+data['receipt_code']+"</td>";
                  ...
                  td_str += "</tr>";
                  $("#one_cancel_receipt").html(td_str);
                  layer.open({
                        type: 1,
                        title: false,
                        closeBtn: 0,
                        area: '840px',
                        shadeClose: false,
                        content: $('#show_cancel_receipt_modal')
                });
            }
    );
}
    ...
    object = {
        init:function(){ //初始化方法
            ...
            if(type==0){
                var post_url="<?php echo base_url('admin/t33/sys/receipt/api_receipt_list')?>";
                var th_str = "<th>序号</th><th>录入日期</th><th>前缀</th><th>起始~结束编号</th><th>总数量</th><th>已领用</th><th>已使用</th><th>未使用</th><th>录入人</th><th>备注</th><th>操作</th>";
                $("#add_receipt").show();
                $("#input_people").show();
                $("#input_date").show();
                 $("#prefix").show();
                ...
                var post_url="<?php echo base_url('admin/t33/sys/receipt/api_receipt_list')?>";
                var th_str = "<th>序号</th><th>领用日期</th><th>前缀</th><th>起始~结束编号</th><th>总数量</th><th>起始~结束编号(已领)</th><th>领用数</th><th>领用人</th><th>领用部门</th><th>分配人</th><th>使用数量</th><th>作废数量</th><th>备注</th><th>操作</th>";
                $("#add_receipt").hide();
                $("#input_people").hide();
                $("#input_date").hide();
                $("#order_sn").hide();
                ...
                var post_url="<?php echo base_url('admin/t33/sys/receipt/api_receipt_list')?>";
                var th_str = "<th></th><th>序号</th><th>批次号</th><th>订单号</th> <th>前缀</th><th>收据编号</th><th>使用时间</th><th>使用人</th><th>使用部门</th><th>分配人</th><th>操作</th>";
                $("#add_receipt").hide();
                $("#input_people").hide();
                $("#input_date").hide();
                $("#num").hide();
                ...
                var post_url="<?php echo base_url('admin/t33/sys/receipt/api_receipt_list')?>";
                var th_str = "<th>序号</th><th>批次号</th><th>订单号</th> <th>前缀</th><th>收据编号</th><th>使用时间</th><th>使用人</th><th>使用部门</th><th>核销人</th><th>核销时间</th>";
                $("#add_receipt").hide();
                $("#input_people").hide();
                $("#input_date").hide();
                $("#num").hide();
                ...
                var post_url="<?php echo base_url('admin/t33/sys/receipt/api_receipt_list')?>";
                var th_str = "<th></th><th>序号</th><th>批次号</th><th>领用日期</th> <th>前缀</th><th>收据编号</th><th>作废时间</th><th>作废人</th><th>使用部门</th><th>分配人</th><th>操作</th>";
                $("#add_receipt").hide();
                $("#input_people").hide();
                $("#input_date").hide();
                $("#num").hide();
        ...
        pageData:function(curr,page_size,data){  //未领用生成表格数据
         var str = '', last = curr*page_size - 1;
                ...
                for(var i = 0; i <= last; i++){
                    ...
                    //str +=     "<td><a href='javascript:void(0)' onclick='show_receipt_list(this)' data-id='"+data[i].id+"'>"+data[i].prefix+"</a></td>";
                   ...
                   str +=     "<td><a href='javascript:void(0)' class='a_order' onclick='show_receipt_list(this)' data-id='"+data[i].id+"'>查看</a>"+use_str+"</td>";
                   str += "</tr>";
                }
                return str;
        },
         ...
         var str = '', last = curr*page_size - 1;
                ...
                for(var i = 0; i <= last; i++){
                   ...
                   str +=     "<td>"+data[i].start_code+" ~ "+data[i].end_code+"</td>";
                    ...
                    str +=     "<td>"+data[i].remark+"</td>";
                    //操作
                   str +=     "<td><a href='javascript:void(0)' class='a_order' onclick='show_receipt_list(this)' data-useid='"+data[i].use_id+"'>查看</a><a href='javascript:void(0)' class='a_order' onclick='recycle(this)' data-usenum='"+data[i].use_num+"' data-useid='"+data[i].use_id+"' data-id='"+data[i].id+"'>收回</a></td>";
                   str += "</tr>";
                }
                return str;
        },
                ...
                for(var i = 0; i <= last; i++){
                    str += "<tr class='order_type2'>";
                     if(data[i].confirm_status==1 && data[i].cancel_status==0){
                        str +=     "<td><input type='checkbox' value='"+data[i].id+"' name='choose_invoce' onclick='choose_receipt(this)'/></td>";
                    }else{
                        str +=     "<td></td>";
                    }
                    //str +=     "<td><input type='checkbox' value='"+data[i].id+"' name='choose_invoce' onclick='choose_receipt(this)'/></td>";
                   ...
                   str +=     "<td style='color:#09c;'>"+data[i].prefix+"</td>";
                    ...
                    //操作
                     if(/*data[i].confirm_status!=2 && data[i].use_id>0 &&*/ data[i].confirm_status==1 && data[i].cancel_status==0){
                        str += "<td><a href='javascript:void(0)' style='cursor:pointer' class='a_order' onclick='cancel_receipt(this)' data-useid='"+data[i].use_id+"' data-id='"+data[i].id+"'>作废</a></td>";
                    }else{
                        str += "<td></td>";
                    }
                    str +=     "</tr>";
...
$(function(){
    ...
    $('.endtime').datetimepicker({
            ...
            $("#add_receipt_form").submit(function(){
                $.post(
                    "<?php echo base_url();?>admin/t33/sys/receipt/add_receipt",
                     $('#add_receipt_form').serialize(),
                     function(data){
                        data = eval('('+data+')');
                        if (data.status == 200){
                            tan_alert(data.msg);
            ...
            $("#cancel_receipt_form").submit(function(){
                $.post(
                    "<?php echo base_url();?>admin/t33/sys/receipt/cancel_receipt",
                     $('#cancel_receipt_form').serialize(),
                     function(data){
                        data = eval('('+data+')');
                        if (data.status == 200){
            ...
            $("#write_off_form").submit(function(){
                  $.post(
                         "<?php echo base_url();?>admin/t33/sys/receipt/write_off_receipt",
            ...
            // End 收据核销提交#
               ...
               //领用收据提交
            $("#receive_receipt_form").submit(function(){
                  $.post(
                         "<?php echo base_url();?>admin/t33/sys/receipt/receive_receipt",
                        $('#receive_receipt_form').serialize(),
                        function(data){
                                data = eval('('+data+')');
                                if (data.status == 200){
                                     tan_alert(data.msg);
...
//旅行社下的营业部的管家
$.post('/admin/t33/sys/receipt/get_union_expert_data', {}, function(data) {
  var data = eval('(' + data + ')');
  var array = new Array();
