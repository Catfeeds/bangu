				...
				<div class="tab-content tabs-flat">
							...
							<div id="registration-form">
                            	<table class="line_base_info table_form_content table_td_border" border="1" width="100%">
                                    ...
                                    <tr height="34" class="form_group">
                                        ...
                                        <td>
                                        	<input type="text" placeholder="出发地-模糊搜索" class="form_input w_120 fl" id="startcity" name="startcity" autocomplete="off" value="">
                                    ...
                                    <tr height="34" class="form_group">
                                        ...
                                        <td id="select_dest">
                                        	<input type="text" placeholder="目的地-模糊搜索" class="form_input w_120 fl" id="overcity" name="overcity">
                                        </td>
                                    </tr>
                                    <tr height="34" class="form_group">
                                        <td class="form_title">主题游：</td>
                                        <td id="select_theme">
                                        <input type="text" placeholder="主题游" class="form_input w_120 fl" id="theme" name="theme">
                                        </td>
                                    </tr>  
                                    <tr height="34" class="form_group">
                                        <td class="form_title"><i class="important_title">*</i>上车地点：</td>
                                        <td id="select_dest">
                                        	<input type="text" placeholder="目的地-模糊搜索" class="form_input w_120 fl" id="car_address" name="car_address">
                                        </td>
                                    </tr>  
                                    <tr height="34" class="form_group">
                                    ...
                                    <tr height="34" class="form_group">
                                        ...
                                        <td>
                                        	<textarea placeholder="其他显示信息(600字以内)" style="width:300px;height:180px;" class="noresize w_600"  id="features" name="features"></textarea>
                                        </td>
                                    </tr>
                                    <tr height="34" class="form_group">
                                        <td class="form_title"><i class="important_title">*</i>线路宣传图：</td>
                                        <td>
                                         	<input type="file"  id="file" class="form_input w_180 fl"  name="mainpic" >
                                        </td>
                                    </tr>   
                                    <tr height="34" class="form_group">
                                        <td class="form_title"><i class="important_title">*</i>产品标签：</td>
                                        <td>
								...
								<table class="departure_notice table_form_content table_td_border" border="1" width="800">                                
                                        <tbody>
                                            <tr class="form_group">
                                                ...
                                                <td style="height:160px;"><textarea  style="height:150px;" class="form_textarea w_600 noresize" name="feeinclude" id="feeinclude"></textarea></td>
                                            </tr>
                                            <tr class="form_group">
                                                <td class="form_title w_100"><i class="important_title">*</i>费用不含：</td>
                                                <td style="height:160px;"><textarea  style="height:150px;" class="form_textarea w_600 noresize" name="feenotinclude" id="feenotinclude"></textarea></td>
                                            </tr>
                                            <tr class="form_group">
                                                <td class="form_title w_100">购物自费：</td>
                                                <td  style="height:160px;"><textarea  style="height:150px;" class="form_textarea w_600 noresize" name="other_project" id="other_project"></textarea></td>
                                            </tr>
                                            <tr class="form_group">
                                                <td class="form_title w_100">保险说明：</td>
                                                <td  style="height:160px;"><textarea  style="height:150px;" class="form_textarea w_600 noresize" name="insurance" id="insurance"></textarea></td>
                                            </tr>
                                            <tr class="form_group">
                                                <td class="form_title w_100">签证说明：</td>
                                                <td  style="height:160px;"><textarea  style="height:150px;" class="form_textarea w_600 noresize" name="visa_content" id="visa_content"></textarea></td>
                                            </tr>
	                                        <tr class="form_group">
		                                        <td class="form_title w_100"><i class="important_title">*</i>温馨提示：</td>
		                                        <td style="height:160px;"><textarea  style="height:150px;" class="form_textarea w_600 noresize" name="beizu" id="editor"></textarea></td>
		                                    </tr>
		                                    <tr class="form_group">
		                                        <td class="form_title w_100"><i class="important_title">*</i>特别约定：</td>
		                                        <td style="height:160px;"><textarea  style="height:150px;" class="form_textarea w_600 noresize" name="special_appointment" id="special_appointment"></textarea></td>
		                                    </tr>
		                                    <tr class="form_group">
		                                        <td class="form_title w_100"><i class="important_title">*</i>安全提示：</td>
		                                        <td style="height:160px;"><textarea  style="height:150px;" class="form_textarea w_600 noresize" name="safe_alert" id="safe_alert"></textarea></td>
		                                    </tr> 
		                                    <tr class="form_group">
			    	...
			    	<div class="tab-pane" id="profile17">
							...
							<div class="form-group problem_content" style="margin-left:0.5%;margin-top:20px;">
								...
								<div class="problem_div">
									<div class="problem_title fl">
									       <span class="num"><i class="important_title" >*</i>问题</span>
						...
						<div class="div_bt_i">
							  ...
							  <button  class="btn btn-palegreen"  type="submit" id=""> <b  style="font-size:14px">保存</b></button>
					...
					<div class="tab-pane" id="profile12">
						...
						<input type="hidden" class="LineRoutDay" value=""> 
						<div class="widget-body" id="rout_line">	         
	
						<div class="line_rout_comment" >
						<input name="lineday" id="lineday" value="" type="hidden" />
						<div class="lineDayDiv">
							<div class="form-group">
								<label class="col-sm-2 control-label no-padding-right label-width col_lb"
									for="inputEmail3" style="font-size:14px;"><span style="color: red;">*</span>第天</label>
								<div class="col-sm-10 col_ts"  style=" width:auto;min-width:43%;position:relative;">
								<input name="daynum" value="" id="daynum" type="hidden" />
									<div name="title" class="title_div text-width" contenteditable="true" > </div>
									...
									<input type="hidden"   style="width: 650px;" id="username"class="form-control text-width" name="title[]" value='' />
								</div>
							</div>
							<input name="id" value="" id="id" type="hidden" />
							<input name="routid[]" value="" id="id" type="hidden" /> 
							<input name="day[]"	value="" id="id" type="hidden" />
							<div class="form-group">
								<!-- 往返交通 -->
							...
							<div class="form-group">
								...
								<div class="form-inline ">
									<div class="checkbox  col_ts" style="padding-top: 0px;">
										...
										<input type="checkbox" name="breakfirsthas[]" value="1"/>早餐
										</label>
									</div>
									<div class="form-group col_ts" style="margin: 0px;">
									...
									<div class="checkbox col_ts" style="padding-top: 0px;">
									<label style="padding: 0px;text-align: center;width:76px;">	
									     <input type="checkbox" name="lunchhas[]" value="1" />
											午餐
										</label>
									</div>
									<div class="form-group col_ts" style="margin:0px;">
									...
									<div class="checkbox col_ts" style="padding-top: 0px;width:80px;">
										<label style="padding: 0px;text-align: center;width:76px;"> 
										<input type="checkbox" name="supperhas[]" value="1"/>
											晚餐
										</label>
									</div>
						...
						<div class="div_bt_i">
							...
							<button class="btn btn-palegreen" type="submit" id="sb_rout" ><b  style="font-size:14px">保存</b></button>
							<button class="btn btn-palegreen" type="submit"  id="next_rout"   style="margin-left:150px;font-size:14px" ><b >保存&nbsp;&nbsp;并</b><span style="font-size:12px;padding-left:4px">下一步</span></button><i> </i>
						</div>
						</form>
					</div>
					
					<!-- 设置价格 -->
					<input type="hidden" value="" id="selectMonth" name="selectMonth" />
								...
								<div id="day_price">
									<div style="margin-top: 10px;"> 	
									    <form action="/admin/b1/product/updateLinePrice" accept-charset="utf-8" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" 
											...
											<input name="lineId" type="hidden" id="lineId" value="" />
                                         <div style="margin-top:20px;" >
                                             <span style="padding-left: 5px;"><span style="color: red;">*</span>定金:</span>
                                             <input style="padding-left: 5px;width:60px;" class="price_input" type="text" placeholder="" value="" name="deposit" id="deposit" />
                                             <span>元</span>

                                             <span><span style="color: red;padding-left:10px;">*</span>提前:</span>
                                             <input style="padding-left: 5px;width:50px;display: inline-block;" type="text" value="" id="before_day" class="price_input" name="before_day"  />
                                             <span>天交清团费</span>
                                        </div>

									  	<div style="margin-top:20px;"><span><span style="color: red;">*</span>成人佣金:</span>
									  		<input style="padding-left: 5px;width:60px;display: inline-block;" type="text" value="" id="agent_rate" class="form-control text-width price_input" name="agent_rate"  />
									  		<span>元/人份</span>
									  	
									  	<span style="padding-left: 15px;" >小童佣金:</span>
									  		<input style="padding-left: 5px;width:60px;display: inline-block;" type="text" value="" id="agent_rate_child" class="form-control text-width price_input" name="agent_rate_child"  />
									  		<span>元/人份</span>
									  	</div>

									  <div style="margin-top:15px;"><span style="color: red;">备注:</span></div> 
									    <div style="margin-top:10px;"> <span class=" col_price">儿童占床说明 :</span>
									    <input style="padding-left: 5px;display:inline-block;height:28px;" type="text" placeholder="15字内 " value="" id="child_description" class="form-control text-width price_input col_wd" name="child_description"  /></div>
									    
									    <div style="margin-top:10px;"> <span class=" col_price">儿童不占床说明 :</span>
									    <input style="padding-left: 5px;display:inline-block;height:28px;" type="text" placeholder="15字内 " value="" id="child_nobed_description"  class="form-control text-width price_input col_wd" name="child_nobed_description"  />
									     <span style="padding-left:10px;">提示：填写则在产品页面显示，不填则无显示</span>
									    </div>
									       
									    <div style="margin:10px 0px 10px 0px;"> <span class=" col_price">老人价说明 :</span>
									    <input style="padding-left: 5px;display:inline-block;height:28px;" type="text" placeholder="15字内 " value="" id="old_description"  class="form-control text-width price_input col_wd" name="old_description"  /></div>
									    
									    <div style="margin-bottom:30px;"> <span class=" col_price">特殊人群说明:</span>
									    <input type="text" placeholder="15字内 " value="" id="special_description" style="padding-left: 5px;display:inline-block;height:28px;" class="form-control text-width price_input col_wd" name="special_description"  /></div>
										</form>
										<!-- 日期价格 -->
			...
			<div class="widget-body">
				<div id="registration-form" class="messages_show" style="">
				 	<table class="table table-bordered table-hover money_table">	  
					    ...
					    <tr><td class="order_info_title"><span style="color: red;">*</span>空位</td>
						<td colspan="3">
						<input name="line_id" value="" id="line_id" type="hidden" />
...
<!-- 文件预览 -->
<div id="file_txt" style="display: none;">
</div>
<!-- 行程附件预览 -->
<div id="line_file_txt" style="display: none;">
</div>
				...
				<div class="modal-body" style="height: 480px;">
				 <span style="color:red;float:left;width:100%;margin-bottom:20px;">建议上传5张。最多上传5张，选取一张成为主图</span><br>
					<span>线路主图片:</span>
						...
						<img style="max-height:130px" src="<?php if(!empty($data['mainpic'])){ echo $data['mainpic'];}?>"></span>
						</div>
					<span>线路宣传图:</span>
					<ul id="ThumbPic" style="">
					<?php if(!empty($imgurl)){ 
						foreach ($imgurl as $k=>$v){
                            				if(!empty($v['filepath'])){
						?>
						 <li style="float: left;margin:0 10px 10px 0px; width:96px;height:59px;">
						   <div class="img_main0" ><div class="float_img" id="del_img"  onclick="del_line_imgdata(this,<?php echo $v['pid']?>)">×</div>
							<div onclick="select_img(this);"><img  style="height:60px;width:100%;<?php if($data['mainpic']==$v['filepath']){ echo "border:2px solid #ff9900";} ?> " src="<?php echo $v['filepath']; ?>"></div>
							</div>
							<!-- <input type="hidden" value="<?php echo $v['filepath']; ?>" name="line_imgss[]" />   -->
						</li>
					<?php } }}?>
					</ul>
					<div style="width:100%; float:left;margin:30px;">
						<!-- <div id="infoimg"></div> -->
						<span onclick="change_avatar(this,0);" class="choice_img">选择图片</span>
					</div>
					<div style="margin-top:160px;"><input class="btn btn-palegreen " id="line_img_btn" type="submit" style="float: right; margin-right: 2%;" value="确认"></div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="NewlyBox box-shadow">
			...
			<div class="db-content">
				...
				<!-- 	<li class="db-row">
					...
					<div class="db-row-content">
					<textarea name="description" maxlength="250" style="width: 450px;height: 100px;">
...
(function(){
	...
	function initProductPrice(){
		...
		priceDate = new jQuery.priceDate({  record:'', renderTo:".cal-manager",comparableField:"day",
			...
			dayFormatter:function(settings,data){
		        	...
		        	html = html +'<div class="cell-price">¥<input type="text" style="width: 70px;" '+(settings.disabled ? '':'placeholder="老人价"' )+' '+ flag +' value="'+oldprice+'" size="4" name="oldprice">元</div>';
		        	return html;
	...
	function switchover(suitId){
		jQuery.ajax({ type : "POST",data :'suitId='+suitId,url : "<?php echo base_url()?>admin/b1/product/switchover_desc", 
			success : function(data) {
				if(data!='' && data!='0'){	
					var obj = eval('(' + data + ')');
				    $("input[name='child_description']").val(obj.child_description);
				    $("input[name='old_description']").val(obj.old_description); 
				    $("input[name='special_description']").val(obj.special_description); 
				    $("input[name='child_nobed_description']").val(obj.child_nobed_description); 
...
/*	   	 var lineprice=$('input[name="lineprice"]').val();
	    	if(''==lineprice){
		    	alert('促销价不能为空!');
	    		$('#lineprice').focus();
			return false;
...
//单位人份的变化
/* $(".uint1").change(function(){
	jQuery('.package-tab','body').each(function(index){
		var tab = jQuery(this);
		if(tab.hasClass('selected')){
			var index=tab.attr('tabindex');
			var unit_val = $('.uint1').val();
			//TAB相关的BODY显示
			var activeTabName = "#tab_body"+index;
			var tab_bodyclass = jQuery(activeTabName);
			//单位人份的变化
			$("#tab_body"+index).find('input[name="unit"]').val(unit_val);		
		}
	});
}); */ 
...
//function CheckLine(){
 jQuery('#sb_line,#next_line').click(function(){
 	$("#sb_line,#next_line").attr({"disabled":"disabled"});
	var linename = $('#lineprename');
	if(''==linename.val()){
		$("#sb_line,#next_line").removeAttr("disabled");
		alert('线路名称不能为空');
		linename.focus();
		return false;
	}else{  
	...
	//限制目的地的选择
	var overcitylen=$('.selectedContent').length;
	if(overcitylen<1){
		$("#sb_line,#next_line").removeAttr("disabled");
		alert('目的地分类不能为空！');
		return false;
	...
	// $("#rout_line").html('');
    	...
    	if(flag>0){
    		...
    		var data_num=parseInt(data_num);
     		if(TwoFlag>0){
         		for(var a=data_num;a<lineday;a++){
             		$('.line_rout_comment'+a).remove();
             	}
         	}    	
        }
    });
...
jQuery('#sb_rout,#next_rout').click(function(){
		var num=$('input[name="data_num"]').val();
		if(num!=''&& num!='0'){
			for(var i=0;i<num;i++){ 
				//行程内容
				var n=0;
...
jQuery('#sb_label,#next_label').click(function(){
	 var index=$(this).index();
	jQuery.ajax({ type : "POST",data : jQuery('#lineLabelForm').serialize(),url : "<?php echo base_url()?>admin/b1/product/lineLabelForm", 
		success : function(response) {
		 	if(response!='' && response!='0'){	 	 
				alert( '保存成功！' );
				if(index==2){
...
jQuery('#sb_linetrain,#next_inetrain').click(function(){
	 ...
	 var index=$(this).index();
		jQuery.ajax({ type : "POST",data : jQuery('#lineInfo').serialize(),async:false,url : "<?php echo base_url()?>t33Api/line/get_line", 
			success : function(response) {
			 	 if(response!='' && response!='0'){	 	 
					alert( '保存成功！' );
                                                  //   alert(index);
					...
					//window.location.href="/admin/b1/group_line";
					window.close();
...
//清空价格
 ...
 /*   	 	$('.cal-manager').find('.package-con').each(function(i){
    	 	 	var obj= $(this).is(":hidden");
    	 		if(obj==false){
    	 			$(this).find("td").each(function(i){
    	 			   jQuery(this).find("input[name='refprice']").val(''); 
    	 			   jQuery(this).find("input[name='childnobedprice']").val(''); 
    	 			   jQuery(this).find("input[name='adultprice']").val(''); 
    	 			   jQuery(this).find("input[name='childprice']").val('');
    	 			   jQuery(this).find("input[name='number']").val(''); 
    	 			   jQuery(this).find("input[name='oldprice']").val(''); 
    	 			}); 
    	 		}
    	 	});*/
...
$.post('/admin/b1/group_line/get_expert_data', {}, function(data) {
	...
	$('input[name="expertid"]').val('<?php  if(!empty($expert['id'])){echo  $expert['id'];}?>');
})
