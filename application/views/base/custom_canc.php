      		...
      		<div class="consulting_tab">
            	<div class="hd cm_hd clear">
                    <ul><a href="<?php echo base_url('base/member/mycustom?tyle=onmake');?>"><li>制作中</li></a>
                     <a href="<?php echo base_url('base/member/mycustom?tyle=confirme');?>"><li>已确认</li></a>
                    <a href="<?php echo base_url('base/member/mycustom?tyle=canc');?>"><li class="on">已取消</li></a></ul>
				</div>
				<div class="bd cm_bd">
                    <!-- tab 切换制作中的内容 -->
                    <ul>
                        <table  class="common-table" style="position:relative;" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <?php foreach ($row as $k=>$v){ ?>
                            <tr>
                                ...
                                <td><?php echo $v['endplace']; ?></td>
                                <td style="color: #e83b37;"><span>￥</span><?php echo $v['budget']; ?><span>/无</span></td>
                                <td><?php echo $v['days']; ?></td>
                                <td><?php echo $v['people']; ?></td>
                                <td><?php  echo  $str = mb_strimwidth($v['service_range'], 0,15, '...', 'utf8');?></td>
                                <td><?php echo  $str = mb_strimwidth($v['other_service'], 0,15, '...', 'utf8'); ?></td>
                                <td><?php echo $v['rob']; ?></td>
                                <td><?php echo $v['replies']; ?>条</td>
                                <td class="detail_link">
                                    <a class="order_table_tbody_plan" href="#">查看方案</a><br/>
                        ...
                        <div class="pagination">
						  <ul class="page"><?php if(!empty($complaint)){echo $this->page->create_page();}?></ul>
						</div>
                    </ul>
				</div>
            </div> 
