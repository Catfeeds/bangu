								...
								<table class="common-table" style="position: relative;"
									...
									<thead class="common_thead">
										<tr>
											...
											<th width="140"><span class="td_left">投诉时间</span></th>
											<th width="240">投诉内容</th>
											<th width="180">产品名称</th>
											<th width="80">投诉对象</th>
											<th width="80">状态</th>
											<th width="100">联系电话</th>
											<!-- <th width="160">处理意见</th> -->
										</tr>
									</thead>
									<tbody class="common_tbody">
										...
										<tr>
											...
											<a title="<?php echo in_array(1 ,explode(',',$val['overcity'])) ? '/line/'.$val['lineid'].'.html' : '/line/'.$val['lineid'].'.html'; ?>" target="_blank"><?php echo  $str = mb_strimwidth($val['productname'], 0,25, '...', 'utf8'); ?></a>
											</td>
											...
											<td title="<?php echo $val['remark']; ?>"><?php echo  $str = mb_strimwidth($val['remark'], 0,25, '...', 'utf8'); ?></td>
										</tr>
										<?php }}else{?>
										<!-- 以下是没有点评记录时的状态 -->
										<?php if($tyle=='nodid'){ ?>
