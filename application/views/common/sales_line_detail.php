            ...
            <div class="table_content" style="padding-bottom:0px;">
                ...
                <div class="tab_content" style="margin-top:10px;">
                       ...
                       <div class="ul_div">
                           ...
                           <p class="one_p clear"><font>指定管家：</font>             
...
(function(){
  ...
  function initProductPrice(){
      var url = '<?php echo base_url()?>common/line/get_salesPrice';
      ...
      dayFormatter:function(settings,data){
			...
			html += date_flag ? '<p></p>':'<p>'+(''==childprice?'':'<span class="lab"></span><span style="float: left;">售价：</span><span style="color:#F40;padding-right: 5px;">'+adultprice+'</span>')+'</p>';
			html+= date_flag ? '<p></p>':'<p>'+(''==childprice?'':'<span class="lab"></span><span style="float: left;">促销价：</span><span style="color:#F40;padding-right: 5px;">'+(''==s_adultprice?'':s_adultprice)+'</span>')+'</p>';
			
			html += date_flag ? '<p>'+(''==childprice?'':'')+'</p>':'<p>'+(''==childprice?'':'<span class="lab"></span><span style="float: left;">售价：</span><span style="color:#F40;padding-right: 5px;">'+(''==childprice?'':childprice)+'</span>')+'</p>';
			html+= date_flag ? '<p>'+(''==s_childprice?'':'')+'</p>':'<p>'+(''==childprice?'':'<span class="lab"></span><span style="float: left;">促销价：</span><span style="color:#F40;padding-right: 5px;">'+(''==s_childprice?'':s_childprice)+'</span>')+'</p>';
			
			html += date_flag ? '<p>'+(''==childnobedprice?'':'')+'</p>':'<p>'+(''==childprice?'':'<span class="lab"></span><span style="float: left;">售价：</span><span style="color:#F40;padding-right: 5px;">'+(''==childnobedprice?'':childnobedprice)+'</span>')+'</p>';
			html+= date_flag ? '<p>'+(''==s_childnobedprice?'':'')+'</p>':'<p>'+(''==childprice?'':'<span class="lab"></span><span style="float: left;">促销价：</span><span style="color:#F40;padding-right: 5px;">'+(''==s_childnobedprice?'':s_childnobedprice)+'</span>')+'</p>';
			
			html += date_flag ? '<p>'+(''==number?'':'')+'</p>':'<p>'+(''==childprice?'':'<span class="lab"></span><span style="float: left;">余位：</span><span style="color:#F40;padding-right: 5px;">'+(''==number?'':number)+'</span>')+'</p>';
			html+= date_flag ? '<p>'+(''==s_number?'':'')+'</p>':'<p>'+(''==childprice?'':'<span class="lab"></span><span style="float: left;">促销位：</span><span style="color:#F40;padding-right: 5px;">'+(''==s_number?'':s_number)+'</span>')+'</p>';
