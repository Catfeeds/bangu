...
<!--
    <div class="headingLogo clear">
    	<div class="fl logo">
        	<a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>/static/img/logo.png" alt="帮游旅游网"/></a>
        </div>
        <div class="fr orderNav orderNav_4"></div>
    </div>
-->
    <div class="header">
        <div  class="wid_1200">
            ...
            <div class="head_right">
                ...
                <div class="shouye_nav">
                    <ul>
                        ...
                        <li><a href="/guonei/">国内游</a></li>           <!-- 将gn改为guonei-->
                        <li><a href="/zhoubian/">周边游</a></li>           <!-- 将zb改为zhoubian-->
                        <li><a href="/zhuti/">主题游</a></li>           <!-- 将zt改为zhuti-->
    ...
    <div class="orderMian" style=" border:none;">
    	<div class="orderfour-content">
            ...
            <div class="orderFooter shuang_btn">
                <a class="btn-link btn-fanhui" href="/" class="btn-fanhui">返回首页</a>
                <a class="btn-link btn-green" href="<?php echo site_url('order_from/order/show_order_message_'.$id.'.html')?>" class="btn-submit">查看订单</a>
            </div>
        </div>
    </div>
   	</div>
