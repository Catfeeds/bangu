		...
		<div class="cantantCon">
			<div class="headerTitlrBg">
				<div class="headerTitle">
					<img src="<?php echo base_url('static/img/rankinglist/titlrTetxt1.png'); ?>">
				</div>
				
				<div class="tipTextr">以下是前十名产品人气排行榜 【时间：2017-02-03 00:00:00 —— 2017-02-10 19:30:00】</div>
			</div>
...
// 		},10000);
	...
	function getdata(){
		$.ajax({
            type: "post",
            url: "http://"+lost+"/rankinglist/line_list_change",
	...
	function anta(){
		...
		for( var i = 0 ; i < dl ; i ++ ){
			var ht = "";
				...
				ht +=		'<div class="headBox"><img src="http://'+lost+data[i].mainpic+'"></div>';
				ht +=		'<div class="box1">';
				ht +=			'<span class="Name oneColor">'+data[i].brand+'</span>';
				...
				ht +=		'<div class="headBox"><img src="http://'+lost+data[i].mainpic+'"></div>';
				ht +=		'<div class="box1">';
				ht +=			'<span class="Name twoColor">'+data[i].brand+'</span>';
				...
				ht +=		'<div class="headBox"><img src="http://'+lost+data[i].mainpic+'"></div>';
				ht +=		'<div class="box1">';
				ht +=			'<span class="Name threeColor">'+data[i].brand+'</span>';
				...
				ht +=		'<div class="headBox"><img src="http://'+lost+data[i].mainpic+'"></div>';
				ht +=		'<div class="box1">';
				ht +=			'<span class="Name defaColor">'+data[i].brand+'</span>';
