...
<body>
	<div class="Cellphone_header">
    	<div class="Cellphone_main">
        	<a href="<?php echo sys_constant::INDEX_URL?>"><img src="/static/img/logo.png" alt="logo"/></a>
        	<div class="Cellphone_tltle">找回密码</div>
        	<div class="Cellphone_Return"><a href="<?php echo sys_constant::INDEX_URL?>">返回帮游旅行首页</a></div>
        	<div class="Cellphone_Reg"><a href="<?php echo site_url('register/index');?>">免费注册</a></div>
        	<div class="Cellphone_land"><a href="<?php echo site_url('login')?>">会员登录</a></div>
        </div>
    </div>
    <div class="Cellphone_conment">     
        ...
        <form action="" method="post" id="retrieve_password">
  		<div class="Cellphone_input">
        	<div class="chunk_box">
        		<span>手机号码</span>
        		<input style=" width:230px;" type="text" maxlength="11" name="mobile" placeholder="输入手机号码">
          	...
          	<div class="chunk_box">
           	...
           	<div class="eject_yanzheng">
            	<input class="" name="vcode" maxlength="4"  placeholder="输入验证码">
            	<div class="Cellphone_ejc_box">
               	...
               	<input type="button" class="tijiao submit_code" value="提交">
                <input type="button" class="guanbi" value="关闭">
            </div>
          	<div class="chunk_box" style=" height:45px;">
             	<span class="magin_top">密码</span>

            	<input type="password" class="magin_top" name="password" style=" width:337px;" maxlength="15" type="password" placeholder="设置登录密码" onKeyUp=pwStrength(this.value) onBlur=pwStrength(this.value)>
            </div>
            <div class="chunk_box" style=" height:30px;">
            	<table class="Cellphone_two_table">
	    			<tr width="40px">
          	...
          	<div class="chunk_box"> 
             	...
             	<input name="repass" style=" width:337px; margin-top:15px;" maxlength="15" type="password" placeholder="再次输入密码" >
            </div>
...
function submit_form() {
	$.post(
		"<?php echo site_url('login/do_retrieve_pass')?>",
...
$('.submit_code').click(function(){
	...
	$.post( 
		...
		{'mobile':mobile,'verifycode':vcode,'type':2},
		function(data) {
			var data = eval('('+data+')');
			if (data.code == 2000) {
				alert(data.msg);
