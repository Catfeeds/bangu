...
<head>
    ...
    <meta name="description" content="深圳之窗旅游频道联合帮游旅行网为你曝光(<?php echo $dest_name;?>)不文明旅游行为，大家可以在此了解一下关于事情的始末。
" />
    <title><?php echo $con['title'];?>+旅游曝光台-帮游网-深圳之窗网
</title>
      	...
      	<div class="information_detail" style="min-height:600px;">
            ...
            <div class="article_info">
                <ul class="evant_box">
                    ...
                    <li><div class="icle_title">作者:</div><span><?php echo $con['realname'];?></span></li>
                </ul>
            </div>
...
$('#guanjia').click(function() {
	...
	var url = '<?php echo base_url();?>guanjia/'; // guanj改为guanjia 魏勇编辑
	var url2="";
	if (cityid >0) {
		url2 += '_c-'+cityid;
	}
