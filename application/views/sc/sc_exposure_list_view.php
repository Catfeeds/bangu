...
<head>
    ...
    <meta name="description" content="深圳之窗旅游频道联合帮游旅行网为你提供各地不文明旅游行为曝光平台，包括旅游景点不合理行为，游客的不文明行为以及国家对于不文明行为的政策等。" />
    <title>旅游曝光台_不文明旅游曝光-帮游网-深圳之窗网</title>
...
<div class="text_nav_title">
	...
	<a href="#" class="fl changes">旅游曝光台</a>
            ...
            <?php foreach ($im_content as $item=>$con):?>
                <div class="tab_cons" data-id="<?php echo $item;?>" style="display: <?php if($item=="1") echo 'block'; else echo 'none';?>;">
                    <ul class="information_list_info">
                    	...
                    	<li><a href="<?php echo base_url('sc/index/exposure_detail?id='.$val['id']);?>"	 target="_blank">
			...
			<div class="tabcontent">
				...
				<div class="tab_con" style=" display: block">
					<div class="sc_input_list">
						...
						<div class="sc_inp_box"><input type="text" id="expertCityName" class="inp_one" value="<?php echo $startcityname;?>" autocomplete="off"/></div>			
						<input type="hidden" name="expertCityId" value="<?php echo $startcityId;?>" placeholder="请选择城市" id="expertCityId">
					</div>
...
$(".tab_cons .ul_page li a").click(function(){
   ...
   $.ajax({
     ...
     url:"<?php echo base_url().'sc/index/exposure_list'?>",
     dataType:"json",
     success:function(data){
         ...
         for(var o in json)
         {
			...
			str +="<li><a href='"+base_url+"sc/index/exposure_detail?id="+json[o]['id']+"' target='_blank'>";
			str +="<div class='information_img fl'><img src='"+base_url+json[o]['pic']+"' data-original='"+base_url+json[o]['pic']+"'></div>";
			str +="<div class='information_txt fr'><h4>"+(json[o]['title']==null?'':json[o]['title'])+"</h4><p></p></div></a>";
            str +="<div class='attention'><span class='spn1'>"+json[o]['addtime'].substr(0,4)+"年"+json[o]['addtime'].substr(5,2)+"月"+json[o]['addtime'].substr(8,2)+"日</span>&nbsp;&nbsp;<span class='spn2'>"+json[o]['addtime'].substr(11,5)+"</span>&nbsp;&nbsp;</div>";
