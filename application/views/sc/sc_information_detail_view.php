...
<head>
    ...
    <meta name="keywords" content="<?php echo $dest_name;?>周边旅游_<?php echo $dest_name;?>旅游攻略" />
    <meta name="description" content="深圳之窗旅游频道联合帮游旅行网旅游资讯频道为大家提供最新最全面的<?php echo $dest_name;?>旅游攻略，为您在<?php echo $dest_name;?>的旅程提供专业的出游指南。" />
    <title><?php echo $con['title'];?>_最新<?php echo $dest_name;?>旅游资讯-帮游网--深圳之窗网</title>
...
<div class="nav_bar">
	<ul class="sc_1000 clear">
		...
		<li	<?php if( $key=='0'){ echo "   class='on'   ";}else{      echo '   '; }?>><a href="<?php echo  base_url($val['link']);?>"  target="_blank"><?php echo $val['name']?></a></li>
		<?php }?>
    </ul>
</div>
...
<div class="banner_img"   style="margin-top:20px;margin-bottom:5px;">
	<a href="<?php echo $fix_desc['center'][1]['link'];?>" target="_blank"><img src="<?php echo BANGU_URL.$fix_desc['center'][1]['pic'];?>"/></a>
</div>
<?php }else{?>
...
<div class="text_nav_title">
	...
	<span class="fl">&gt;</span>
	<a href="#" class="fl"><?php echo $con['title'];?></a>
</div>
...
<div class="man_content sc_1000 clear">
	...
	<div class="left_content">
    	<!--================资讯详情=========== -->
      	<div class="information_detail" style="min-height:600px;">
        	<h2 class="information_title"><?php echo $con['title'];?></h2>
            <div class="article_info">
                <ul class="evant_box">
                    <li><div class="icle_title">来源:</div><span>帮游旅行网</span></li>
                    <li><div class="icle_title">发布:</div><span><?php echo  $con['addtime'] ;?></span></li>
                    <li><div class="icle_title">来源:</div><span><?php echo $con['user_name'];?></span></li>
                </ul>
            </div>
            ...
            <div class="review_text">
                ...
                <div class="review_zan">
	                <img src="../../static/img/sc/zans.png" class="zans" style="display:none;" id="yi_zan">
	                <img src="../../static/img/sc/zany.png" id="to_zan">
	                <i><?php echo isset($con['praisetnum'])==true?$con['praisetnum']:'0';?></i>
                </div>

                <div class="review_share">
                    <div class="review_enter">
                        <div class="enter_tel">分享到&nbsp;:&nbsp;</div>
                        <div class="enter_ioc" style="width:192px;">
                           <ul class="enter_ioc">
...
<!--                 <span>更多关于巴厘岛旅游以及普吉岛旅游资讯请访问帮游旅游网</span><a href="http://www.1b1u.com/lyzx">http;//www.1b1u.com/lyzx</a> -->
                </div>
            </div>
        </div>
        ...
        <div class="like_line">
            ...
            <ul class="line_line_list clear">
 			...
 			<?php  foreach ($guess_line as $key => $val){?>
            	...
            	<li><a href="<?php echo $line_url = in_array(1 ,explode(',',$val['overcity'])) ? '/line/'.$val['id'].'.html' : '/line/'.$val['id'].'.html'; ?>">
	...
	<div class="sc_con_you">
		<div class="tab">
			...
			<div class="tabcontent">
				...
				<div class="tab_con" style=" display: block">
					...
					<div class="sc_input_list" id="visit_div" style="padding-bottom:10px;display:none;">
        ...
        <div class="travel_notes">
            ...
            <?php if(empty($three_line)){echo   '   ';}else{ foreach  ($three_line  as $key =>$val){    ?>
             	<li>
                    <!-- 将cj和gn改为line,添加后缀.html-->
                	<a href="<?php echo $line_url = in_array(1 ,explode(',',$val['overcity'])) ? '/line/'.$val['id'].'.html' : '/line/'.$val['id'].'.html'; ?>">
                		<div class="travel_note_img">
                			<img src="<?php echo site_url('static/img/loading0.gif'); ?>" data-original="<?php echo base_url($val['mainpic']);?>">
                		</div>
                    	<p class="travel_note_title"><<?php echo $val['linename']?>><?php echo $val['linetitle']?></p>
                	...
                	<!-- <span class="cancle_num"><?php echo $val['collectnum']?></span><span class="comment_num"><?php echo $val['comment_count']?></span> -->
                </li>
               <?php    }}?> 
                           </ul>
        </div>
        ...
        <div class="bu_public_num">
            ...
            <div class="console_expert">
                <div class="expert_photo"><a href="javascript:void(0)"><img src="<?php echo base_url();?>static/img/sc/console_expert.jpg"></a></div>
...
$(function(){
	var len = $(".expert_console  ul li").length;
	$(".expert_console  ul li").eq(len-1).css("margin-right","0px");
...
$(function(){
	...
	var id="<?php echo $con['id'];?>";
	//delCookie("iszan");
	
	//点赞+1
	var num=$(".review_zan i").html();
	num = parseInt(num)+1;
	var iszan=getCookie("iszan");
	if(iszan!=null)
	{
		var eee=iszan.toString().split("-");
		if(eee.indexOf(id)>=0)
		{
			$("#to_zan").css("display","none");
			$("#yi_zan").css("display","block");
		}
		var consult=iszan;
	}
	else
	...
	$("#to_zan").click(function(){
		...
		$.ajax({
            type:"POST",
            url:"<?php echo base_url().'sc/index/to_zan';?>",
            data:{id:id},
            dataType:"json",
            success:function(data){
            	...
            	if(data.code=="0")
            	{
        		 $("#to_zan").css("display","none");
        		 $("#yi_zan").css("display","block");
        		 $(".review_zan i").html(num);
        		 var arr=consult.split("-");
        		 if(arr.indexOf(id)>=0)
        		 {
        		 }
        		 else
	...
	//浏览+1
	var shownum="<?php echo $con['shownum'];?>";
	shownum = parseInt(shownum)+1;
	var read_num=getCookie("read_num");
	if(read_num!=null)
	{
		var read=read_num;
	}
	...
	else
	{
		$.ajax({
            type:"POST",
            url:"<?php echo base_url().'sc/index/to_read';?>",
            data:{id:id},
            dataType:"json",
            success:function(data){
