...
<!--头部结束--> 
        <div class="butler_main">
            <div class="butler_left">
                <ul>
                    <li class="xieyi_lvs"><a href="/service/expert_agreement" class="xieyi_lvs" >管家服务总则</a></li>
                    <li><a href="/service/cooperation">管家合作协议</a></li>
            ...
            <div class="butler_right">
                 <div style=" display:block; text-align:center; height:40px; line-height:40px; font-size:24px; margin-top:10px;">旅游管家服务总则</div>
            <?php if(!empty($atrr)){
            	foreach ($atrr as $k=>$v){
          if(!empty($v['son'])){
				foreach ($v['son'] as $key=>$val){
