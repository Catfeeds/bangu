...
<!--头部结束--> 
        <div class="butler_main">
            <div class="butler_left">
                <ul>
                    <li class="xieyi_lvs"><a href="/service/member_agreement" class="xieyi_lvs">会员协议</a></li>
                    <li><a href="/service/integral_agreement">积分规则</a></li>
                </ul>
            </div>
            ...
            <div class="butler_right">
               	<div style=" display:block; text-align:center; height:40px; line-height:40px; font-size:24px; margin-top:10px;">游帮会员协议</div>
            	<?php if(!empty($atrr)){
            		foreach ($atrr as $k=>$v){
         	    	if(!empty($v['son'])){
					foreach ($v['son'] as $key=>$val){	
...
<!--底部开始-->
<div style=" background: #fff;margin-top:50px; border-top:1px solid #ccc; border-bottom:1px solid #ccc;">
