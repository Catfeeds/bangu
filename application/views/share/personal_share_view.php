...
<body>
    ...
    <div class="page_main">
        <div class="page_geren">
            <div class="geren_title_left">
                
                <img alt="<?php echo $share_man['truename']; ?>" src="<?php echo $share_man['litpic']?>" />
                <div class="geren_name"><?php echo $share_man['truename']; ?></div>
                <div class="geren_Explain"><?php echo $share_man['talk']; ?></div>
            </div>
            <div class="geren_title_right">
                <ul>
                    <li>
                        <div class="shulia"><?php echo $share_man['share_count']?></div>
                        <div class="title_til">分享</div>
                    </li>
                    <li>
                        <div class="shulia"><?php echo $share_man['share_popularity']?></div>
                        <div class="title_til">人气</div>
                    </li>
                    <li>
                        <div class="shulia"><?php echo $share_man['share_praise']?></div>
                        <div class="title_til">被赞</div>
                    </li>
                </ul>
            </div>
        </div>
    </div>
    <div class="otoShare_conment" style="margin-top:10px; background-color:rgba(255,255,255,0.8); min-height:500px;">
            <ul>
            <?php foreach ($share_img as $val) {  ?>
                <li onclick="share_list_ul(this);" val="<?php echo $val['id']?>"><a class="a1" href="javascript:void(0);">
            ...
            <div class="page_nav"><?php echo $this->page->create_page(); ?></div>
        </div>
...
<script type="text/javascript">
        ...
        function share_list_ul(obj){
         	...
         	$.post("/share/share_detail/get_share_detail", { id: id },  function(json) {
				...
				$(".ulSmallPic li:visible").addClass("hide") 
             })
	...
	$(function(){
	 var num=$(".geren_Explain").html();
	 if(num.length>65){
	 	$(".geren_Explain").html(num.substr(0,65)+"...")}
	});
</script>
<script type="text/javascript"> 
$(function() { 
