...
//		$('<dl><dt></dt><dd title="成人价格">成人价格</dd><dd title="儿童占床价">儿童占床价</dd><dd title="儿童不占床价">儿童不占床价</dd><dd title="单房差">单人数补房差</dd><dd class="bg_yellow balance">余位</dd><dd class="bg_yellow borders balance">提前截止收客</dd></dl>').appendTo(reserve_record);
		...
		for(var i=0;i<center+1;i++){
			$('<dl><dt></dt><dd title="成人价格">成人价格</dd><dd title="儿童占床价">儿童占床价</dd><dd title="儿童不占床价">儿童不占床价</dd><dd class="bg_yellow balance">余位</dd></dl>').appendTo(reserve_record);
		}
		switch(week){
			case 1:
	...
	initFirstRow : function(fullCount,emptyCount,now,tabbody){
		...
		for(var i=0;i<emptyCount;i++){
			this.tr += '<td><p class="bg_blue"><i></i></p><p class="singleRow"></p><p class="singleRow"></p><p class="singleRow"></p><p class="singleRow"></p></td>';
		}
	...
	initCal: function (tab_body,now){
		...
		for(var k=0;k<this.monthTabLen;k++){
			...
			$('<dl><dt class="month"><span>'+month+'</span>月</dt><dd title="成人价格">成人价格</dd><dd title="儿童占床价">儿童占床价</dd><dd title="儿童不占床价">儿童不占床价</dd><dd class="bg_yellow balance">余位</dd></dl>').appendTo(reserve_record);
