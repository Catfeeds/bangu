        ...
        init: function () {
            ...
            $('#editabledatatable_new').click(function (e) {
                ...
                var aiNew = oTable.fnAddData(['', '', '', '',
                        '<a href="#" class="btn btn-success btn-xs save"> 保存</a> <a href="#" class="btn btn-warning btn-xs cancel"><i class="fa fa-times"></i> 返回</a>'
                ]);
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[4].innerHTML = '<a href="#" class="btn btn-success btn-xs save"><i class="fa fa-save"></i> Save</a> <a href="#" class="btn btn-warning btn-xs cancel"><i class="fa fa-times"></i> 返回</a>';
            }
