(function($){
    $.querycity = function(input,options){
        ...
        if($.trim(input.val())=='' || $.trim(input.val())==options.defaultText){ 
            input.val(options.defaultText).css('color','#333');
        }
        ...
        labelMain.find('a').click(function(){	
	    ...
	    popContainer.find('a').click(function(){
		    input.val($(this).html());
		    input.change();
		    popMain.hide();
	    });
        ...
        suggestMain.find('.list_city_container a').click(function(){
        ...
        suggestMain.find('.page_break a').mouseover(function(){
            t_suggest_focus = true;        
        }).live('mouseout',function(){
            t_suggest_focus = false;
        });
	    suggestMain.find('.page_break a').click(function(event){
